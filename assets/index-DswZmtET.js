 ...
 * Club GSAP members, the agreement issued with that membership.
 * @author: Jack Doyle, jack@greensock.com
*/var Ze,ba,Fn,Qi,tr,vs,kd,Sr,uo,Hd,Li,ii,Vd,Gd=function(){return Ze||typeof window<"u"&&(Ze=window.gsap)&&Ze.registerPlugin&&Ze},Wd=1,ds=[],ne=[],gi=[],ho=Date.now,vc=function(t,e){return e},c_=function(){var t=uo.core,e=t.bridge||{},n=t._scrollers,i=t._proxies;n.push.apply(n,ne),i.push.apply(i,gi),ne=n,gi=i,vc=function(o,a){return e[o](a)}},ir=function(t,e){return~gi.indexOf(t)&&gi[gi.indexOf(t)+1][e]},fo=function(t){return!!~Hd.indexOf(t)},cn=function(t,e,n,i,s){return t.addEventListener(e,n,{passive:i!==!1,capture:!!s})},ln=function(t,e,n,i){return t.removeEventListener(e,n,!!i)},zo="scrollLeft",ko="scrollTop",xc=function(){return Li&&Li.isPressed||ne.cache++},Wa=function(t,e){var n=function i(s){if(s||s===0){Wd&&(Fn.history.scrollRestoration="manual");var o=Li&&Li.isPressed;s=i.v=Math.round(s)||(Li&&Li.iOS?1:0),t(s),i.cacheID=ne.cache,o&&vc("ss",s)}else(e||ne.cache!==i.cacheID||vc("ref"))&&(i.cacheID=ne.cache,i.v=t());return i.v+i.offset};return n.offset=0,t&&n},mn={s:zo,p:"left",p2:"Left",os:"right",os2:"Right",d:"width",d2:"Width",a:"x",sc:Wa(function(r){return arguments.length?Fn.scrollTo(r,Ge.sc()):Fn.pageXOffset||Qi[zo]||tr[zo]||vs[zo]||0})},Ge={s:ko,p:"top",p2:"Top",os:"bottom",os2:"Bottom",d:"height",d2:"Height",a:"y",op:mn,sc:Wa(function(r){return arguments.length?Fn.scrollTo(mn.sc(),r):Fn.pageYOffset||Qi[ko]||tr[ko]||vs[ko]||0})},vn=function(t,e){return(e&&e._ctx&&e._ctx.selector||Ze.utils.toArray)(t)[0]||(typeof t=="string"&&Ze.config().nullTargetWarn!==!1?console.warn("Element not found:",t):null)},lr=function(t,e){var n=e.s,i=e.sc;fo(t)&&(t=Qi.scrollingElement||tr);var s=ne.indexOf(t),o=i===Ge.sc?1:2;!~s&&(s=ne.push(t)-1),ne[s+o]||cn(t,"scroll",xc);var a=ne[s+o],l=a||(ne[s+o]=Wa(ir(t,n),!0)||(fo(t)?i:Wa(function(c){return arguments.length?t[n]=c:t[n]})));return l.target=t,a||(l.smooth=Ze.getProperty(t,"scrollBehavior")==="smooth"),l},Mc=function(t,e,n){var i=t,s=t,o=ho(),a=o,l=e||50,c=Math.max(500,l*3),u=function(g,_){var m=ho();_||m-o>l?(s=i,i=g,a=o,o=m):n?i+=g:i=s+(g-s)/(m-a)*(o-a)},h=function(){s=i=n?0:i,a=o=0},f=function(g){var _=a,m=s,p=ho();return(g||g===0)&&g!==i&&u(g),o===a||p-a>c?0:(i+(n?m:-m))/((n?p:o)-_)*1e3};return{update:u,reset:h,getVelocity:f}},Ws=function(t,e){return e&&!t._gsapAllow&&t.preventDefault(),t.changedTouches?t.changedTouches[0]:t},_h=function(t){var e=Math.max.apply(Math,t),n=Math.min.apply(Math,t);return Math.abs(e)>=Math.abs(n)?e:n},Xd=function(){uo=Ze.core.globals().ScrollTrigger,uo&&uo.core&&c_()},Yd=function(t){return Ze=t||Gd(),!ba&&Ze&&typeof document<"u"&&document.body&&(Fn=window,Qi=document,tr=Qi.documentElement,vs=Qi.body,Hd=[Fn,Qi,tr,vs],Ze.utils.clamp,Vd=Ze.core.context||function(){},Sr="onpointerenter"in vs?"pointer":"mouse",kd=Ne.isTouch=Fn.matchMedia&&Fn.matchMedia("(hover: none), (pointer: coarse)").matches?1:"ontouchstart"in Fn||navigator.maxTouchPoints>0||navigator.msMaxTouchPoints>0?2:0,ii=Ne.eventTypes=("ontouchstart"in tr?"touchstart,touchmove,touchcancel,touchend":"onpointerdown"in tr?"pointerdown,pointermove,pointercancel,pointerup":"mousedown,mousemove,mouseup,mouseup").split(","),setTimeout(function(){return Wd=0},500),Xd(),ba=1),ba};mn.op=Ge;ne.cache=0;var Ne=function(){function r(e){this.init(e)}var t=r.prototype;return t.init=function(n){ba||Yd(Ze)||console.warn("Please gsap.registerPlugin(Observer)"),uo||Xd();var i=n.tolerance,s=n.dragMinimum,o=n.type,a=n.target,l=n.lineHeight,c=n.debounce,u=n.preventDefault,h=n.onStop,f=n.onStopDelay,d=n.ignore,g=n.wheelSpeed,_=n.event,m=n.onDragStart,p=n.onDragEnd,E=n.onDrag,v=n.onPress,x=n.onRelease,R=n.onRight,w=n.onLeft,b=n.onUp,C=n.onDown,S=n.onChangeX,M=n.onChangeY,P=n.onChange,U=n.onToggleX,O=n.onToggleY,H=n.onHover,$=n.onHoverEnd,X=n.onMove,Y=n.ignoreCheck,z=n.isNormalizer,nt=n.onGestureStart,D=n.onGestureEnd,ut=n.onWheel,it=n.onEnable,Tt=n.onDisable,k=n.onClick,j=n.scrollSpeed,at=n.capture,et=n.allowClicks,Mt=n.lockAxis,Et=n.onLockAxis;this.target=a=vn(a)||tr,this.vars=n,d&&(d=Ze.utils.toArray(d)),i=i||1e-9,s=s||0,g=g||1,j=j||1,o=o||"wheel,touch,pointer",c=c!==!1,l||(l=parseFloat(Fn.getComputedStyle(vs).lineHeight)||22);var Ot,qt,Nt,Pt,I,ge,zt,B=this,At=0,ie=0,Dt=n.passive||!u&&n.passive!==!1,A=lr(a,mn),y=lr(a,Ge),G=A(),tt=y(),Q=~o.indexOf("touch")&&!~o.indexOf("pointer")&&ii[0]==="pointerdown",Z=fo(a),dt=a.ownerDocument||Qi,ct=[0,0,0],_t=[0,0,0],Xt=0,rt=function(){return Xt=ho()},lt=function(Rt,Kt){return(B.event=Rt)&&d&&~d.indexOf(Rt.target)||Kt&&Q&&Rt.pointerType!=="touch"||Y&&Y(Rt,Kt)},Ut=function(){B._vx.reset(),B._vy.reset(),qt.pause(),h&&h(B)},It=function(){var Rt=B.deltaX=_h(ct),Kt=B.deltaY=_h(_t),gt=Math.abs(Rt)>=i,Gt=Math.abs(Kt)>=i;P&&(gt||Gt)&&P(B,Rt,Kt,ct,_t),gt&&(R&&B.deltaX>0&&R(B),w&&B.deltaX<0&&w(B),S&&S(B),U&&B.deltaX<0!=At<0&&U(B),At=B.deltaX,ct[0]=ct[1]=ct[2]=0),Gt&&(C&&B.deltaY>0&&C(B),b&&B.deltaY<0&&b(B),M&&M(B),O&&B.deltaY<0!=ie<0&&O(B),ie=B.deltaY,_t[0]=_t[1]=_t[2]=0),(Pt||Nt)&&(X&&X(B),Nt&&(m&&Nt===1&&m(B),E&&E(B),Nt=0),Pt=!1),ge&&!(ge=!1)&&Et&&Et(B),I&&(ut(B),I=!1),Ot=0},St=function(Rt,Kt,gt){ct[gt]+=Rt,_t[gt]+=Kt,B._vx.update(Rt),B._vy.update(Kt),c?Ot||(Ot=requestAnimationFrame(It)):It()},$t=function(Rt,Kt){Mt&&!zt&&(B.axis=zt=Math.abs(Rt)>Math.abs(Kt)?"x":"y",ge=!0),zt!=="y"&&(ct[2]+=Rt,B._vx.update(Rt,!0)),zt!=="x"&&(_t[2]+=Kt,B._vy.update(Kt,!0)),c?Ot||(Ot=requestAnimationFrame(It)):It()},Bt=function(Rt){if(!lt(Rt,1)){Rt=Ws(Rt,u);var Kt=Rt.clientX,gt=Rt.clientY,Gt=Kt-B.x,Ct=gt-B.y,Vt=B.isDragging;B.x=Kt,B.y=gt,(Vt||(Gt||Ct)&&(Math.abs(B.startX-Kt)>=s||Math.abs(B.startY-gt)>=s))&&(Nt=Vt?2:1,Vt||(B.isDragging=!0),$t(Gt,Ct))}},se=B.onPress=function(xt){lt(xt,1)||xt&&xt.button||(B.axis=zt=null,qt.pause(),B.isPressed=!0,xt=Ws(xt),At=ie=0,B.startX=B.x=xt.clientX,B.startY=B.y=xt.clientY,B._vx.reset(),B._vy.reset(),cn(z?a:dt,ii[1],Bt,Dt,!0),B.deltaX=B.deltaY=0,v&&v(B))},L=B.onRelease=function(xt){if(!lt(xt,1)){ln(z?a:dt,ii[1],Bt,!0);var Rt=!isNaN(B.y-B.startY),Kt=B.isDragging,gt=Kt&&(Math.abs(B.x-B.startX)>3||Math.abs(B.y-B.startY)>3),Gt=Ws(xt);!gt&&Rt&&(B._vx.reset(),B._vy.reset(),u&&et&&Ze.delayedCall(.08,function(){if(ho()-Xt>300&&!xt.defaultPrevented){if(xt.target.click)xt.target.click();else if(dt.createEvent){var Ct=dt.createEvent("MouseEvents");Ct.initMouseEvent("click",!0,!0,Fn,1,Gt.screenX,Gt.screenY,Gt.clientX,Gt.clientY,!1,!1,!1,!1,0,null),xt.target.dispatchEvent(Ct)}}})),B.isDragging=B.isGesturing=B.isPressed=!1,h&&Kt&&!z&&qt.restart(!0),Nt&&It(),p&&Kt&&p(B),x&&x(B,gt)}},ft=function(Rt){return Rt.touches&&Rt.touches.length>1&&(B.isGesturing=!0)&&nt(Rt,B.isDragging)},K=function(){return(B.isGesturing=!1)||D(B)},J=function(Rt){if(!lt(Rt)){var Kt=A(),gt=y();St((Kt-G)*j,(gt-tt)*j,1),G=Kt,tt=gt,h&&qt.restart(!0)}},ht=function(Rt){if(!lt(Rt)){Rt=Ws(Rt,u),ut&&(I=!0);var Kt=(Rt.deltaMode===1?l:Rt.deltaMode===2?Fn.innerHeight:1)*g;St(Rt.deltaX*Kt,Rt.deltaY*Kt,0),h&&!z&&qt.restart(!0)}},pt=function(Rt){if(!lt(Rt)){var Kt=Rt.clientX,gt=Rt.clientY,Gt=Kt-B.x,Ct=gt-B.y;B.x=Kt,B.y=gt,Pt=!0,h&&qt.restart(!0),(Gt||Ct)&&$t(Gt,Ct)}},kt=function(Rt){B.event=Rt,H(B)},le=function(Rt){B.event=Rt,$(B)},Pe=function(Rt){return lt(Rt)||Ws(Rt,u)&&k(B)};qt=B._dc=Ze.delayedCall(f||.25,Ut).pause(),B.deltaX=B.deltaY=0,B._vx=Mc(0,50,!0),B._vy=Mc(0,50,!0),B.scrollX=A,B.scrollY=y,B.isDragging=B.isGesturing=B.isPressed=!1,Vd(this),B.enable=function(xt){return B.isEnabled||(cn(Z?dt:a,"scroll",xc),o.indexOf("scroll")>=0&&cn(Z?dt:a,"scroll",J,Dt,at),o.indexOf("wheel")>=0&&cn(a,"wheel",ht,Dt,at),(o.indexOf("touch")>=0&&kd||o.indexOf("pointer")>=0)&&(cn(a,ii[0],se,Dt,at),cn(dt,ii[2],L),cn(dt,ii[3],L),et&&cn(a,"click",rt,!0,!0),k&&cn(a,"click",Pe),nt&&cn(dt,"gesturestart",ft),D&&cn(dt,"gestureend",K),H&&cn(a,Sr+"enter",kt),$&&cn(a,Sr+"leave",le),X&&cn(a,Sr+"move",pt)),B.isEnabled=!0,B.isDragging=B.isGesturing=B.isPressed=Pt=Nt=!1,B._vx.reset(),B._vy.reset(),G=A(),tt=y(),xt&&xt.type&&se(xt),it&&it(B)),B},B.disable=function(){B.isEnabled&&(ds.filter(function(xt){return xt!==B&&fo(xt.target)}).length||ln(Z?dt:a,"scroll",xc),B.isPressed&&(B._vx.reset(),B._vy.reset(),ln(z?a:dt,ii[1],Bt,!0)),ln(Z?dt:a,"scroll",J,at),ln(a,"wheel",ht,at),ln(a,ii[0],se,at),ln(dt,ii[2],L),ln(dt,ii[3],L),ln(a,"click",rt,!0),ln(a,"click",Pe),ln(dt,"gesturestart",ft),ln(dt,"gestureend",K),ln(a,Sr+"enter",kt),ln(a,Sr+"leave",le),ln(a,Sr+"move",pt),B.isEnabled=B.isPressed=B.isDragging=!1,Tt&&Tt(B))},B.kill=B.revert=function(){B.disable();var xt=ds.indexOf(B);xt>=0&&ds.splice(xt,1),Li===B&&(Li=0)},ds.push(B),z&&fo(a)&&(Li=B),B.enable(_)},l_(r,[{key:"velocityX",get:function(){return this._vx.getVelocity()}},{key:"velocityY",get:function(){return this._vy.getVelocity()}}]),r}();Ne.version="3.12.7";Ne.create=function(r){return new Ne(r)};Ne.register=Yd;Ne.getAll=function(){return ds.slice()};Ne.getById=function(r){return ds.filter(function(t){return t.vars.id===r})[0]};Gd()&&Ze.registerPlugin(Ne);/*!
...
`].filter(oo).join(`
`)),o=pu(o),o=wf(o,e),o=Af(o,e),a=pu(a),a=wf(a,e),a=Af(a,e),o=Rf(o),a=Rf(a),e.isRawShaderMaterial!==!0&&(E=`#version 300 es
...
`)+`
`+p);const v=E+m+o,x=E+p+a,R=Ef(i,i.VERTEX_SHADER,v),w=Ef(i,i.FRAGMENT_SHADER,x);i.attachShader(_,R),i.attachShader(_,w),e.index0AttributeName!==void 0?i.bindAttribLocation(_,0,e.index0AttributeName):e.morphTargets===!0&&i.bindAttribLocation(_,0,"position"),i.linkProgram(_);function b(P){if(r.debug.checkShaderErrors){const U=i.getProgramInfoLog(_).trim(),O=i.getShaderInfoLog(R).trim(),H=i.getShaderInfoLog(w).trim();let $=!0,X=!0;if(i.getProgramParameter(_,i.LINK_STATUS)===!1)if($=!1,typeof r.debug.onShaderError=="function")r.debug.onShaderError(i,_,R,w);else{const Y=bf(i,R,"vertex"),z=bf(i,w,"fragment");console.error("THREE.WebGLProgram: Shader Error "+i.getError()+" - VALIDATE_STATUS "+i.getProgramParameter(_,i.VALIDATE_STATUS)+`
...
}`;function pS(r,t,e){let n=new Ku;const i=new ue,s=new ue,o=new De,a=new uS({depthPacking:ag}),l=new hS,c={},u=e.maxTextureSize,h={[cr]:_n,[_n]:cr,[fi]:fi},f=new ur({defines:{VSM_SAMPLES:8},uniforms:{shadow_pass:{value:null},resolution:{value:new ue},radius:{value:4}},vertexShader:fS,fragmentShader:dS}),d=f.clone();d.defines.HORIZONTAL_PASS=1;const g=new Jn;g.setAttribute("position",new vi(new Float32Array([-1,-1,.5,3,-1,.5,-1,3,.5]),3));const _=new Bn(g,f),m=this;this.enabled=!1,this.autoUpdate=!0,this.needsUpdate=!1,this.type=fp;let p=this.type;this.render=function(w,b,C){if(m.enabled===!1||m.autoUpdate===!1&&m.needsUpdate===!1||w.length===0)return;const S=r.getRenderTarget(),M=r.getActiveCubeFace(),P=r.getActiveMipmapLevel(),U=r.state;U.setBlending(rr),U.buffers.color.setClear(1,1,1,1),U.buffers.depth.setTest(!0),U.setScissorTest(!1);const O=p!==Ri&&this.type===Ri,H=p===Ri&&this.type!==Ri;for(let $=0,X=w.length;$<X;$++){const Y=w[$],z=Y.shadow;if(z===void 0){console.warn("THREE.WebGLShadowMap:",Y,"has no shadow.");continue}if(z.autoUpdate===!1&&z.needsUpdate===!1)continue;i.copy(z.mapSize);const nt=z.getFrameExtents();if(i.multiply(nt),s.copy(z.mapSize),(i.x>u||i.y>u)&&(i.x>u&&(s.x=Math.floor(u/nt.x),i.x=s.x*nt.x,z.mapSize.x=s.x),i.y>u&&(s.y=Math.floor(u/nt.y),i.y=s.y*nt.y,z.mapSize.y=s.y)),z.map===null||O===!0||H===!0){const ut=this.type!==Ri?{minFilter:oi,magFilter:oi}:{};z.map!==null&&z.map.dispose(),z.map=new Gr(i.x,i.y,ut),z.map.texture.name=Y.name+".shadowMap",z.camera.updateProjectionMatrix()}r.setRenderTarget(z.map),r.clear();const D=z.getViewportCount();for(let ut=0;ut<D;ut++){const it=z.getViewport(ut);o.set(s.x*it.x,s.y*it.y,s.x*it.z,s.y*it.w),U.viewport(o),z.updateMatrices(Y,ut),n=z.getFrustum(),x(b,C,z.camera,Y,this.type)}z.isPointLightShadow!==!0&&this.type===Ri&&E(z,C),z.needsUpdate=!1}p=this.type,m.needsUpdate=!1,r.setRenderTarget(S,M,P)};function E(w,b){const C=t.update(_);f.defines.VSM_SAMPLES!==w.blurSamples&&(f.defines.VSM_SAMPLES=w.blurSamples,d.defines.VSM_SAMPLES=w.blurSamples,f.needsUpdate=!0,d.needsUpdate=!0),w.mapPass===null&&(w.mapPass=new Gr(i.x,i.y)),f.uniforms.shadow_pass.value=w.map.texture,f.uniforms.resolution.value=w.mapSize,f.uniforms.radius.value=w.radius,r.setRenderTarget(w.mapPass),r.clear(),r.renderBufferDirect(b,null,C,f,_,null),d.uniforms.shadow_pass.value=w.mapPass.texture,d.uniforms.resolution.value=w.mapSize,d.uniforms.radius.value=w.radius,r.setRenderTarget(w.map),r.clear(),r.renderBufferDirect(b,null,C,d,_,null)}function v(w,b,C,S){let M=null;const P=C.isPointLight===!0?w.customDistanceMaterial:w.customDepthMaterial;if(P!==void 0)M=P;else if(M=C.isPointLight===!0?l:a,r.localClippingEnabled&&b.clipShadows===!0&&Array.isArray(b.clippingPlanes)&&b.clippingPlanes.length!==0||b.displacementMap&&b.displacementScale!==0||b.alphaMap&&b.alphaTest>0||b.map&&b.alphaTest>0){const U=M.uuid,O=b.uuid;let H=c[U];H===void 0&&(H={},c[U]=H);let $=H[O];$===void 0&&($=M.clone(),H[O]=$,b.addEventListener("dispose",R)),M=$}if(M.visible=b.visible,M.wireframe=b.wireframe,S===Ri?M.side=b.shadowSide!==null?b.shadowSide:b.side:M.side=b.shadowSide!==null?b.shadowSide:h[b.side],M.alphaMap=b.alphaMap,M.alphaTest=b.alphaTest,M.map=b.map,M.clipShadows=b.clipShadows,M.clippingPlanes=b.clippingPlanes,M.clipIntersection=b.clipIntersection,M.displacementMap=b.displacementMap,M.displacementScale=b.displacementScale,M.displacementBias=b.displacementBias,M.wireframeLinewidth=b.wireframeLinewidth,M.linewidth=b.linewidth,C.isPointLight===!0&&M.isMeshDistanceMaterial===!0){const U=r.properties.get(M);U.light=C}return M}function x(w,b,C,S,M){if(w.visible===!1)return;if(w.layers.test(b.layers)&&(w.isMesh||w.isLine||w.isPoints)&&(w.castShadow||w.receiveShadow&&M===Ri)&&(!w.frustumCulled||n.intersectsObject(w))){w.modelViewMatrix.multiplyMatrices(C.matrixWorldInverse,w.matrixWorld);const O=t.update(w),H=w.material;if(Array.isArray(H)){const $=O.groups;for(let X=0,Y=$.length;X<Y;X++){const z=$[X],nt=H[z.materialIndex];if(nt&&nt.visible){const D=v(w,nt,S,M);w.onBeforeShadow(r,w,b,C,O,D,z),r.renderBufferDirect(C,null,O,D,w,z),w.onAfterShadow(r,w,b,C,O,D,z)}}}else if(H.visible){const $=v(w,H,S,M);w.onBeforeShadow(r,w,b,C,O,$,null),r.renderBufferDirect(C,null,O,$,w,null),w.onAfterShadow(r,w,b,C,O,$,null)}}const U=w.children;for(let O=0,H=U.length;O<H;O++)x(U[O],b,C,S,M)}function R(w){w.target.removeEventListener("dispose",R);for(const C in c){const S=c[C],M=w.target.uuid;M in S&&(S[M].dispose(),delete S[M])}}}const mS={[Pc]:Dc,[Lc]:Nc,[Ic]:Fc,[Ds]:Uc,[Dc]:Pc,[Nc]:Lc,[Fc]:Ic,[Uc]:Ds};function _S(r,t){function e(){let L=!1;const ft=new De;let K=null;const J=new De(0,0,0,0);return{setMask:function(ht){K!==ht&&!L&&(r.colorMask(ht,ht,ht,ht),K=ht)},setLocked:function(ht){L=ht},setClear:function(ht,pt,kt,le,Pe){Pe===!0&&(ht*=le,pt*=le,kt*=le),ft.set(ht,pt,kt,le),J.equals(ft)===!1&&(r.clearColor(ht,pt,kt,le),J.copy(ft))},reset:function(){L=!1,K=null,J.set(-1,0,0,0)}}}function n(){let L=!1,ft=!1,K=null,J=null,ht=null;return{setReversed:function(pt){if(ft!==pt){const kt=t.get("EXT_clip_control");ft?kt.clipControlEXT(kt.LOWER_LEFT_EXT,kt.ZERO_TO_ONE_EXT):kt.clipControlEXT(kt.LOWER_LEFT_EXT,kt.NEGATIVE_ONE_TO_ONE_EXT);const le=ht;ht=null,this.setClear(le)}ft=pt},getReversed:function(){return ft},setTest:function(pt){pt?et(r.DEPTH_TEST):Mt(r.DEPTH_TEST)},setMask:function(pt){K!==pt&&!L&&(r.depthMask(pt),K=pt)},setFunc:function(pt){if(ft&&(pt=mS[pt]),J!==pt){switch(pt){case Pc:r.depthFunc(r.NEVER);break;case Dc:r.depthFunc(r.ALWAYS);break;case Lc:r.depthFunc(r.LESS);break;case Ds:r.depthFunc(r.LEQUAL);break;case Ic:r.depthFunc(r.EQUAL);break;case Uc:r.depthFunc(r.GEQUAL);break;case Nc:r.depthFunc(r.GREATER);break;case Fc:r.depthFunc(r.NOTEQUAL);break;default:r.depthFunc(r.LEQUAL)}J=pt}},setLocked:function(pt){L=pt},setClear:function(pt){ht!==pt&&(ft&&(pt=1-pt),r.clearDepth(pt),ht=pt)},reset:function(){L=!1,K=null,J=null,ht=null,ft=!1}}}function i(){let L=!1,ft=null,K=null,J=null,ht=null,pt=null,kt=null,le=null,Pe=null;return{setTest:function(xt){L||(xt?et(r.STENCIL_TEST):Mt(r.STENCIL_TEST))},setMask:function(xt){ft!==xt&&!L&&(r.stencilMask(xt),ft=xt)},setFunc:function(xt,Rt,Kt){(K!==xt||J!==Rt||ht!==Kt)&&(r.stencilFunc(xt,Rt,Kt),K=xt,J=Rt,ht=Kt)},setOp:function(xt,Rt,Kt){(pt!==xt||kt!==Rt||le!==Kt)&&(r.stencilOp(xt,Rt,Kt),pt=xt,kt=Rt,le=Kt)},setLocked:function(xt){L=xt},setClear:function(xt){Pe!==xt&&(r.clearStencil(xt),Pe=xt)},reset:function(){L=!1,ft=null,K=null,J=null,ht=null,pt=null,kt=null,le=null,Pe=null}}}const s=new e,o=new n,a=new i,l=new WeakMap,c=new WeakMap;let u={},h={},f=new WeakMap,d=[],g=null,_=!1,m=null,p=null,E=null,v=null,x=null,R=null,w=null,b=new ae(0,0,0),C=0,S=!1,M=null,P=null,U=null,O=null,H=null;const $=r.getParameter(r.MAX_COMBINED_TEXTURE_IMAGE_UNITS);let X=!1,Y=0;const z=r.getParameter(r.VERSION);z.indexOf("WebGL")!==-1?(Y=parseFloat(/^WebGL (\d)/.exec(z)[1]),X=Y>=1):z.indexOf("OpenGL ES")!==-1&&(Y=parseFloat(/^OpenGL ES (\d)/.exec(z)[1]),X=Y>=2);let nt=null,D={};const ut=r.getParameter(r.SCISSOR_BOX),it=r.getParameter(r.VIEWPORT),Tt=new De().fromArray(ut),k=new De().fromArray(it);function j(L,ft,K,J){const ht=new Uint8Array(4),pt=r.createTexture();r.bindTexture(L,pt),r.texParameteri(L,r.TEXTURE_MIN_FILTER,r.NEAREST),r.texParameteri(L,r.TEXTURE_MAG_FILTER,r.NEAREST);for(let kt=0;kt<K;kt++)L===r.TEXTURE_3D||L===r.TEXTURE_2D_ARRAY?r.texImage3D(ft,0,r.RGBA,1,1,J,0,r.RGBA,r.UNSIGNED_BYTE,ht):r.texImage2D(ft+kt,0,r.RGBA,1,1,0,r.RGBA,r.UNSIGNED_BYTE,ht);return pt}const at={};at[r.TEXTURE_2D]=j(r.TEXTURE_2D,r.TEXTURE_2D,1),at[r.TEXTURE_CUBE_MAP]=j(r.TEXTURE_CUBE_MAP,r.TEXTURE_CUBE_MAP_POSITIVE_X,6),at[r.TEXTURE_2D_ARRAY]=j(r.TEXTURE_2D_ARRAY,r.TEXTURE_2D_ARRAY,1,1),at[r.TEXTURE_3D]=j(r.TEXTURE_3D,r.TEXTURE_3D,1,1),s.setClear(0,0,0,1),o.setClear(1),a.setClear(0),et(r.DEPTH_TEST),o.setFunc(Ds),zt(!1),B(Nh),et(r.CULL_FACE),I(rr);function et(L){u[L]!==!0&&(r.enable(L),u[L]=!0)}function Mt(L){u[L]!==!1&&(r.disable(L),u[L]=!1)}function Et(L,ft){return h[L]!==ft?(r.bindFramebuffer(L,ft),h[L]=ft,L===r.DRAW_FRAMEBUFFER&&(h[r.FRAMEBUFFER]=ft),L===r.FRAMEBUFFER&&(h[r.DRAW_FRAMEBUFFER]=ft),!0):!1}function Ot(L,ft){let K=d,J=!1;if(L){K=f.get(ft),K===void 0&&(K=[],f.set(ft,K));const ht=L.textures;if(K.length!==ht.length||K[0]!==r.COLOR_ATTACHMENT0){for(let pt=0,kt=ht.length;pt<kt;pt++)K[pt]=r.COLOR_ATTACHMENT0+pt;K.length=ht.length,J=!0}}else K[0]!==r.BACK&&(K[0]=r.BACK,J=!0);J&&r.drawBuffers(K)}function qt(L){return g!==L?(r.useProgram(L),g=L,!0):!1}const Nt={[br]:r.FUNC_ADD,[I_]:r.FUNC_SUBTRACT,[U_]:r.FUNC_REVERSE_SUBTRACT};Nt[N_]=r.MIN,Nt[F_]=r.MAX;const Pt={[O_]:r.ZERO,[B_]:r.ONE,[z_]:r.SRC_COLOR,[Rc]:r.SRC_ALPHA,[X_]:r.SRC_ALPHA_SATURATE,[G_]:r.DST_COLOR,[H_]:r.DST_ALPHA,[k_]:r.ONE_MINUS_SRC_COLOR,[Cc]:r.ONE_MINUS_SRC_ALPHA,[W_]:r.ONE_MINUS_DST_COLOR,[V_]:r.ONE_MINUS_DST_ALPHA,[Y_]:r.CONSTANT_COLOR,[q_]:r.ONE_MINUS_CONSTANT_COLOR,[$_]:r.CONSTANT_ALPHA,[K_]:r.ONE_MINUS_CONSTANT_ALPHA};function I(L,ft,K,J,ht,pt,kt,le,Pe,xt){if(L===rr){_===!0&&(Mt(r.BLEND),_=!1);return}if(_===!1&&(et(r.BLEND),_=!0),L!==L_){if(L!==m||xt!==S){if((p!==br||x!==br)&&(r.blendEquation(r.FUNC_ADD),p=br,x=br),xt)switch(L){case Ss:r.blendFuncSeparate(r.ONE,r.ONE_MINUS_SRC_ALPHA,r.ONE,r.ONE_MINUS_SRC_ALPHA);break;case Fh:r.blendFunc(r.ONE,r.ONE);break;case Oh:r.blendFuncSeparate(r.ZERO,r.ONE_MINUS_SRC_COLOR,r.ZERO,r.ONE);break;case Bh:r.blendFuncSeparate(r.ZERO,r.SRC_COLOR,r.ZERO,r.SRC_ALPHA);break;default:console.error("THREE.WebGLState: Invalid blending: ",L);break}else switch(L){case Ss:r.blendFuncSeparate(r.SRC_ALPHA,r.ONE_MINUS_SRC_ALPHA,r.ONE,r.ONE_MINUS_SRC_ALPHA);break;case Fh:r.blendFunc(r.SRC_ALPHA,r.ONE);break;case Oh:r.blendFuncSeparate(r.ZERO,r.ONE_MINUS_SRC_COLOR,r.ZERO,r.ONE);break;case Bh:r.blendFunc(r.ZERO,r.SRC_COLOR);break;default:console.error("THREE.WebGLState: Invalid blending: ",L);break}E=null,v=null,R=null,w=null,b.set(0,0,0),C=0,m=L,S=xt}return}ht=ht||ft,pt=pt||K,kt=kt||J,(ft!==p||ht!==x)&&(r.blendEquationSeparate(Nt[ft],Nt[ht]),p=ft,x=ht),(K!==E||J!==v||pt!==R||kt!==w)&&(r.blendFuncSeparate(Pt[K],Pt[J],Pt[pt],Pt[kt]),E=K,v=J,R=pt,w=kt),(le.equals(b)===!1||Pe!==C)&&(r.blendColor(le.r,le.g,le.b,Pe),b.copy(le),C=Pe),m=L,S=!1}function ge(L,ft){L.side===fi?Mt(r.CULL_FACE):et(r.CULL_FACE);let K=L.side===_n;ft&&(K=!K),zt(K),L.blending===Ss&&L.transparent===!1?I(rr):I(L.blending,L.blendEquation,L.blendSrc,L.blendDst,L.blendEquationAlpha,L.blendSrcAlpha,L.blendDstAlpha,L.blendColor,L.blendAlpha,L.premultipliedAlpha),o.setFunc(L.depthFunc),o.setTest(L.depthTest),o.setMask(L.depthWrite),s.setMask(L.colorWrite);const J=L.stencilWrite;a.setTest(J),J&&(a.setMask(L.stencilWriteMask),a.setFunc(L.stencilFunc,L.stencilRef,L.stencilFuncMask),a.setOp(L.stencilFail,L.stencilZFail,L.stencilZPass)),ie(L.polygonOffset,L.polygonOffsetFactor,L.polygonOffsetUnits),L.alphaToCoverage===!0?et(r.SAMPLE_ALPHA_TO_COVERAGE):Mt(r.SAMPLE_ALPHA_TO_COVERAGE)}function zt(L){M!==L&&(L?r.frontFace(r.CW):r.frontFace(r.CCW),M=L)}function B(L){L!==C_?(et(r.CULL_FACE),L!==P&&(L===Nh?r.cullFace(r.BACK):L===P_?r.cullFace(r.FRONT):r.cullFace(r.FRONT_AND_BACK))):Mt(r.CULL_FACE),P=L}function At(L){L!==U&&(X&&r.lineWidth(L),U=L)}function ie(L,ft,K){L?(et(r.POLYGON_OFFSET_FILL),(O!==ft||H!==K)&&(r.polygonOffset(ft,K),O=ft,H=K)):Mt(r.POLYGON_OFFSET_FILL)}function Dt(L){L?et(r.SCISSOR_TEST):Mt(r.SCISSOR_TEST)}function A(L){L===void 0&&(L=r.TEXTURE0+$-1),nt!==L&&(r.activeTexture(L),nt=L)}function y(L,ft,K){K===void 0&&(nt===null?K=r.TEXTURE0+$-1:K=nt);let J=D[K];J===void 0&&(J={type:void 0,texture:void 0},D[K]=J),(J.type!==L||J.texture!==ft)&&(nt!==K&&(r.activeTexture(K),nt=K),r.bindTexture(L,ft||at[L]),J.type=L,J.texture=ft)}function G(){const L=D[nt];L!==void 0&&L.type!==void 0&&(r.bindTexture(L.type,null),L.type=void 0,L.texture=void 0)}function tt(){try{r.compressedTexImage2D.apply(r,arguments)}catch(L){console.error("THREE.WebGLState:",L)}}function Q(){try{r.compressedTexImage3D.apply(r,arguments)}catch(L){console.error("THREE.WebGLState:",L)}}function Z(){try{r.texSubImage2D.apply(r,arguments)}catch(L){console.error("THREE.WebGLState:",L)}}function dt(){try{r.texSubImage3D.apply(r,arguments)}catch(L){console.error("THREE.WebGLState:",L)}}function ct(){try{r.compressedTexSubImage2D.apply(r,arguments)}catch(L){console.error("THREE.WebGLState:",L)}}function _t(){try{r.compressedTexSubImage3D.apply(r,arguments)}catch(L){console.error("THREE.WebGLState:",L)}}function Xt(){try{r.texStorage2D.apply(r,arguments)}catch(L){console.error("THREE.WebGLState:",L)}}function rt(){try{r.texStorage3D.apply(r,arguments)}catch(L){console.error("THREE.WebGLState:",L)}}function lt(){try{r.texImage2D.apply(r,arguments)}catch(L){console.error("THREE.WebGLState:",L)}}function Ut(){try{r.texImage3D.apply(r,arguments)}catch(L){console.error("THREE.WebGLState:",L)}}function It(L){Tt.equals(L)===!1&&(r.scissor(L.x,L.y,L.z,L.w),Tt.copy(L))}function St(L){k.equals(L)===!1&&(r.viewport(L.x,L.y,L.z,L.w),k.copy(L))}function $t(L,ft){let K=c.get(ft);K===void 0&&(K=new WeakMap,c.set(ft,K));let J=K.get(L);J===void 0&&(J=r.getUniformBlockIndex(ft,L.name),K.set(L,J))}function Bt(L,ft){const J=c.get(ft).get(L);l.get(ft)!==J&&(r.uniformBlockBinding(ft,J,L.__bindingPointIndex),l.set(ft,J))}function se(){r.disable(r.BLEND),r.disable(r.CULL_FACE),r.disable(r.DEPTH_TEST),r.disable(r.POLYGON_OFFSET_FILL),r.disable(r.SCISSOR_TEST),r.disable(r.STENCIL_TEST),r.disable(r.SAMPLE_ALPHA_TO_COVERAGE),r.blendEquation(r.FUNC_ADD),r.blendFunc(r.ONE,r.ZERO),r.blendFuncSeparate(r.ONE,r.ZERO,r.ONE,r.ZERO),r.blendColor(0,0,0,0),r.colorMask(!0,!0,!0,!0),r.clearColor(0,0,0,0),r.depthMask(!0),r.depthFunc(r.LESS),o.setReversed(!1),r.clearDepth(1),r.stencilMask(4294967295),r.stencilFunc(r.ALWAYS,0,4294967295),r.stencilOp(r.KEEP,r.KEEP,r.KEEP),r.clearStencil(0),r.cullFace(r.BACK),r.frontFace(r.CCW),r.polygonOffset(0,0),r.activeTexture(r.TEXTURE0),r.bindFramebuffer(r.FRAMEBUFFER,null),r.bindFramebuffer(r.DRAW_FRAMEBUFFER,null),r.bindFramebuffer(r.READ_FRAMEBUFFER,null),r.useProgram(null),r.lineWidth(1),r.scissor(0,0,r.canvas.width,r.canvas.height),r.viewport(0,0,r.canvas.width,r.canvas.height),u={},nt=null,D={},h={},f=new WeakMap,d=[],g=null,_=!1,m=null,p=null,E=null,v=null,x=null,R=null,w=null,b=new ae(0,0,0),C=0,S=!1,M=null,P=null,U=null,O=null,H=null,Tt.set(0,0,r.canvas.width,r.canvas.height),k.set(0,0,r.canvas.width,r.canvas.height),s.reset(),o.reset(),a.reset()}return{buffers:{color:s,depth:o,stencil:a},enable:et,disable:Mt,bindFramebuffer:Et,drawBuffers:Ot,useProgram:qt,setBlending:I,setMaterial:ge,setFlipSided:zt,setCullFace:B,setLineWidth:At,setPolygonOffset:ie,setScissorTest:Dt,activeTexture:A,bindTexture:y,unbindTexture:G,compressedTexImage2D:tt,compressedTexImage3D:Q,texImage2D:lt,texImage3D:Ut,updateUBOMapping:$t,uniformBlockBinding:Bt,texStorage2D:Xt,texStorage3D:rt,texSubImage2D:Z,texSubImage3D:dt,compressedTexSubImage2D:ct,compressedTexSubImage3D:_t,scissor:It,viewport:St,reset:se}}function If(r,t,e,n){const i=gS(n);switch(e){case gp:return r*t;case xp:return r*t;case Mp:return r*t*2;case Sp:return r*t/i.components*i.byteLength;case Yu:return r*t/i.components*i.byteLength;case yp:return r*t*2/i.components*i.byteLength;case qu:return r*t*2/i.components*i.byteLength;case vp:return r*t*3/i.components*i.byteLength;case si:return r*t*4/i.components*i.byteLength;case $u:return r*t*4/i.components*i.byteLength;case Da:case La:return Math.floor((r+3)/4)*Math.floor((t+3)/4)*8;case Ia:case Ua:return Math.floor((r+3)/4)*Math.floor((t+3)/4)*16;case Vc:case Wc:return Math.max(r,16)*Math.max(t,8)/4;case Hc:case Gc:return Math.max(r,8)*Math.max(t,8)/2;case Xc:case Yc:return Math.floor((r+3)/4)*Math.floor((t+3)/4)*8;case qc:return Math.floor((r+3)/4)*Math.floor((t+3)/4)*16;case $c:return Math.floor((r+3)/4)*Math.floor((t+3)/4)*16;case Kc:return Math.floor((r+4)/5)*Math.floor((t+3)/4)*16;case Zc:return Math.floor((r+4)/5)*Math.floor((t+4)/5)*16;case jc:return Math.floor((r+5)/6)*Math.floor((t+4)/5)*16;case Jc:return Math.floor((r+5)/6)*Math.floor((t+5)/6)*16;case Qc:return Math.floor((r+7)/8)*Math.floor((t+4)/5)*16;case tu:return Math.floor((r+7)/8)*Math.floor((t+5)/6)*16;case eu:return Math.floor((r+7)/8)*Math.floor((t+7)/8)*16;case nu:return Math.floor((r+9)/10)*Math.floor((t+4)/5)*16;case iu:return Math.floor((r+9)/10)*Math.floor((t+5)/6)*16;case ru:return Math.floor((r+9)/10)*Math.floor((t+7)/8)*16;case su:return Math.floor((r+9)/10)*Math.floor((t+9)/10)*16;case ou:return Math.floor((r+11)/12)*Math.floor((t+9)/10)*16;case au:return Math.floor((r+11)/12)*Math.floor((t+11)/12)*16;case Na:case lu:case cu:return Math.ceil(r/4)*Math.ceil(t/4)*16;case Ep:case uu:return Math.ceil(r/4)*Math.ceil(t/4)*8;case hu:case fu:return Math.ceil(r/4)*Math.ceil(t/4)*16}throw new Error(`Unable to determine texture byte length for ${e} format.`)}function gS(r){switch(r){case zi:case pp:return{byteLength:1,components:1};case Do:case mp:case Io:return{byteLength:2,components:1};case Wu:case Xu:return{byteLength:2,components:4};case Vr:case Gu:case Ii:return{byteLength:4,components:1};case _p:return{byteLength:4,components:3}}throw new Error(`Unknown texture type ${r}.`)}function vS(r,t,e,n,i,s,o){const a=t.has("WEBGL_multisampled_render_to_texture")?t.get("WEBGL_multisampled_render_to_texture"):null,l=typeof navigator>"u"?!1:/OculusBrowser/g.test(navigator.userAgent),c=new ue,u=new WeakMap;let h;const f=new WeakMap;let d=!1;try{d=typeof OffscreenCanvas<"u"&&new OffscreenCanvas(1,1).getContext("2d")!==null}catch{}function g(A,y){return d?new OffscreenCanvas(A,y):Za("canvas")}function _(A,y,G){let tt=1;const Q=Dt(A);if((Q.width>G||Q.height>G)&&(tt=G/Math.max(Q.width,Q.height)),tt<1)if(typeof HTMLImageElement<"u"&&A instanceof HTMLImageElement||typeof HTMLCanvasElement<"u"&&A instanceof HTMLCanvasElement||typeof ImageBitmap<"u"&&A instanceof ImageBitmap||typeof VideoFrame<"u"&&A instanceof VideoFrame){const Z=Math.floor(tt*Q.width),dt=Math.floor(tt*Q.height);h===void 0&&(h=g(Z,dt));const ct=y?g(Z,dt):h;return ct.width=Z,ct.height=dt,ct.getContext("2d").drawImage(A,0,0,Z,dt),console.warn("THREE.WebGLRenderer: Texture has been resized from ("+Q.width+"x"+Q.height+") to ("+Z+"x"+dt+")."),ct}else return"data"in A&&console.warn("THREE.WebGLRenderer: Image in DataTexture is too big ("+Q.width+"x"+Q.height+")."),A;return A}function m(A){return A.generateMipmaps}function p(A){r.generateMipmap(A)}function E(A){return A.isWebGLCubeRenderTarget?r.TEXTURE_CUBE_MAP:A.isWebGL3DRenderTarget?r.TEXTURE_3D:A.isWebGLArrayRenderTarget||A.isCompressedArrayTexture?r.TEXTURE_2D_ARRAY:r.TEXTURE_2D}function v(A,y,G,tt,Q=!1){if(A!==null){if(r[A]!==void 0)return r[A];console.warn("THREE.WebGLRenderer: Attempt to use non-existing WebGL internal format '"+A+"'")}let Z=y;if(y===r.RED&&(G===r.FLOAT&&(Z=r.R32F),G===r.HALF_FLOAT&&(Z=r.R16F),G===r.UNSIGNED_BYTE&&(Z=r.R8)),y===r.RED_INTEGER&&(G===r.UNSIGNED_BYTE&&(Z=r.R8UI),G===r.UNSIGNED_SHORT&&(Z=r.R16UI),G===r.UNSIGNED_INT&&(Z=r.R32UI),G===r.BYTE&&(Z=r.R8I),G===r.SHORT&&(Z=r.R16I),G===r.INT&&(Z=r.R32I)),y===r.RG&&(G===r.FLOAT&&(Z=r.RG32F),G===r.HALF_FLOAT&&(Z=r.RG16F),G===r.UNSIGNED_BYTE&&(Z=r.RG8)),y===r.RG_INTEGER&&(G===r.UNSIGNED_BYTE&&(Z=r.RG8UI),G===r.UNSIGNED_SHORT&&(Z=r.RG16UI),G===r.UNSIGNED_INT&&(Z=r.RG32UI),G===r.BYTE&&(Z=r.RG8I),G===r.SHORT&&(Z=r.RG16I),G===r.INT&&(Z=r.RG32I)),y===r.RGB_INTEGER&&(G===r.UNSIGNED_BYTE&&(Z=r.RGB8UI),G===r.UNSIGNED_SHORT&&(Z=r.RGB16UI),G===r.UNSIGNED_INT&&(Z=r.RGB32UI),G===r.BYTE&&(Z=r.RGB8I),G===r.SHORT&&(Z=r.RGB16I),G===r.INT&&(Z=r.RGB32I)),y===r.RGBA_INTEGER&&(G===r.UNSIGNED_BYTE&&(Z=r.RGBA8UI),G===r.UNSIGNED_SHORT&&(Z=r.RGBA16UI),G===r.UNSIGNED_INT&&(Z=r.RGBA32UI),G===r.BYTE&&(Z=r.RGBA8I),G===r.SHORT&&(Z=r.RGBA16I),G===r.INT&&(Z=r.RGBA32I)),y===r.RGB&&G===r.UNSIGNED_INT_5_9_9_9_REV&&(Z=r.RGB9_E5),y===r.RGBA){const dt=Q?rl:oe.getTransfer(tt);G===r.FLOAT&&(Z=r.RGBA32F),G===r.HALF_FLOAT&&(Z=r.RGBA16F),G===r.UNSIGNED_BYTE&&(Z=dt===_e?r.SRGB8_ALPHA8:r.RGBA8),G===r.UNSIGNED_SHORT_4_4_4_4&&(Z=r.RGBA4),G===r.UNSIGNED_SHORT_5_5_5_1&&(Z=r.RGB5_A1)}return(Z===r.R16F||Z===r.R32F||Z===r.RG16F||Z===r.RG32F||Z===r.RGBA16F||Z===r.RGBA32F)&&t.get("EXT_color_buffer_float"),Z}function x(A,y){let G;return A?y===null||y===Vr||y===Us?G=r.DEPTH24_STENCIL8:y===Ii?G=r.DEPTH32F_STENCIL8:y===Do&&(G=r.DEPTH24_STENCIL8,console.warn("DepthTexture: 16 bit depth attachment is not supported with stencil. Using 24-bit attachment.")):y===null||y===Vr||y===Us?G=r.DEPTH_COMPONENT24:y===Ii?G=r.DEPTH_COMPONENT32F:y===Do&&(G=r.DEPTH_COMPONENT16),G}function R(A,y){return m(A)===!0||A.isFramebufferTexture&&A.minFilter!==oi&&A.minFilter!==mi?Math.log2(Math.max(y.width,y.height))+1:A.mipmaps!==void 0&&A.mipmaps.length>0?A.mipmaps.length:A.isCompressedTexture&&Array.isArray(A.image)?y.mipmaps.length:1}function w(A){const y=A.target;y.removeEventListener("dispose",w),C(y),y.isVideoTexture&&u.delete(y)}function b(A){const y=A.target;y.removeEventListener("dispose",b),M(y)}function C(A){const y=n.get(A);if(y.__webglInit===void 0)return;const G=A.source,tt=f.get(G);if(tt){const Q=tt[y.__cacheKey];Q.usedTimes--,Q.usedTimes===0&&S(A),Object.keys(tt).length===0&&f.delete(G)}n.remove(A)}function S(A){const y=n.get(A);r.deleteTexture(y.__webglTexture);const G=A.source,tt=f.get(G);delete tt[y.__cacheKey],o.memory.textures--}function M(A){const y=n.get(A);if(A.depthTexture&&(A.depthTexture.dispose(),n.remove(A.depthTexture)),A.isWebGLCubeRenderTarget)for(let tt=0;tt<6;tt++){if(Array.isArray(y.__webglFramebuffer[tt]))for(let Q=0;Q<y.__webglFramebuffer[tt].length;Q++)r.deleteFramebuffer(y.__webglFramebuffer[tt][Q]);else r.deleteFramebuffer(y.__webglFramebuffer[tt]);y.__webglDepthbuffer&&r.deleteRenderbuffer(y.__webglDepthbuffer[tt])}else{if(Array.isArray(y.__webglFramebuffer))for(let tt=0;tt<y.__webglFramebuffer.length;tt++)r.deleteFramebuffer(y.__webglFramebuffer[tt]);else r.deleteFramebuffer(y.__webglFramebuffer);if(y.__webglDepthbuffer&&r.deleteRenderbuffer(y.__webglDepthbuffer),y.__webglMultisampledFramebuffer&&r.deleteFramebuffer(y.__webglMultisampledFramebuffer),y.__webglColorRenderbuffer)for(let tt=0;tt<y.__webglColorRenderbuffer.length;tt++)y.__webglColorRenderbuffer[tt]&&r.deleteRenderbuffer(y.__webglColorRenderbuffer[tt]);y.__webglDepthRenderbuffer&&r.deleteRenderbuffer(y.__webglDepthRenderbuffer)}const G=A.textures;for(let tt=0,Q=G.length;tt<Q;tt++){const Z=n.get(G[tt]);Z.__webglTexture&&(r.deleteTexture(Z.__webglTexture),o.memory.textures--),n.remove(G[tt])}n.remove(A)}let P=0;function U(){P=0}function O(){const A=P;return A>=i.maxTextures&&console.warn("THREE.WebGLTextures: Trying to use "+A+" texture units while this GPU supports only "+i.maxTextures),P+=1,A}function H(A){const y=[];return y.push(A.wrapS),y.push(A.wrapT),y.push(A.wrapR||0),y.push(A.magFilter),y.push(A.minFilter),y.push(A.anisotropy),y.push(A.internalFormat),y.push(A.format),y.push(A.type),y.push(A.generateMipmaps),y.push(A.premultiplyAlpha),y.push(A.flipY),y.push(A.unpackAlignment),y.push(A.colorSpace),y.join()}function $(A,y){const G=n.get(A);if(A.isVideoTexture&&At(A),A.isRenderTargetTexture===!1&&A.version>0&&G.__version!==A.version){const tt=A.image;if(tt===null)console.warn("THREE.WebGLRenderer: Texture marked for update but no image data found.");else if(tt.complete===!1)console.warn("THREE.WebGLRenderer: Texture marked for update but image is incomplete");else{k(G,A,y);return}}e.bindTexture(r.TEXTURE_2D,G.__webglTexture,r.TEXTURE0+y)}function X(A,y){const G=n.get(A);if(A.version>0&&G.__version!==A.version){k(G,A,y);return}e.bindTexture(r.TEXTURE_2D_ARRAY,G.__webglTexture,r.TEXTURE0+y)}function Y(A,y){const G=n.get(A);if(A.version>0&&G.__version!==A.version){k(G,A,y);return}e.bindTexture(r.TEXTURE_3D,G.__webglTexture,r.TEXTURE0+y)}function z(A,y){const G=n.get(A);if(A.version>0&&G.__version!==A.version){j(G,A,y);return}e.bindTexture(r.TEXTURE_CUBE_MAP,G.__webglTexture,r.TEXTURE0+y)}const nt={[zc]:r.REPEAT,[Cr]:r.CLAMP_TO_EDGE,[kc]:r.MIRRORED_REPEAT},D={[oi]:r.NEAREST,[sg]:r.NEAREST_MIPMAP_NEAREST,[jo]:r.NEAREST_MIPMAP_LINEAR,[mi]:r.LINEAR,[El]:r.LINEAR_MIPMAP_NEAREST,[Pr]:r.LINEAR_MIPMAP_LINEAR},ut={[cg]:r.NEVER,[mg]:r.ALWAYS,[ug]:r.LESS,[bp]:r.LEQUAL,[hg]:r.EQUAL,[pg]:r.GEQUAL,[fg]:r.GREATER,[dg]:r.NOTEQUAL};function it(A,y){if(y.type===Ii&&t.has("OES_texture_float_linear")===!1&&(y.magFilter===mi||y.magFilter===El||y.magFilter===jo||y.magFilter===Pr||y.minFilter===mi||y.minFilter===El||y.minFilter===jo||y.minFilter===Pr)&&console.warn("THREE.WebGLRenderer: Unable to use linear filtering with floating point textures. OES_texture_float_linear not supported on this device."),r.texParameteri(A,r.TEXTURE_WRAP_S,nt[y.wrapS]),r.texParameteri(A,r.TEXTURE_WRAP_T,nt[y.wrapT]),(A===r.TEXTURE_3D||A===r.TEXTURE_2D_ARRAY)&&r.texParameteri(A,r.TEXTURE_WRAP_R,nt[y.wrapR]),r.texParameteri(A,r.TEXTURE_MAG_FILTER,D[y.magFilter]),r.texParameteri(A,r.TEXTURE_MIN_FILTER,D[y.minFilter]),y.compareFunction&&(r.texParameteri(A,r.TEXTURE_COMPARE_MODE,r.COMPARE_REF_TO_TEXTURE),r.texParameteri(A,r.TEXTURE_COMPARE_FUNC,ut[y.compareFunction])),t.has("EXT_texture_filter_anisotropic")===!0){if(y.magFilter===oi||y.minFilter!==jo&&y.minFilter!==Pr||y.type===Ii&&t.has("OES_texture_float_linear")===!1)return;if(y.anisotropy>1||n.get(y).__currentAnisotropy){const G=t.get("EXT_texture_filter_anisotropic");r.texParameterf(A,G.TEXTURE_MAX_ANISOTROPY_EXT,Math.min(y.anisotropy,i.getMaxAnisotropy())),n.get(y).__currentAnisotropy=y.anisotropy}}}function Tt(A,y){let G=!1;A.__webglInit===void 0&&(A.__webglInit=!0,y.addEventListener("dispose",w));const tt=y.source;let Q=f.get(tt);Q===void 0&&(Q={},f.set(tt,Q));const Z=H(y);if(Z!==A.__cacheKey){Q[Z]===void 0&&(Q[Z]={texture:r.createTexture(),usedTimes:0},o.memory.textures++,G=!0),Q[Z].usedTimes++;const dt=Q[A.__cacheKey];dt!==void 0&&(Q[A.__cacheKey].usedTimes--,dt.usedTimes===0&&S(y)),A.__cacheKey=Z,A.__webglTexture=Q[Z].texture}return G}function k(A,y,G){let tt=r.TEXTURE_2D;(y.isDataArrayTexture||y.isCompressedArrayTexture)&&(tt=r.TEXTURE_2D_ARRAY),y.isData3DTexture&&(tt=r.TEXTURE_3D);const Q=Tt(A,y),Z=y.source;e.bindTexture(tt,A.__webglTexture,r.TEXTURE0+G);const dt=n.get(Z);if(Z.version!==dt.__version||Q===!0){e.activeTexture(r.TEXTURE0+G);const ct=oe.getPrimaries(oe.workingColorSpace),_t=y.colorSpace===Ki?null:oe.getPrimaries(y.colorSpace),Xt=y.colorSpace===Ki||ct===_t?r.NONE:r.BROWSER_DEFAULT_WEBGL;r.pixelStorei(r.UNPACK_FLIP_Y_WEBGL,y.flipY),r.pixelStorei(r.UNPACK_PREMULTIPLY_ALPHA_WEBGL,y.premultiplyAlpha),r.pixelStorei(r.UNPACK_ALIGNMENT,y.unpackAlignment),r.pixelStorei(r.UNPACK_COLORSPACE_CONVERSION_WEBGL,Xt);let rt=_(y.image,!1,i.maxTextureSize);rt=ie(y,rt);const lt=s.convert(y.format,y.colorSpace),Ut=s.convert(y.type);let It=v(y.internalFormat,lt,Ut,y.colorSpace,y.isVideoTexture);it(tt,y);let St;const $t=y.mipmaps,Bt=y.isVideoTexture!==!0,se=dt.__version===void 0||Q===!0,L=Z.dataReady,ft=R(y,rt);if(y.isDepthTexture)It=x(y.format===Ns,y.type),se&&(Bt?e.texStorage2D(r.TEXTURE_2D,1,It,rt.width,rt.height):e.texImage2D(r.TEXTURE_2D,0,It,rt.width,rt.height,0,lt,Ut,null));else if(y.isDataTexture)if($t.length>0){Bt&&se&&e.texStorage2D(r.TEXTURE_2D,ft,It,$t[0].width,$t[0].height);for(let K=0,J=$t.length;K<J;K++)St=$t[K],Bt?L&&e.texSubImage2D(r.TEXTURE_2D,K,0,0,St.width,St.height,lt,Ut,St.data):e.texImage2D(r.TEXTURE_2D,K,It,St.width,St.height,0,lt,Ut,St.data);y.generateMipmaps=!1}else Bt?(se&&e.texStorage2D(r.TEXTURE_2D,ft,It,rt.width,rt.height),L&&e.texSubImage2D(r.TEXTURE_2D,0,0,0,rt.width,rt.height,lt,Ut,rt.data)):e.texImage2D(r.TEXTURE_2D,0,It,rt.width,rt.height,0,lt,Ut,rt.data);else if(y.isCompressedTexture)if(y.isCompressedArrayTexture){Bt&&se&&e.texStorage3D(r.TEXTURE_2D_ARRAY,ft,It,$t[0].width,$t[0].height,rt.depth);for(let K=0,J=$t.length;K<J;K++)if(St=$t[K],y.format!==si)if(lt!==null)if(Bt){if(L)if(y.layerUpdates.size>0){const ht=If(St.width,St.height,y.format,y.type);for(const pt of y.layerUpdates){const kt=St.data.subarray(pt*ht/St.data.BYTES_PER_ELEMENT,(pt+1)*ht/St.data.BYTES_PER_ELEMENT);e.compressedTexSubImage3D(r.TEXTURE_2D_ARRAY,K,0,0,pt,St.width,St.height,1,lt,kt)}y.clearLayerUpdates()}else e.compressedTexSubImage3D(r.TEXTURE_2D_ARRAY,K,0,0,0,St.width,St.height,rt.depth,lt,St.data)}else e.compressedTexImage3D(r.TEXTURE_2D_ARRAY,K,It,St.width,St.height,rt.depth,0,St.data,0,0);else console.warn("THREE.WebGLRenderer: Attempt to load unsupported compressed texture format in .uploadTexture()");else Bt?L&&e.texSubImage3D(r.TEXTURE_2D_ARRAY,K,0,0,0,St.width,St.height,rt.depth,lt,Ut,St.data):e.texImage3D(r.TEXTURE_2D_ARRAY,K,It,St.width,St.height,rt.depth,0,lt,Ut,St.data)}else{Bt&&se&&e.texStorage2D(r.TEXTURE_2D,ft,It,$t[0].width,$t[0].height);for(let K=0,J=$t.length;K<J;K++)St=$t[K],y.format!==si?lt!==null?Bt?L&&e.compressedTexSubImage2D(r.TEXTURE_2D,K,0,0,St.width,St.height,lt,St.data):e.compressedTexImage2D(r.TEXTURE_2D,K,It,St.width,St.height,0,St.data):console.warn("THREE.WebGLRenderer: Attempt to load unsupported compressed texture format in .uploadTexture()"):Bt?L&&e.texSubImage2D(r.TEXTURE_2D,K,0,0,St.width,St.height,lt,Ut,St.data):e.texImage2D(r.TEXTURE_2D,K,It,St.width,St.height,0,lt,Ut,St.data)}else if(y.isDataArrayTexture)if(Bt){if(se&&e.texStorage3D(r.TEXTURE_2D_ARRAY,ft,It,rt.width,rt.height,rt.depth),L)if(y.layerUpdates.size>0){const K=If(rt.width,rt.height,y.format,y.type);for(const J of y.layerUpdates){const ht=rt.data.subarray(J*K/rt.data.BYTES_PER_ELEMENT,(J+1)*K/rt.data.BYTES_PER_ELEMENT);e.texSubImage3D(r.TEXTURE_2D_ARRAY,0,0,0,J,rt.width,rt.height,1,lt,Ut,ht)}y.clearLayerUpdates()}else e.texSubImage3D(r.TEXTURE_2D_ARRAY,0,0,0,0,rt.width,rt.height,rt.depth,lt,Ut,rt.data)}else e.texImage3D(r.TEXTURE_2D_ARRAY,0,It,rt.width,rt.height,rt.depth,0,lt,Ut,rt.data);else if(y.isData3DTexture)Bt?(se&&e.texStorage3D(r.TEXTURE_3D,ft,It,rt.width,rt.height,rt.depth),L&&e.texSubImage3D(r.TEXTURE_3D,0,0,0,0,rt.width,rt.height,rt.depth,lt,Ut,rt.data)):e.texImage3D(r.TEXTURE_3D,0,It,rt.width,rt.height,rt.depth,0,lt,Ut,rt.data);else if(y.isFramebufferTexture){if(se)if(Bt)e.texStorage2D(r.TEXTURE_2D,ft,It,rt.width,rt.height);else{let K=rt.width,J=rt.height;for(let ht=0;ht<ft;ht++)e.texImage2D(r.TEXTURE_2D,ht,It,K,J,0,lt,Ut,null),K>>=1,J>>=1}}else if($t.length>0){if(Bt&&se){const K=Dt($t[0]);e.texStorage2D(r.TEXTURE_2D,ft,It,K.width,K.height)}for(let K=0,J=$t.length;K<J;K++)St=$t[K],Bt?L&&e.texSubImage2D(r.TEXTURE_2D,K,0,0,lt,Ut,St):e.texImage2D(r.TEXTURE_2D,K,It,lt,Ut,St);y.generateMipmaps=!1}else if(Bt){if(se){const K=Dt(rt);e.texStorage2D(r.TEXTURE_2D,ft,It,K.width,K.height)}L&&e.texSubImage2D(r.TEXTURE_2D,0,0,0,lt,Ut,rt)}else e.texImage2D(r.TEXTURE_2D,0,It,lt,Ut,rt);m(y)&&p(tt),dt.__version=Z.version,y.onUpdate&&y.onUpdate(y)}A.__version=y.version}function j(A,y,G){if(y.image.length!==6)return;const tt=Tt(A,y),Q=y.source;e.bindTexture(r.TEXTURE_CUBE_MAP,A.__webglTexture,r.TEXTURE0+G);const Z=n.get(Q);if(Q.version!==Z.__version||tt===!0){e.activeTexture(r.TEXTURE0+G);const dt=oe.getPrimaries(oe.workingColorSpace),ct=y.colorSpace===Ki?null:oe.getPrimaries(y.colorSpace),_t=y.colorSpace===Ki||dt===ct?r.NONE:r.BROWSER_DEFAULT_WEBGL;r.pixelStorei(r.UNPACK_FLIP_Y_WEBGL,y.flipY),r.pixelStorei(r.UNPACK_PREMULTIPLY_ALPHA_WEBGL,y.premultiplyAlpha),r.pixelStorei(r.UNPACK_ALIGNMENT,y.unpackAlignment),r.pixelStorei(r.UNPACK_COLORSPACE_CONVERSION_WEBGL,_t);const Xt=y.isCompressedTexture||y.image[0].isCompressedTexture,rt=y.image[0]&&y.image[0].isDataTexture,lt=[];for(let J=0;J<6;J++)!Xt&&!rt?lt[J]=_(y.image[J],!0,i.maxCubemapSize):lt[J]=rt?y.image[J].image:y.image[J],lt[J]=ie(y,lt[J]);const Ut=lt[0],It=s.convert(y.format,y.colorSpace),St=s.convert(y.type),$t=v(y.internalFormat,It,St,y.colorSpace),Bt=y.isVideoTexture!==!0,se=Z.__version===void 0||tt===!0,L=Q.dataReady;let ft=R(y,Ut);it(r.TEXTURE_CUBE_MAP,y);let K;if(Xt){Bt&&se&&e.texStorage2D(r.TEXTURE_CUBE_MAP,ft,$t,Ut.width,Ut.height);for(let J=0;J<6;J++){K=lt[J].mipmaps;for(let ht=0;ht<K.length;ht++){const pt=K[ht];y.format!==si?It!==null?Bt?L&&e.compressedTexSubImage2D(r.TEXTURE_CUBE_MAP_POSITIVE_X+J,ht,0,0,pt.width,pt.height,It,pt.data):e.compressedTexImage2D(r.TEXTURE_CUBE_MAP_POSITIVE_X+J,ht,$t,pt.width,pt.height,0,pt.data):console.warn("THREE.WebGLRenderer: Attempt to load unsupported compressed texture format in .setTextureCube()"):Bt?L&&e.texSubImage2D(r.TEXTURE_CUBE_MAP_POSITIVE_X+J,ht,0,0,pt.width,pt.height,It,St,pt.data):e.texImage2D(r.TEXTURE_CUBE_MAP_POSITIVE_X+J,ht,$t,pt.width,pt.height,0,It,St,pt.data)}}}else{if(K=y.mipmaps,Bt&&se){K.length>0&&ft++;const J=Dt(lt[0]);e.texStorage2D(r.TEXTURE_CUBE_MAP,ft,$t,J.width,J.height)}for(let J=0;J<6;J++)if(rt){Bt?L&&e.texSubImage2D(r.TEXTURE_CUBE_MAP_POSITIVE_X+J,0,0,0,lt[J].width,lt[J].height,It,St,lt[J].data):e.texImage2D(r.TEXTURE_CUBE_MAP_POSITIVE_X+J,0,$t,lt[J].width,lt[J].height,0,It,St,lt[J].data);for(let ht=0;ht<K.length;ht++){const kt=K[ht].image[J].image;Bt?L&&e.texSubImage2D(r.TEXTURE_CUBE_MAP_POSITIVE_X+J,ht+1,0,0,kt.width,kt.height,It,St,kt.data):e.texImage2D(r.TEXTURE_CUBE_MAP_POSITIVE_X+J,ht+1,$t,kt.width,kt.height,0,It,St,kt.data)}}else{Bt?L&&e.texSubImage2D(r.TEXTURE_CUBE_MAP_POSITIVE_X+J,0,0,0,It,St,lt[J]):e.texImage2D(r.TEXTURE_CUBE_MAP_POSITIVE_X+J,0,$t,It,St,lt[J]);for(let ht=0;ht<K.length;ht++){const pt=K[ht];Bt?L&&e.texSubImage2D(r.TEXTURE_CUBE_MAP_POSITIVE_X+J,ht+1,0,0,It,St,pt.image[J]):e.texImage2D(r.TEXTURE_CUBE_MAP_POSITIVE_X+J,ht+1,$t,It,St,pt.image[J])}}}m(y)&&p(r.TEXTURE_CUBE_MAP),Z.__version=Q.version,y.onUpdate&&y.onUpdate(y)}A.__version=y.version}function at(A,y,G,tt,Q,Z){const dt=s.convert(G.format,G.colorSpace),ct=s.convert(G.type),_t=v(G.internalFormat,dt,ct,G.colorSpace),Xt=n.get(y),rt=n.get(G);if(rt.__renderTarget=y,!Xt.__hasExternalTextures){const lt=Math.max(1,y.width>>Z),Ut=Math.max(1,y.height>>Z);Q===r.TEXTURE_3D||Q===r.TEXTURE_2D_ARRAY?e.texImage3D(Q,Z,_t,lt,Ut,y.depth,0,dt,ct,null):e.texImage2D(Q,Z,_t,lt,Ut,0,dt,ct,null)}e.bindFramebuffer(r.FRAMEBUFFER,A),B(y)?a.framebufferTexture2DMultisampleEXT(r.FRAMEBUFFER,tt,Q,rt.__webglTexture,0,zt(y)):(Q===r.TEXTURE_2D||Q>=r.TEXTURE_CUBE_MAP_POSITIVE_X&&Q<=r.TEXTURE_CUBE_MAP_NEGATIVE_Z)&&r.framebufferTexture2D(r.FRAMEBUFFER,tt,Q,rt.__webglTexture,Z),e.bindFramebuffer(r.FRAMEBUFFER,null)}function et(A,y,G){if(r.bindRenderbuffer(r.RENDERBUFFER,A),y.depthBuffer){const tt=y.depthTexture,Q=tt&&tt.isDepthTexture?tt.type:null,Z=x(y.stencilBuffer,Q),dt=y.stencilBuffer?r.DEPTH_STENCIL_ATTACHMENT:r.DEPTH_ATTACHMENT,ct=zt(y);B(y)?a.renderbufferStorageMultisampleEXT(r.RENDERBUFFER,ct,Z,y.width,y.height):G?r.renderbufferStorageMultisample(r.RENDERBUFFER,ct,Z,y.width,y.height):r.renderbufferStorage(r.RENDERBUFFER,Z,y.width,y.height),r.framebufferRenderbuffer(r.FRAMEBUFFER,dt,r.RENDERBUFFER,A)}else{const tt=y.textures;for(let Q=0;Q<tt.length;Q++){const Z=tt[Q],dt=s.convert(Z.format,Z.colorSpace),ct=s.convert(Z.type),_t=v(Z.internalFormat,dt,ct,Z.colorSpace),Xt=zt(y);G&&B(y)===!1?r.renderbufferStorageMultisample(r.RENDERBUFFER,Xt,_t,y.width,y.height):B(y)?a.renderbufferStorageMultisampleEXT(r.RENDERBUFFER,Xt,_t,y.width,y.height):r.renderbufferStorage(r.RENDERBUFFER,_t,y.width,y.height)}}r.bindRenderbuffer(r.RENDERBUFFER,null)}function Mt(A,y){if(y&&y.isWebGLCubeRenderTarget)throw new Error("Depth Texture with cube render targets is not supported");if(e.bindFramebuffer(r.FRAMEBUFFER,A),!(y.depthTexture&&y.depthTexture.isDepthTexture))throw new Error("renderTarget.depthTexture must be an instance of THREE.DepthTexture");const tt=n.get(y.depthTexture);tt.__renderTarget=y,(!tt.__webglTexture||y.depthTexture.image.width!==y.width||y.depthTexture.image.height!==y.height)&&(y.depthTexture.image.width=y.width,y.depthTexture.image.height=y.height,y.depthTexture.needsUpdate=!0),$(y.depthTexture,0);const Q=tt.__webglTexture,Z=zt(y);if(y.depthTexture.format===ys)B(y)?a.framebufferTexture2DMultisampleEXT(r.FRAMEBUFFER,r.DEPTH_ATTACHMENT,r.TEXTURE_2D,Q,0,Z):r.framebufferTexture2D(r.FRAMEBUFFER,r.DEPTH_ATTACHMENT,r.TEXTURE_2D,Q,0);else if(y.depthTexture.format===Ns)B(y)?a.framebufferTexture2DMultisampleEXT(r.FRAMEBUFFER,r.DEPTH_STENCIL_ATTACHMENT,r.TEXTURE_2D,Q,0,Z):r.framebufferTexture2D(r.FRAMEBUFFER,r.DEPTH_STENCIL_ATTACHMENT,r.TEXTURE_2D,Q,0);else throw new Error("Unknown depthTexture format")}function Et(A){const y=n.get(A),G=A.isWebGLCubeRenderTarget===!0;if(y.__boundDepthTexture!==A.depthTexture){const tt=A.depthTexture;if(y.__depthDisposeCallback&&y.__depthDisposeCallback(),tt){const Q=()=>{delete y.__boundDepthTexture,delete y.__depthDisposeCallback,tt.removeEventListener("dispose",Q)};tt.addEventListener("dispose",Q),y.__depthDisposeCallback=Q}y.__boundDepthTexture=tt}if(A.depthTexture&&!y.__autoAllocateDepthBuffer){if(G)throw new Error("target.depthTexture not supported in Cube render targets");Mt(y.__webglFramebuffer,A)}else if(G){y.__webglDepthbuffer=[];for(let tt=0;tt<6;tt++)if(e.bindFramebuffer(r.FRAMEBUFFER,y.__webglFramebuffer[tt]),y.__webglDepthbuffer[tt]===void 0)y.__webglDepthbuffer[tt]=r.createRenderbuffer(),et(y.__webglDepthbuffer[tt],A,!1);else{const Q=A.stencilBuffer?r.DEPTH_STENCIL_ATTACHMENT:r.DEPTH_ATTACHMENT,Z=y.__webglDepthbuffer[tt];r.bindRenderbuffer(r.RENDERBUFFER,Z),r.framebufferRenderbuffer(r.FRAMEBUFFER,Q,r.RENDERBUFFER,Z)}}else if(e.bindFramebuffer(r.FRAMEBUFFER,y.__webglFramebuffer),y.__webglDepthbuffer===void 0)y.__webglDepthbuffer=r.createRenderbuffer(),et(y.__webglDepthbuffer,A,!1);else{const tt=A.stencilBuffer?r.DEPTH_STENCIL_ATTACHMENT:r.DEPTH_ATTACHMENT,Q=y.__webglDepthbuffer;r.bindRenderbuffer(r.RENDERBUFFER,Q),r.framebufferRenderbuffer(r.FRAMEBUFFER,tt,r.RENDERBUFFER,Q)}e.bindFramebuffer(r.FRAMEBUFFER,null)}function Ot(A,y,G){const tt=n.get(A);y!==void 0&&at(tt.__webglFramebuffer,A,A.texture,r.COLOR_ATTACHMENT0,r.TEXTURE_2D,0),G!==void 0&&Et(A)}function qt(A){const y=A.texture,G=n.get(A),tt=n.get(y);A.addEventListener("dispose",b);const Q=A.textures,Z=A.isWebGLCubeRenderTarget===!0,dt=Q.length>1;if(dt||(tt.__webglTexture===void 0&&(tt.__webglTexture=r.createTexture()),tt.__version=y.version,o.memory.textures++),Z){G.__webglFramebuffer=[];for(let ct=0;ct<6;ct++)if(y.mipmaps&&y.mipmaps.length>0){G.__webglFramebuffer[ct]=[];for(let _t=0;_t<y.mipmaps.length;_t++)G.__webglFramebuffer[ct][_t]=r.createFramebuffer()}else G.__webglFramebuffer[ct]=r.createFramebuffer()}else{if(y.mipmaps&&y.mipmaps.length>0){G.__webglFramebuffer=[];for(let ct=0;ct<y.mipmaps.length;ct++)G.__webglFramebuffer[ct]=r.createFramebuffer()}else G.__webglFramebuffer=r.createFramebuffer();if(dt)for(let ct=0,_t=Q.length;ct<_t;ct++){const Xt=n.get(Q[ct]);Xt.__webglTexture===void 0&&(Xt.__webglTexture=r.createTexture(),o.memory.textures++)}if(A.samples>0&&B(A)===!1){G.__webglMultisampledFramebuffer=r.createFramebuffer(),G.__webglColorRenderbuffer=[],e.bindFramebuffer(r.FRAMEBUFFER,G.__webglMultisampledFramebuffer);for(let ct=0;ct<Q.length;ct++){const _t=Q[ct];G.__webglColorRenderbuffer[ct]=r.createRenderbuffer(),r.bindRenderbuffer(r.RENDERBUFFER,G.__webglColorRenderbuffer[ct]);const Xt=s.convert(_t.format,_t.colorSpace),rt=s.convert(_t.type),lt=v(_t.internalFormat,Xt,rt,_t.colorSpace,A.isXRRenderTarget===!0),Ut=zt(A);r.renderbufferStorageMultisample(r.RENDERBUFFER,Ut,lt,A.width,A.height),r.framebufferRenderbuffer(r.FRAMEBUFFER,r.COLOR_ATTACHMENT0+ct,r.RENDERBUFFER,G.__webglColorRenderbuffer[ct])}r.bindRenderbuffer(r.RENDERBUFFER,null),A.depthBuffer&&(G.__webglDepthRenderbuffer=r.createRenderbuffer(),et(G.__webglDepthRenderbuffer,A,!0)),e.bindFramebuffer(r.FRAMEBUFFER,null)}}if(Z){e.bindTexture(r.TEXTURE_CUBE_MAP,tt.__webglTexture),it(r.TEXTURE_CUBE_MAP,y);for(let ct=0;ct<6;ct++)if(y.mipmaps&&y.mipmaps.length>0)for(let _t=0;_t<y.mipmaps.length;_t++)at(G.__webglFramebuffer[ct][_t],A,y,r.COLOR_ATTACHMENT0,r.TEXTURE_CUBE_MAP_POSITIVE_X+ct,_t);else at(G.__webglFramebuffer[ct],A,y,r.COLOR_ATTACHMENT0,r.TEXTURE_CUBE_MAP_POSITIVE_X+ct,0);m(y)&&p(r.TEXTURE_CUBE_MAP),e.unbindTexture()}else if(dt){for(let ct=0,_t=Q.length;ct<_t;ct++){const Xt=Q[ct],rt=n.get(Xt);e.bindTexture(r.TEXTURE_2D,rt.__webglTexture),it(r.TEXTURE_2D,Xt),at(G.__webglFramebuffer,A,Xt,r.COLOR_ATTACHMENT0+ct,r.TEXTURE_2D,0),m(Xt)&&p(r.TEXTURE_2D)}e.unbindTexture()}else{let ct=r.TEXTURE_2D;if((A.isWebGL3DRenderTarget||A.isWebGLArrayRenderTarget)&&(ct=A.isWebGL3DRenderTarget?r.TEXTURE_3D:r.TEXTURE_2D_ARRAY),e.bindTexture(ct,tt.__webglTexture),it(ct,y),y.mipmaps&&y.mipmaps.length>0)for(let _t=0;_t<y.mipmaps.length;_t++)at(G.__webglFramebuffer[_t],A,y,r.COLOR_ATTACHMENT0,ct,_t);else at(G.__webglFramebuffer,A,y,r.COLOR_ATTACHMENT0,ct,0);m(y)&&p(ct),e.unbindTexture()}A.depthBuffer&&Et(A)}function Nt(A){const y=A.textures;for(let G=0,tt=y.length;G<tt;G++){const Q=y[G];if(m(Q)){const Z=E(A),dt=n.get(Q).__webglTexture;e.bindTexture(Z,dt),p(Z),e.unbindTexture()}}}const Pt=[],I=[];function ge(A){if(A.samples>0){if(B(A)===!1){const y=A.textures,G=A.width,tt=A.height;let Q=r.COLOR_BUFFER_BIT;const Z=A.stencilBuffer?r.DEPTH_STENCIL_ATTACHMENT:r.DEPTH_ATTACHMENT,dt=n.get(A),ct=y.length>1;if(ct)for(let _t=0;_t<y.length;_t++)e.bindFramebuffer(r.FRAMEBUFFER,dt.__webglMultisampledFramebuffer),r.framebufferRenderbuffer(r.FRAMEBUFFER,r.COLOR_ATTACHMENT0+_t,r.RENDERBUFFER,null),e.bindFramebuffer(r.FRAMEBUFFER,dt.__webglFramebuffer),r.framebufferTexture2D(r.DRAW_FRAMEBUFFER,r.COLOR_ATTACHMENT0+_t,r.TEXTURE_2D,null,0);e.bindFramebuffer(r.READ_FRAMEBUFFER,dt.__webglMultisampledFramebuffer),e.bindFramebuffer(r.DRAW_FRAMEBUFFER,dt.__webglFramebuffer);for(let _t=0;_t<y.length;_t++){if(A.resolveDepthBuffer&&(A.depthBuffer&&(Q|=r.DEPTH_BUFFER_BIT),A.stencilBuffer&&A.resolveStencilBuffer&&(Q|=r.STENCIL_BUFFER_BIT)),ct){r.framebufferRenderbuffer(r.READ_FRAMEBUFFER,r.COLOR_ATTACHMENT0,r.RENDERBUFFER,dt.__webglColorRenderbuffer[_t]);const Xt=n.get(y[_t]).__webglTexture;r.framebufferTexture2D(r.DRAW_FRAMEBUFFER,r.COLOR_ATTACHMENT0,r.TEXTURE_2D,Xt,0)}r.blitFramebuffer(0,0,G,tt,0,0,G,tt,Q,r.NEAREST),l===!0&&(Pt.length=0,I.length=0,Pt.push(r.COLOR_ATTACHMENT0+_t),A.depthBuffer&&A.resolveDepthBuffer===!1&&(Pt.push(Z),I.push(Z),r.invalidateFramebuffer(r.DRAW_FRAMEBUFFER,I)),r.invalidateFramebuffer(r.READ_FRAMEBUFFER,Pt))}if(e.bindFramebuffer(r.READ_FRAMEBUFFER,null),e.bindFramebuffer(r.DRAW_FRAMEBUFFER,null),ct)for(let _t=0;_t<y.length;_t++){e.bindFramebuffer(r.FRAMEBUFFER,dt.__webglMultisampledFramebuffer),r.framebufferRenderbuffer(r.FRAMEBUFFER,r.COLOR_ATTACHMENT0+_t,r.RENDERBUFFER,dt.__webglColorRenderbuffer[_t]);const Xt=n.get(y[_t]).__webglTexture;e.bindFramebuffer(r.FRAMEBUFFER,dt.__webglFramebuffer),r.framebufferTexture2D(r.DRAW_FRAMEBUFFER,r.COLOR_ATTACHMENT0+_t,r.TEXTURE_2D,Xt,0)}e.bindFramebuffer(r.DRAW_FRAMEBUFFER,dt.__webglMultisampledFramebuffer)}else if(A.depthBuffer&&A.resolveDepthBuffer===!1&&l){const y=A.stencilBuffer?r.DEPTH_STENCIL_ATTACHMENT:r.DEPTH_ATTACHMENT;r.invalidateFramebuffer(r.DRAW_FRAMEBUFFER,[y])}}}function zt(A){return Math.min(i.maxSamples,A.samples)}function B(A){const y=n.get(A);return A.samples>0&&t.has("WEBGL_multisampled_render_to_texture")===!0&&y.__useRenderToTexture!==!1}function At(A){const y=o.render.frame;u.get(A)!==y&&(u.set(A,y),A.update())}function ie(A,y){const G=A.colorSpace,tt=A.format,Q=A.type;return A.isCompressedTexture===!0||A.isVideoTexture===!0||G!==Os&&G!==Ki&&(oe.getTransfer(G)===_e?(tt!==si||Q!==zi)&&console.warn("THREE.WebGLTextures: sRGB encoded textures have to use RGBAFormat and UnsignedByteType."):console.error("THREE.WebGLTextures: Unsupported texture color space:",G)),y}function Dt(A){return typeof HTMLImageElement<"u"&&A instanceof HTMLImageElement?(c.width=A.naturalWidth||A.width,c.height=A.naturalHeight||A.height):typeof VideoFrame<"u"&&A instanceof VideoFrame?(c.width=A.displayWidth,c.height=A.displayHeight):(c.width=A.width,c.height=A.height),c}this.allocateTextureUnit=O,this.resetTextureUnits=U,this.setTexture2D=$,this.setTexture2DArray=X,this.setTexture3D=Y,this.setTextureCube=z,this.rebindTextures=Ot,this.setupRenderTarget=qt,this.updateRenderTargetMipmap=Nt,this.updateMultisampleRenderTarget=ge,this.setupDepthRenderbuffer=Et,this.setupFrameBufferTexture=at,this.useMultisampledRTT=B}function xS(r,t){function e(n,i=Ki){let s;const o=oe.getTransfer(i);if(n===zi)return r.UNSIGNED_BYTE;if(n===Wu)return r.UNSIGNED_SHORT_4_4_4_4;if(n===Xu)return r.UNSIGNED_SHORT_5_5_5_1;if(n===_p)return r.UNSIGNED_INT_5_9_9_9_REV;if(n===pp)return r.BYTE;if(n===mp)return r.SHORT;if(n===Do)return r.UNSIGNED_SHORT;if(n===Gu)return r.INT;if(n===Vr)return r.UNSIGNED_INT;if(n===Ii)return r.FLOAT;if(n===Io)return r.HALF_FLOAT;if(n===gp)return r.ALPHA;if(n===vp)return r.RGB;if(n===si)return r.RGBA;if(n===xp)return r.LUMINANCE;if(n===Mp)return r.LUMINANCE_ALPHA;if(n===ys)return r.DEPTH_COMPONENT;if(n===Ns)return r.DEPTH_STENCIL;if(n===Sp)return r.RED;if(n===Yu)return r.RED_INTEGER;if(n===yp)return r.RG;if(n===qu)return r.RG_INTEGER;if(n===$u)return r.RGBA_INTEGER;if(n===Da||n===La||n===Ia||n===Ua)if(o===_e)if(s=t.get("WEBGL_compressed_texture_s3tc_srgb"),s!==null){if(n===Da)return s.COMPRESSED_SRGB_S3TC_DXT1_EXT;if(n===La)return s.COMPRESSED_SRGB_ALPHA_S3TC_DXT1_EXT;if(n===Ia)return s.COMPRESSED_SRGB_ALPHA_S3TC_DXT3_EXT;if(n===Ua)return s.COMPRESSED_SRGB_ALPHA_S3TC_DXT5_EXT}else return null;else if(s=t.get("WEBGL_compressed_texture_s3tc"),s!==null){if(n===Da)return s.COMPRESSED_RGB_S3TC_DXT1_EXT;if(n===La)return s.COMPRESSED_RGBA_S3TC_DXT1_EXT;if(n===Ia)return s.COMPRESSED_RGBA_S3TC_DXT3_EXT;if(n===Ua)return s.COMPRESSED_RGBA_S3TC_DXT5_EXT}else return null;if(n===Hc||n===Vc||n===Gc||n===Wc)if(s=t.get("WEBGL_compressed_texture_pvrtc"),s!==null){if(n===Hc)return s.COMPRESSED_RGB_PVRTC_4BPPV1_IMG;if(n===Vc)return s.COMPRESSED_RGB_PVRTC_2BPPV1_IMG;if(n===Gc)return s.COMPRESSED_RGBA_PVRTC_4BPPV1_IMG;if(n===Wc)return s.COMPRESSED_RGBA_PVRTC_2BPPV1_IMG}else return null;if(n===Xc||n===Yc||n===qc)if(s=t.get("WEBGL_compressed_texture_etc"),s!==null){if(n===Xc||n===Yc)return o===_e?s.COMPRESSED_SRGB8_ETC2:s.COMPRESSED_RGB8_ETC2;if(n===qc)return o===_e?s.COMPRESSED_SRGB8_ALPHA8_ETC2_EAC:s.COMPRESSED_RGBA8_ETC2_EAC}else return null;if(n===$c||n===Kc||n===Zc||n===jc||n===Jc||n===Qc||n===tu||n===eu||n===nu||n===iu||n===ru||n===su||n===ou||n===au)if(s=t.get("WEBGL_compressed_texture_astc"),s!==null){if(n===$c)return o===_e?s.COMPRESSED_SRGB8_ALPHA8_ASTC_4x4_KHR:s.COMPRESSED_RGBA_ASTC_4x4_KHR;if(n===Kc)return o===_e?s.COMPRESSED_SRGB8_ALPHA8_ASTC_5x4_KHR:s.COMPRESSED_RGBA_ASTC_5x4_KHR;if(n===Zc)return o===_e?s.COMPRESSED_SRGB8_ALPHA8_ASTC_5x5_KHR:s.COMPRESSED_RGBA_ASTC_5x5_KHR;if(n===jc)return o===_e?s.COMPRESSED_SRGB8_ALPHA8_ASTC_6x5_KHR:s.COMPRESSED_RGBA_ASTC_6x5_KHR;if(n===Jc)return o===_e?s.COMPRESSED_SRGB8_ALPHA8_ASTC_6x6_KHR:s.COMPRESSED_RGBA_ASTC_6x6_KHR;if(n===Qc)return o===_e?s.COMPRESSED_SRGB8_ALPHA8_ASTC_8x5_KHR:s.COMPRESSED_RGBA_ASTC_8x5_KHR;if(n===tu)return o===_e?s.COMPRESSED_SRGB8_ALPHA8_ASTC_8x6_KHR:s.COMPRESSED_RGBA_ASTC_8x6_KHR;if(n===eu)return o===_e?s.COMPRESSED_SRGB8_ALPHA8_ASTC_8x8_KHR:s.COMPRESSED_RGBA_ASTC_8x8_KHR;if(n===nu)return o===_e?s.COMPRESSED_SRGB8_ALPHA8_ASTC_10x5_KHR:s.COMPRESSED_RGBA_ASTC_10x5_KHR;if(n===iu)return o===_e?s.COMPRESSED_SRGB8_ALPHA8_ASTC_10x6_KHR:s.COMPRESSED_RGBA_ASTC_10x6_KHR;if(n===ru)return o===_e?s.COMPRESSED_SRGB8_ALPHA8_ASTC_10x8_KHR:s.COMPRESSED_RGBA_ASTC_10x8_KHR;if(n===su)return o===_e?s.COMPRESSED_SRGB8_ALPHA8_ASTC_10x10_KHR:s.COMPRESSED_RGBA_ASTC_10x10_KHR;if(n===ou)return o===_e?s.COMPRESSED_SRGB8_ALPHA8_ASTC_12x10_KHR:s.COMPRESSED_RGBA_ASTC_12x10_KHR;if(n===au)return o===_e?s.COMPRESSED_SRGB8_ALPHA8_ASTC_12x12_KHR:s.COMPRESSED_RGBA_ASTC_12x12_KHR}else return null;if(n===Na||n===lu||n===cu)if(s=t.get("EXT_texture_compression_bptc"),s!==null){if(n===Na)return o===_e?s.COMPRESSED_SRGB_ALPHA_BPTC_UNORM_EXT:s.COMPRESSED_RGBA_BPTC_UNORM_EXT;if(n===lu)return s.COMPRESSED_RGB_BPTC_SIGNED_FLOAT_EXT;if(n===cu)return s.COMPRESSED_RGB_BPTC_UNSIGNED_FLOAT_EXT}else return null;if(n===Ep||n===uu||n===hu||n===fu)if(s=t.get("EXT_texture_compression_rgtc"),s!==null){if(n===Na)return s.COMPRESSED_RED_RGTC1_EXT;if(n===uu)return s.COMPRESSED_SIGNED_RED_RGTC1_EXT;if(n===hu)return s.COMPRESSED_RED_GREEN_RGTC2_EXT;if(n===fu)return s.COMPRESSED_SIGNED_RED_GREEN_RGTC2_EXT}else return null;return n===Us?r.UNSIGNED_INT_24_8:r[n]!==void 0?r[n]:null}return{convert:e}}class MS extends $n{constructor(t=[]){super(),this.isArrayCamera=!0,this.cameras=t}}class va extends Je{constructor(){super(),this.isGroup=!0,this.type="Group"}}const SS={type:"move"};class Jl{constructor(){this._targetRay=null,this._grip=null,this._hand=null}getHandSpace(){return this._hand===null&&(this._hand=new va,this._hand.matrixAutoUpdate=!1,this._hand.visible=!1,this._hand.joints={},this._hand.inputState={pinching:!1}),this._hand}getTargetRaySpace(){return this._targetRay===null&&(this._targetRay=new va,this._targetRay.matrixAutoUpdate=!1,this._targetRay.visible=!1,this._targetRay.hasLinearVelocity=!1,this._targetRay.linearVelocity=new q,this._targetRay.hasAngularVelocity=!1,this._targetRay.angularVelocity=new q),this._targetRay}getGripSpace(){return this._grip===null&&(this._grip=new va,this._grip.matrixAutoUpdate=!1,this._grip.visible=!1,this._grip.hasLinearVelocity=!1,this._grip.linearVelocity=new q,this._grip.hasAngularVelocity=!1,this._grip.angularVelocity=new q),this._grip}dispatchEvent(t){return this._targetRay!==null&&this._targetRay.dispatchEvent(t),this._grip!==null&&this._grip.dispatchEvent(t),this._hand!==null&&this._hand.dispatchEvent(t),this}connect(t){if(t&&t.hand){const e=this._hand;if(e)for(const n of t.hand.values())this._getHandJoint(e,n)}return this.dispatchEvent({type:"connected",data:t}),this}disconnect(t){return this.dispatchEvent({type:"disconnected",data:t}),this._targetRay!==null&&(this._targetRay.visible=!1),this._grip!==null&&(this._grip.visible=!1),this._hand!==null&&(this._hand.visible=!1),this}update(t,e,n){let i=null,s=null,o=null;const a=this._targetRay,l=this._grip,c=this._hand;if(t&&e.session.visibilityState!=="visible-blurred"){if(c&&t.hand){o=!0;for(const _ of t.hand.values()){const m=e.getJointPose(_,n),p=this._getHandJoint(c,_);m!==null&&(p.matrix.fromArray(m.transform.matrix),p.matrix.decompose(p.position,p.rotation,p.scale),p.matrixWorldNeedsUpdate=!0,p.jointRadius=m.radius),p.visible=m!==null}const u=c.joints["index-finger-tip"],h=c.joints["thumb-tip"],f=u.position.distanceTo(h.position),d=.02,g=.005;c.inputState.pinching&&f>d+g?(c.inputState.pinching=!1,this.dispatchEvent({type:"pinchend",handedness:t.handedness,target:this})):!c.inputState.pinching&&f<=d-g&&(c.inputState.pinching=!0,this.dispatchEvent({type:"pinchstart",handedness:t.handedness,target:this}))}else l!==null&&t.gripSpace&&(s=e.getPose(t.gripSpace,n),s!==null&&(l.matrix.fromArray(s.transform.matrix),l.matrix.decompose(l.position,l.rotation,l.scale),l.matrixWorldNeedsUpdate=!0,s.linearVelocity?(l.hasLinearVelocity=!0,l.linearVelocity.copy(s.linearVelocity)):l.hasLinearVelocity=!1,s.angularVelocity?(l.hasAngularVelocity=!0,l.angularVelocity.copy(s.angularVelocity)):l.hasAngularVelocity=!1));a!==null&&(i=e.getPose(t.targetRaySpace,n),i===null&&s!==null&&(i=s),i!==null&&(a.matrix.fromArray(i.transform.matrix),a.matrix.decompose(a.position,a.rotation,a.scale),a.matrixWorldNeedsUpdate=!0,i.linearVelocity?(a.hasLinearVelocity=!0,a.linearVelocity.copy(i.linearVelocity)):a.hasLinearVelocity=!1,i.angularVelocity?(a.hasAngularVelocity=!0,a.angularVelocity.copy(i.angularVelocity)):a.hasAngularVelocity=!1,this.dispatchEvent(SS)))}return a!==null&&(a.visible=i!==null),l!==null&&(l.visible=s!==null),c!==null&&(c.visible=o!==null),this}_getHandJoint(t,e){if(t.joints[e.jointName]===void 0){const n=new va;n.matrixAutoUpdate=!1,n.visible=!1,t.joints[e.jointName]=n,t.add(n)}return t.joints[e.jointName]}}const yS=`
void main() {
...
}`;class TS{constructor(){this.texture=null,this.mesh=null,this.depthNear=0,this.depthFar=0}init(t,e,n){if(this.texture===null){const i=new Tn,s=t.properties.get(i);s.__webglTexture=e.texture,(e.depthNear!=n.depthNear||e.depthFar!=n.depthFar)&&(this.depthNear=e.depthNear,this.depthFar=e.depthFar),this.texture=i}}getMesh(t){if(this.texture!==null&&this.mesh===null){const e=t.cameras[0].viewport,n=new ur({vertexShader:yS,fragmentShader:ES,uniforms:{depthColor:{value:this.texture},depthWidth:{value:e.z},depthHeight:{value:e.w}}});this.mesh=new Bn(new ol(20,20),n)}return this.mesh}reset(){this.texture=null,this.mesh=null}getDepthTexture(){return this.texture}}class bS extends Bs{constructor(t,e){super();const n=this;let i=null,s=1,o=null,a="local-floor",l=1,c=null,u=null,h=null,f=null,d=null,g=null;const _=new TS,m=e.getContextAttributes();let p=null,E=null;const v=[],x=[],R=new ue;let w=null;const b=new $n;b.viewport=new De;const C=new $n;C.viewport=new De;const S=[b,C],M=new MS;let P=null,U=null;this.cameraAutoUpdate=!0,this.enabled=!1,this.isPresenting=!1,this.getController=function(k){let j=v[k];return j===void 0&&(j=new Jl,v[k]=j),j.getTargetRaySpace()},this.getControllerGrip=function(k){let j=v[k];return j===void 0&&(j=new Jl,v[k]=j),j.getGripSpace()},this.getHand=function(k){let j=v[k];return j===void 0&&(j=new Jl,v[k]=j),j.getHandSpace()};function O(k){const j=x.indexOf(k.inputSource);if(j===-1)return;const at=v[j];at!==void 0&&(at.update(k.inputSource,k.frame,c||o),at.dispatchEvent({type:k.type,data:k.inputSource}))}function H(){i.removeEventListener("select",O),i.removeEventListener("selectstart",O),i.removeEventListener("selectend",O),i.removeEventListener("squeeze",O),i.removeEventListener("squeezestart",O),i.removeEventListener("squeezeend",O),i.removeEventListener("end",H),i.removeEventListener("inputsourceschange",$);for(let k=0;k<v.length;k++){const j=x[k];j!==null&&(x[k]=null,v[k].disconnect(j))}P=null,U=null,_.reset(),t.setRenderTarget(p),d=null,f=null,h=null,i=null,E=null,Tt.stop(),n.isPresenting=!1,t.setPixelRatio(w),t.setSize(R.width,R.height,!1),n.dispatchEvent({type:"sessionend"})}this.setFramebufferScaleFactor=function(k){s=k,n.isPresenting===!0&&console.warn("THREE.WebXRManager: Cannot change framebuffer scale while presenting.")},this.setReferenceSpaceType=function(k){a=k,n.isPresenting===!0&&console.warn("THREE.WebXRManager: Cannot change reference space type while presenting.")},this.getReferenceSpace=function(){return c||o},this.setReferenceSpace=function(k){c=k},this.getBaseLayer=function(){return f!==null?f:d},this.getBinding=function(){return h},this.getFrame=function(){return g},this.getSession=function(){return i},this.setSession=async function(k){if(i=k,i!==null){if(p=t.getRenderTarget(),i.addEventListener("select",O),i.addEventListener("selectstart",O),i.addEventListener("selectend",O),i.addEventListener("squeeze",O),i.addEventListener("squeezestart",O),i.addEventListener("squeezeend",O),i.addEventListener("end",H),i.addEventListener("inputsourceschange",$),m.xrCompatible!==!0&&await e.makeXRCompatible(),w=t.getPixelRatio(),t.getSize(R),i.renderState.layers===void 0){const j={antialias:m.antialias,alpha:!0,depth:m.depth,stencil:m.stencil,framebufferScaleFactor:s};d=new XRWebGLLayer(i,e,j),i.updateRenderState({baseLayer:d}),t.setPixelRatio(1),t.setSize(d.framebufferWidth,d.framebufferHeight,!1),E=new Gr(d.framebufferWidth,d.framebufferHeight,{format:si,type:zi,colorSpace:t.outputColorSpace,stencilBuffer:m.stencil})}else{let j=null,at=null,et=null;m.depth&&(et=m.stencil?e.DEPTH24_STENCIL8:e.DEPTH_COMPONENT24,j=m.stencil?Ns:ys,at=m.stencil?Us:Vr);const Mt={colorFormat:e.RGBA8,depthFormat:et,scaleFactor:s};h=new XRWebGLBinding(i,e),f=h.createProjectionLayer(Mt),i.updateRenderState({layers:[f]}),t.setPixelRatio(1),t.setSize(f.textureWidth,f.textureHeight,!1),E=new Gr(f.textureWidth,f.textureHeight,{format:si,type:zi,depthTexture:new zp(f.textureWidth,f.textureHeight,at,void 0,void 0,void 0,void 0,void 0,void 0,j),stencilBuffer:m.stencil,colorSpace:t.outputColorSpace,samples:m.antialias?4:0,resolveDepthBuffer:f.ignoreDepthValues===!1})}E.isXRRenderTarget=!0,this.setFoveation(l),c=null,o=await i.requestReferenceSpace(a),Tt.setContext(i),Tt.start(),n.isPresenting=!0,n.dispatchEvent({type:"sessionstart"})}},this.getEnvironmentBlendMode=function(){if(i!==null)return i.environmentBlendMode},this.getDepthTexture=function(){return _.getDepthTexture()};function $(k){for(let j=0;j<k.removed.length;j++){const at=k.removed[j],et=x.indexOf(at);et>=0&&(x[et]=null,v[et].disconnect(at))}for(let j=0;j<k.added.length;j++){const at=k.added[j];let et=x.indexOf(at);if(et===-1){for(let Et=0;Et<v.length;Et++)if(Et>=x.length){x.push(at),et=Et;break}else if(x[Et]===null){x[Et]=at,et=Et;break}if(et===-1)break}const Mt=v[et];Mt&&Mt.connect(at)}}const X=new q,Y=new q;function z(k,j,at){X.setFromMatrixPosition(j.matrixWorld),Y.setFromMatrixPosition(at.matrixWorld);const et=X.distanceTo(Y),Mt=j.projectionMatrix.elements,Et=at.projectionMatrix.elements,Ot=Mt[14]/(Mt[10]-1),qt=Mt[14]/(Mt[10]+1),Nt=(Mt[9]+1)/Mt[5],Pt=(Mt[9]-1)/Mt[5],I=(Mt[8]-1)/Mt[0],ge=(Et[8]+1)/Et[0],zt=Ot*I,B=Ot*ge,At=et/(-I+ge),ie=At*-I;if(j.matrixWorld.decompose(k.position,k.quaternion,k.scale),k.translateX(ie),k.translateZ(At),k.matrixWorld.compose(k.position,k.quaternion,k.scale),k.matrixWorldInverse.copy(k.matrixWorld).invert(),Mt[10]===-1)k.projectionMatrix.copy(j.projectionMatrix),k.projectionMatrixInverse.copy(j.projectionMatrixInverse);else{const Dt=Ot+At,A=qt+At,y=zt-ie,G=B+(et-ie),tt=Nt*qt/A*Dt,Q=Pt*qt/A*Dt;k.projectionMatrix.makePerspective(y,G,tt,Q,Dt,A),k.projectionMatrixInverse.copy(k.projectionMatrix).invert()}}function nt(k,j){j===null?k.matrixWorld.copy(k.matrix):k.matrixWorld.multiplyMatrices(j.matrixWorld,k.matrix),k.matrixWorldInverse.copy(k.matrixWorld).invert()}this.updateCamera=function(k){if(i===null)return;let j=k.near,at=k.far;_.texture!==null&&(_.depthNear>0&&(j=_.depthNear),_.depthFar>0&&(at=_.depthFar)),M.near=C.near=b.near=j,M.far=C.far=b.far=at,(P!==M.near||U!==M.far)&&(i.updateRenderState({depthNear:M.near,depthFar:M.far}),P=M.near,U=M.far),b.layers.mask=k.layers.mask|2,C.layers.mask=k.layers.mask|4,M.layers.mask=b.layers.mask|C.layers.mask;const et=k.parent,Mt=M.cameras;nt(M,et);for(let Et=0;Et<Mt.length;Et++)nt(Mt[Et],et);Mt.length===2?z(M,b,C):M.projectionMatrix.copy(b.projectionMatrix),D(k,M,et)};function D(k,j,at){at===null?k.matrix.copy(j.matrixWorld):(k.matrix.copy(at.matrixWorld),k.matrix.invert(),k.matrix.multiply(j.matrixWorld)),k.matrix.decompose(k.position,k.quaternion,k.scale),k.updateMatrixWorld(!0),k.projectionMatrix.copy(j.projectionMatrix),k.projectionMatrixInverse.copy(j.projectionMatrixInverse),k.isPerspectiveCamera&&(k.fov=du*2*Math.atan(1/k.projectionMatrix.elements[5]),k.zoom=1)}this.getCamera=function(){return M},this.getFoveation=function(){if(!(f===null&&d===null))return l},this.setFoveation=function(k){l=k,f!==null&&(f.fixedFoveation=k),d!==null&&d.fixedFoveation!==void 0&&(d.fixedFoveation=k)},this.hasDepthSensing=function(){return _.texture!==null},this.getDepthSensingMesh=function(){return _.getMesh(M)};let ut=null;function it(k,j){if(u=j.getViewerPose(c||o),g=j,u!==null){const at=u.views;d!==null&&(t.setRenderTargetFramebuffer(E,d.framebuffer),t.setRenderTarget(E));let et=!1;at.length!==M.cameras.length&&(M.cameras.length=0,et=!0);for(let Et=0;Et<at.length;Et++){const Ot=at[Et];let qt=null;if(d!==null)qt=d.getViewport(Ot);else{const Pt=h.getViewSubImage(f,Ot);qt=Pt.viewport,Et===0&&(t.setRenderTargetTextures(E,Pt.colorTexture,f.ignoreDepthValues?void 0:Pt.depthStencilTexture),t.setRenderTarget(E))}let Nt=S[Et];Nt===void 0&&(Nt=new $n,Nt.layers.enable(Et),Nt.viewport=new De,S[Et]=Nt),Nt.matrix.fromArray(Ot.transform.matrix),Nt.matrix.decompose(Nt.position,Nt.quaternion,Nt.scale),Nt.projectionMatrix.fromArray(Ot.projectionMatrix),Nt.projectionMatrixInverse.copy(Nt.projectionMatrix).invert(),Nt.viewport.set(qt.x,qt.y,qt.width,qt.height),Et===0&&(M.matrix.copy(Nt.matrix),M.matrix.decompose(M.position,M.quaternion,M.scale)),et===!0&&M.cameras.push(Nt)}const Mt=i.enabledFeatures;if(Mt&&Mt.includes("depth-sensing")){const Et=h.getDepthInformation(at[0]);Et&&Et.isValid&&Et.texture&&_.init(t,Et,i.renderState)}}for(let at=0;at<v.length;at++){const et=x[at],Mt=v[at];et!==null&&Mt!==void 0&&Mt.update(et,j,c||o)}ut&&ut(k,j),j.detectedPlanes&&n.dispatchEvent({type:"planesdetected",data:j}),g=null}const Tt=new Op;Tt.setAnimationLoop(it),this.setAnimationLoop=function(k){ut=k},this.dispose=function(){}}}const xr=new Mi,wS=new Ce;function AS(r,t){function e(m,p){m.matrixAutoUpdate===!0&&m.updateMatrix(),p.value.copy(m.matrix)}function n(m,p){p.color.getRGB(m.fogColor.value,Up(r)),p.isFog?(m.fogNear.value=p.near,m.fogFar.value=p.far):p.isFogExp2&&(m.fogDensity.value=p.density)}function i(m,p,E,v,x){p.isMeshBasicMaterial||p.isMeshLambertMaterial?s(m,p):p.isMeshToonMaterial?(s(m,p),h(m,p)):p.isMeshPhongMaterial?(s(m,p),u(m,p)):p.isMeshStandardMaterial?(s(m,p),f(m,p),p.isMeshPhysicalMaterial&&d(m,p,x)):p.isMeshMatcapMaterial?(s(m,p),g(m,p)):p.isMeshDepthMaterial?s(m,p):p.isMeshDistanceMaterial?(s(m,p),_(m,p)):p.isMeshNormalMaterial?s(m,p):p.isLineBasicMaterial?(o(m,p),p.isLineDashedMaterial&&a(m,p)):p.isPointsMaterial?l(m,p,E,v):p.isSpriteMaterial?c(m,p):p.isShadowMaterial?(m.color.value.copy(p.color),m.opacity.value=p.opacity):p.isShaderMaterial&&(p.uniformsNeedUpdate=!1)}function s(m,p){m.opacity.value=p.opacity,p.color&&m.diffuse.value.copy(p.color),p.emissive&&m.emissive.value.copy(p.emissive).multiplyScalar(p.emissiveIntensity),p.map&&(m.map.value=p.map,e(p.map,m.mapTransform)),p.alphaMap&&(m.alphaMap.value=p.alphaMap,e(p.alphaMap,m.alphaMapTransform)),p.bumpMap&&(m.bumpMap.value=p.bumpMap,e(p.bumpMap,m.bumpMapTransform),m.bumpScale.value=p.bumpScale,p.side===_n&&(m.bumpScale.value*=-1)),p.normalMap&&(m.normalMap.value=p.normalMap,e(p.normalMap,m.normalMapTransform),m.normalScale.value.copy(p.normalScale),p.side===_n&&m.normalScale.value.negate()),p.displacementMap&&(m.displacementMap.value=p.displacementMap,e(p.displacementMap,m.displacementMapTransform),m.displacementScale.value=p.displacementScale,m.displacementBias.value=p.displacementBias),p.emissiveMap&&(m.emissiveMap.value=p.emissiveMap,e(p.emissiveMap,m.emissiveMapTransform)),p.specularMap&&(m.specularMap.value=p.specularMap,e(p.specularMap,m.specularMapTransform)),p.alphaTest>0&&(m.alphaTest.value=p.alphaTest);const E=t.get(p),v=E.envMap,x=E.envMapRotation;v&&(m.envMap.value=v,xr.copy(x),xr.x*=-1,xr.y*=-1,xr.z*=-1,v.isCubeTexture&&v.isRenderTargetTexture===!1&&(xr.y*=-1,xr.z*=-1),m.envMapRotation.value.setFromMatrix4(wS.makeRotationFromEuler(xr)),m.flipEnvMap.value=v.isCubeTexture&&v.isRenderTargetTexture===!1?-1:1,m.reflectivity.value=p.reflectivity,m.ior.value=p.ior,m.refractionRatio.value=p.refractionRatio),p.lightMap&&(m.lightMap.value=p.lightMap,m.lightMapIntensity.value=p.lightMapIntensity,e(p.lightMap,m.lightMapTransform)),p.aoMap&&(m.aoMap.value=p.aoMap,m.aoMapIntensity.value=p.aoMapIntensity,e(p.aoMap,m.aoMapTransform))}function o(m,p){m.diffuse.value.copy(p.color),m.opacity.value=p.opacity,p.map&&(m.map.value=p.map,e(p.map,m.mapTransform))}function a(m,p){m.dashSize.value=p.dashSize,m.totalSize.value=p.dashSize+p.gapSize,m.scale.value=p.scale}function l(m,p,E,v){m.diffuse.value.copy(p.color),m.opacity.value=p.opacity,m.size.value=p.size*E,m.scale.value=v*.5,p.map&&(m.map.value=p.map,e(p.map,m.uvTransform)),p.alphaMap&&(m.alphaMap.value=p.alphaMap,e(p.alphaMap,m.alphaMapTransform)),p.alphaTest>0&&(m.alphaTest.value=p.alphaTest)}function c(m,p){m.diffuse.value.copy(p.color),m.opacity.value=p.opacity,m.rotation.value=p.rotation,p.map&&(m.map.value=p.map,e(p.map,m.mapTransform)),p.alphaMap&&(m.alphaMap.value=p.alphaMap,e(p.alphaMap,m.alphaMapTransform)),p.alphaTest>0&&(m.alphaTest.value=p.alphaTest)}function u(m,p){m.specular.value.copy(p.specular),m.shininess.value=Math.max(p.shininess,1e-4)}function h(m,p){p.gradientMap&&(m.gradientMap.value=p.gradientMap)}function f(m,p){m.metalness.value=p.metalness,p.metalnessMap&&(m.metalnessMap.value=p.metalnessMap,e(p.metalnessMap,m.metalnessMapTransform)),m.roughness.value=p.roughness,p.roughnessMap&&(m.roughnessMap.value=p.roughnessMap,e(p.roughnessMap,m.roughnessMapTransform)),p.envMap&&(m.envMapIntensity.value=p.envMapIntensity)}function d(m,p,E){m.ior.value=p.ior,p.sheen>0&&(m.sheenColor.value.copy(p.sheenColor).multiplyScalar(p.sheen),m.sheenRoughness.value=p.sheenRoughness,p.sheenColorMap&&(m.sheenColorMap.value=p.sheenColorMap,e(p.sheenColorMap,m.sheenColorMapTransform)),p.sheenRoughnessMap&&(m.sheenRoughnessMap.value=p.sheenRoughnessMap,e(p.sheenRoughnessMap,m.sheenRoughnessMapTransform))),p.clearcoat>0&&(m.clearcoat.value=p.clearcoat,m.clearcoatRoughness.value=p.clearcoatRoughness,p.clearcoatMap&&(m.clearcoatMap.value=p.clearcoatMap,e(p.clearcoatMap,m.clearcoatMapTransform)),p.clearcoatRoughnessMap&&(m.clearcoatRoughnessMap.value=p.clearcoatRoughnessMap,e(p.clearcoatRoughnessMap,m.clearcoatRoughnessMapTransform)),p.clearcoatNormalMap&&(m.clearcoatNormalMap.value=p.clearcoatNormalMap,e(p.clearcoatNormalMap,m.clearcoatNormalMapTransform),m.clearcoatNormalScale.value.copy(p.clearcoatNormalScale),p.side===_n&&m.clearcoatNormalScale.value.negate())),p.dispersion>0&&(m.dispersion.value=p.dispersion),p.iridescence>0&&(m.iridescence.value=p.iridescence,m.iridescenceIOR.value=p.iridescenceIOR,m.iridescenceThicknessMinimum.value=p.iridescenceThicknessRange[0],m.iridescenceThicknessMaximum.value=p.iridescenceThicknessRange[1],p.iridescenceMap&&(m.iridescenceMap.value=p.iridescenceMap,e(p.iridescenceMap,m.iridescenceMapTransform)),p.iridescenceThicknessMap&&(m.iridescenceThicknessMap.value=p.iridescenceThicknessMap,e(p.iridescenceThicknessMap,m.iridescenceThicknessMapTransform))),p.transmission>0&&(m.transmission.value=p.transmission,m.transmissionSamplerMap.value=E.texture,m.transmissionSamplerSize.value.set(E.width,E.height),p.transmissionMap&&(m.transmissionMap.value=p.transmissionMap,e(p.transmissionMap,m.transmissionMapTransform)),m.thickness.value=p.thickness,p.thicknessMap&&(m.thicknessMap.value=p.thicknessMap,e(p.thicknessMap,m.thicknessMapTransform)),m.attenuationDistance.value=p.attenuationDistance,m.attenuationColor.value.copy(p.attenuationColor)),p.anisotropy>0&&(m.anisotropyVector.value.set(p.anisotropy*Math.cos(p.anisotropyRotation),p.anisotropy*Math.sin(p.anisotropyRotation)),p.anisotropyMap&&(m.anisotropyMap.value=p.anisotropyMap,e(p.anisotropyMap,m.anisotropyMapTransform))),m.specularIntensity.value=p.specularIntensity,m.specularColor.value.copy(p.specularColor),p.specularColorMap&&(m.specularColorMap.value=p.specularColorMap,e(p.specularColorMap,m.specularColorMapTransform)),p.specularIntensityMap&&(m.specularIntensityMap.value=p.specularIntensityMap,e(p.specularIntensityMap,m.specularIntensityMapTransform))}function g(m,p){p.matcap&&(m.matcap.value=p.matcap)}function _(m,p){const E=t.get(p).light;m.referencePosition.value.setFromMatrixPosition(E.matrixWorld),m.nearDistance.value=E.shadow.camera.near,m.farDistance.value=E.shadow.camera.far}return{refreshFogUniforms:n,refreshMaterialUniforms:i}}function RS(r,t,e,n){let i={},s={},o=[];const a=r.getParameter(r.MAX_UNIFORM_BUFFER_BINDINGS);function l(E,v){const x=v.program;n.uniformBlockBinding(E,x)}function c(E,v){let x=i[E.id];x===void 0&&(g(E),x=u(E),i[E.id]=x,E.addEventListener("dispose",m));const R=v.program;n.updateUBOMapping(E,R);const w=t.render.frame;s[E.id]!==w&&(f(E),s[E.id]=w)}function u(E){const v=h();E.__bindingPointIndex=v;const x=r.createBuffer(),R=E.__size,w=E.usage;return r.bindBuffer(r.UNIFORM_BUFFER,x),r.bufferData(r.UNIFORM_BUFFER,R,w),r.bindBuffer(r.UNIFORM_BUFFER,null),r.bindBufferBase(r.UNIFORM_BUFFER,v,x),x}function h(){for(let E=0;E<a;E++)if(o.indexOf(E)===-1)return o.push(E),E;return console.error("THREE.WebGLRenderer: Maximum number of simultaneously usable uniforms groups reached."),0}function f(E){const v=i[E.id],x=E.uniforms,R=E.__cache;r.bindBuffer(r.UNIFORM_BUFFER,v);for(let w=0,b=x.length;w<b;w++){const C=Array.isArray(x[w])?x[w]:[x[w]];for(let S=0,M=C.length;S<M;S++){const P=C[S];if(d(P,w,S,R)===!0){const U=P.__offset,O=Array.isArray(P.value)?P.value:[P.value];let H=0;for(let $=0;$<O.length;$++){const X=O[$],Y=_(X);typeof X=="number"||typeof X=="boolean"?(P.__data[0]=X,r.bufferSubData(r.UNIFORM_BUFFER,U+H,P.__data)):X.isMatrix3?(P.__data[0]=X.elements[0],P.__data[1]=X.elements[1],P.__data[2]=X.elements[2],P.__data[3]=0,P.__data[4]=X.elements[3],P.__data[5]=X.elements[4],P.__data[6]=X.elements[5],P.__data[7]=0,P.__data[8]=X.elements[6],P.__data[9]=X.elements[7],P.__data[10]=X.elements[8],P.__data[11]=0):(X.toArray(P.__data,H),H+=Y.storage/Float32Array.BYTES_PER_ELEMENT)}r.bufferSubData(r.UNIFORM_BUFFER,U,P.__data)}}}r.bindBuffer(r.UNIFORM_BUFFER,null)}function d(E,v,x,R){const w=E.value,b=v+"_"+x;if(R[b]===void 0)return typeof w=="number"||typeof w=="boolean"?R[b]=w:R[b]=w.clone(),!0;{const C=R[b];if(typeof w=="number"||typeof w=="boolean"){if(C!==w)return R[b]=w,!0}else if(C.equals(w)===!1)return C.copy(w),!0}return!1}function g(E){const v=E.uniforms;let x=0;const R=16;for(let b=0,C=v.length;b<C;b++){const S=Array.isArray(v[b])?v[b]:[v[b]];for(let M=0,P=S.length;M<P;M++){const U=S[M],O=Array.isArray(U.value)?U.value:[U.value];for(let H=0,$=O.length;H<$;H++){const X=O[H],Y=_(X),z=x%R,nt=z%Y.boundary,D=z+nt;x+=nt,D!==0&&R-D<Y.storage&&(x+=R-D),U.__data=new Float32Array(Y.storage/Float32Array.BYTES_PER_ELEMENT),U.__offset=x,x+=Y.storage}}}const w=x%R;return w>0&&(x+=R-w),E.__size=x,E.__cache={},this}function _(E){const v={boundary:0,storage:0};return typeof E=="number"||typeof E=="boolean"?(v.boundary=4,v.storage=4):E.isVector2?(v.boundary=8,v.storage=8):E.isVector3||E.isColor?(v.boundary=16,v.storage=12):E.isVector4?(v.boundary=16,v.storage=16):E.isMatrix3?(v.boundary=48,v.storage=48):E.isMatrix4?(v.boundary=64,v.storage=64):E.isTexture?console.warn("THREE.WebGLRenderer: Texture samplers can not be part of an uniforms group."):console.warn("THREE.WebGLRenderer: Unsupported uniform value type.",E),v}function m(E){const v=E.target;v.removeEventListener("dispose",m);const x=o.indexOf(v.__bindingPointIndex);o.splice(x,1),r.deleteBuffer(i[v.id]),delete i[v.id],delete s[v.id]}function p(){for(const E in i)r.deleteBuffer(i[E]);o=[],i={},s={}}return{bind:l,update:c,dispose:p}}class CS{constructor(t={}){const{canvas:e=gg(),context:n=null,depth:i=!0,stencil:s=!1,alpha:o=!1,antialias:a=!1,premultipliedAlpha:l=!0,preserveDrawingBuffer:c=!1,powerPreference:u="default",failIfMajorPerformanceCaveat:h=!1,reverseDepthBuffer:f=!1}=t;this.isWebGLRenderer=!0;let d;if(n!==null){if(typeof WebGLRenderingContext<"u"&&n instanceof WebGLRenderingContext)throw new Error("THREE.WebGLRenderer: WebGL 1 is not supported since r163.");d=n.getContextAttributes().alpha}else d=o;const g=new Uint32Array(4),_=new Int32Array(4);let m=null,p=null;const E=[],v=[];this.domElement=e,this.debug={checkShaderErrors:!0,onShaderError:null},this.autoClear=!0,this.autoClearColor=!0,this.autoClearDepth=!0,this.autoClearStencil=!0,this.sortObjects=!0,this.clippingPlanes=[],this.localClippingEnabled=!1,this._outputColorSpace=Xn,this.toneMapping=sr,this.toneMappingExposure=1;const x=this;let R=!1,w=0,b=0,C=null,S=-1,M=null;const P=new De,U=new De;let O=null;const H=new ae(0);let $=0,X=e.width,Y=e.height,z=1,nt=null,D=null;const ut=new De(0,0,X,Y),it=new De(0,0,X,Y);let Tt=!1;const k=new Ku;let j=!1,at=!1;const et=new Ce,Mt=new Ce,Et=new q,Ot=new De,qt={background:null,fog:null,environment:null,overrideMaterial:null,isScene:!0};let Nt=!1;function Pt(){return C===null?z:1}let I=n;function ge(T,N){return e.getContext(T,N)}try{const T={alpha:!0,depth:i,stencil:s,antialias:a,premultipliedAlpha:l,preserveDrawingBuffer:c,powerPreference:u,failIfMajorPerformanceCaveat:h};if("setAttribute"in e&&e.setAttribute("data-engine",`three.js r${Hu}`),e.addEventListener("webglcontextlost",J,!1),e.addEventListener("webglcontextrestored",ht,!1),e.addEventListener("webglcontextcreationerror",pt,!1),I===null){const N="webgl2";if(I=ge(N,T),I===null)throw ge(N)?new Error("Error creating WebGL context with your selected attributes."):new Error("Error creating WebGL context.")}}catch(T){throw console.error("THREE.WebGLRenderer: "+T.message),T}let zt,B,At,ie,Dt,A,y,G,tt,Q,Z,dt,ct,_t,Xt,rt,lt,Ut,It,St,$t,Bt,se,L;function ft(){zt=new Ux(I),zt.init(),Bt=new xS(I,zt),B=new Rx(I,zt,t,Bt),At=new _S(I,zt),B.reverseDepthBuffer&&f&&At.buffers.depth.setReversed(!0),ie=new Ox(I),Dt=new eS,A=new vS(I,zt,At,Dt,B,Bt,ie),y=new Px(x),G=new Ix(x),tt=new Wg(I),se=new wx(I,tt),Q=new Nx(I,tt,ie,se),Z=new zx(I,Q,tt,ie),It=new Bx(I,B,A),rt=new Cx(Dt),dt=new tS(x,y,G,zt,B,se,rt),ct=new AS(x,Dt),_t=new iS,Xt=new cS(zt),Ut=new bx(x,y,G,At,Z,d,l),lt=new pS(x,Z,B),L=new RS(I,ie,B,At),St=new Ax(I,zt,ie),$t=new Fx(I,zt,ie),ie.programs=dt.programs,x.capabilities=B,x.extensions=zt,x.properties=Dt,x.renderLists=_t,x.shadowMap=lt,x.state=At,x.info=ie}ft();const K=new bS(x,I);this.xr=K,this.getContext=function(){return I},this.getContextAttributes=function(){return I.getContextAttributes()},this.forceContextLoss=function(){const T=zt.get("WEBGL_lose_context");T&&T.loseContext()},this.forceContextRestore=function(){const T=zt.get("WEBGL_lose_context");T&&T.restoreContext()},this.getPixelRatio=function(){return z},this.setPixelRatio=function(T){T!==void 0&&(z=T,this.setSize(X,Y,!1))},this.getSize=function(T){return T.set(X,Y)},this.setSize=function(T,N,V=!0){if(K.isPresenting){console.warn("THREE.WebGLRenderer: Can't change size while VR device is presenting.");return}X=T,Y=N,e.width=Math.floor(T*z),e.height=Math.floor(N*z),V===!0&&(e.style.width=T+"px",e.style.height=N+"px"),this.setViewport(0,0,T,N)},this.getDrawingBufferSize=function(T){return T.set(X*z,Y*z).floor()},this.setDrawingBufferSize=function(T,N,V){X=T,Y=N,z=V,e.width=Math.floor(T*V),e.height=Math.floor(N*V),this.setViewport(0,0,T,N)},this.getCurrentViewport=function(T){return T.copy(P)},this.getViewport=function(T){return T.copy(ut)},this.setViewport=function(T,N,V,W){T.isVector4?ut.set(T.x,T.y,T.z,T.w):ut.set(T,N,V,W),At.viewport(P.copy(ut).multiplyScalar(z).round())},this.getScissor=function(T){return T.copy(it)},this.setScissor=function(T,N,V,W){T.isVector4?it.set(T.x,T.y,T.z,T.w):it.set(T,N,V,W),At.scissor(U.copy(it).multiplyScalar(z).round())},this.getScissorTest=function(){return Tt},this.setScissorTest=function(T){At.setScissorTest(Tt=T)},this.setOpaqueSort=function(T){nt=T},this.setTransparentSort=function(T){D=T},this.getClearColor=function(T){return T.copy(Ut.getClearColor())},this.setClearColor=function(){Ut.setClearColor.apply(Ut,arguments)},this.getClearAlpha=function(){return Ut.getClearAlpha()},this.setClearAlpha=function(){Ut.setClearAlpha.apply(Ut,arguments)},this.clear=function(T=!0,N=!0,V=!0){let W=0;if(T){let F=!1;if(C!==null){const st=C.texture.format;F=st===$u||st===qu||st===Yu}if(F){const st=C.texture.type,ot=st===zi||st===Vr||st===Do||st===Us||st===Wu||st===Xu,mt=Ut.getClearColor(),yt=Ut.getClearAlpha(),Ht=mt.r,Wt=mt.g,wt=mt.b;ot?(g[0]=Ht,g[1]=Wt,g[2]=wt,g[3]=yt,I.clearBufferuiv(I.COLOR,0,g)):(_[0]=Ht,_[1]=Wt,_[2]=wt,_[3]=yt,I.clearBufferiv(I.COLOR,0,_))}else W|=I.COLOR_BUFFER_BIT}N&&(W|=I.DEPTH_BUFFER_BIT),V&&(W|=I.STENCIL_BUFFER_BIT,this.state.buffers.stencil.setMask(4294967295)),I.clear(W)},this.clearColor=function(){this.clear(!0,!1,!1)},this.clearDepth=function(){this.clear(!1,!0,!1)},this.clearStencil=function(){this.clear(!1,!1,!0)},this.dispose=function(){e.removeEventListener("webglcontextlost",J,!1),e.removeEventListener("webglcontextrestored",ht,!1),e.removeEventListener("webglcontextcreationerror",pt,!1),_t.dispose(),Xt.dispose(),Dt.dispose(),y.dispose(),G.dispose(),Z.dispose(),se.dispose(),L.dispose(),dt.dispose(),K.dispose(),K.removeEventListener("sessionstart",gt),K.removeEventListener("sessionend",Gt),Ct.stop()};function J(T){T.preventDefault(),console.log("THREE.WebGLRenderer: Context Lost."),R=!0}function ht(){console.log("THREE.WebGLRenderer: Context Restored."),R=!1;const T=ie.autoReset,N=lt.enabled,V=lt.autoUpdate,W=lt.needsUpdate,F=lt.type;ft(),ie.autoReset=T,lt.enabled=N,lt.autoUpdate=V,lt.needsUpdate=W,lt.type=F}function pt(T){console.error("THREE.WebGLRenderer: A WebGL context could not be created. Reason: ",T.statusMessage)}function kt(T){const N=T.target;N.removeEventListener("dispose",kt),le(N)}function le(T){Pe(T),Dt.remove(T)}function Pe(T){const N=Dt.get(T).programs;N!==void 0&&(N.forEach(function(V){dt.releaseProgram(V)}),T.isShaderMaterial&&dt.releaseShaderCache(T))}this.renderBufferDirect=function(T,N,V,W,F,st){N===null&&(N=qt);const ot=F.isMesh&&F.matrixWorld.determinant()<0,mt=An(T,N,V,W,F);At.setMaterial(W,ot);let yt=V.index,Ht=1;if(W.wireframe===!0){if(yt=Q.getWireframeAttribute(V),yt===void 0)return;Ht=2}const Wt=V.drawRange,wt=V.attributes.position;let Yt=Wt.start*Ht,ce=(Wt.start+Wt.count)*Ht;st!==null&&(Yt=Math.max(Yt,st.start*Ht),ce=Math.min(ce,(st.start+st.count)*Ht)),yt!==null?(Yt=Math.max(Yt,0),ce=Math.min(ce,yt.count)):wt!=null&&(Yt=Math.max(Yt,0),ce=Math.min(ce,wt.count));const fe=ce-Yt;if(fe<0||fe===1/0)return;se.setup(F,W,mt,V,yt);let Fe,de=St;if(yt!==null&&(Fe=tt.get(yt),de=$t,de.setIndex(Fe)),F.isMesh)W.wireframe===!0?(At.setLineWidth(W.wireframeLinewidth*Pt()),de.setMode(I.LINES)):de.setMode(I.TRIANGLES);else if(F.isLine){let Lt=W.linewidth;Lt===void 0&&(Lt=1),At.setLineWidth(Lt*Pt()),F.isLineSegments?de.setMode(I.LINES):F.isLineLoop?de.setMode(I.LINE_LOOP):de.setMode(I.LINE_STRIP)}else F.isPoints?de.setMode(I.POINTS):F.isSprite&&de.setMode(I.TRIANGLES);if(F.isBatchedMesh)if(F._multiDrawInstances!==null)de.renderMultiDrawInstances(F._multiDrawStarts,F._multiDrawCounts,F._multiDrawCount,F._multiDrawInstances);else if(zt.get("WEBGL_multi_draw"))de.renderMultiDraw(F._multiDrawStarts,F._multiDrawCounts,F._multiDrawCount);else{const Lt=F._multiDrawStarts,Si=F._multiDrawCounts,pe=F._multiDrawCount,Qn=yt?tt.get(yt).bytesPerElement:1,Xr=Dt.get(W).currentProgram.getUniforms();for(let Rn=0;Rn<pe;Rn++)Xr.setValue(I,"_gl_DrawID",Rn),de.render(Lt[Rn]/Qn,Si[Rn])}else if(F.isInstancedMesh)de.renderInstances(Yt,fe,F.count);else if(V.isInstancedBufferGeometry){const Lt=V._maxInstanceCount!==void 0?V._maxInstanceCount:1/0,Si=Math.min(V.instanceCount,Lt);de.renderInstances(Yt,fe,Si)}else de.render(Yt,fe)};function xt(T,N,V){T.transparent===!0&&T.side===fi&&T.forceSinglePass===!1?(T.side=_n,T.needsUpdate=!0,ve(T,N,V),T.side=cr,T.needsUpdate=!0,ve(T,N,V),T.side=fi):ve(T,N,V)}this.compile=function(T,N,V=null){V===null&&(V=T),p=Xt.get(V),p.init(N),v.push(p),V.traverseVisible(function(F){F.isLight&&F.layers.test(N.layers)&&(p.pushLight(F),F.castShadow&&p.pushShadow(F))}),T!==V&&T.traverseVisible(function(F){F.isLight&&F.layers.test(N.layers)&&(p.pushLight(F),F.castShadow&&p.pushShadow(F))}),p.setupLights();const W=new Set;return T.traverse(function(F){if(!(F.isMesh||F.isPoints||F.isLine||F.isSprite))return;const st=F.material;if(st)if(Array.isArray(st))for(let ot=0;ot<st.length;ot++){const mt=st[ot];xt(mt,V,F),W.add(mt)}else xt(st,V,F),W.add(st)}),v.pop(),p=null,W},this.compileAsync=function(T,N,V=null){const W=this.compile(T,N,V);return new Promise(F=>{function st(){if(W.forEach(function(ot){Dt.get(ot).currentProgram.isReady()&&W.delete(ot)}),W.size===0){F(T);return}setTimeout(st,10)}zt.get("KHR_parallel_shader_compile")!==null?st():setTimeout(st,10)})};let Rt=null;function Kt(T){Rt&&Rt(T)}function gt(){Ct.stop()}function Gt(){Ct.start()}const Ct=new Op;Ct.setAnimationLoop(Kt),typeof self<"u"&&Ct.setContext(self),this.setAnimationLoop=function(T){Rt=T,K.setAnimationLoop(T),T===null?Ct.stop():Ct.start()},K.addEventListener("sessionstart",gt),K.addEventListener("sessionend",Gt),this.render=function(T,N){if(N!==void 0&&N.isCamera!==!0){console.error("THREE.WebGLRenderer.render: camera is not an instance of THREE.Camera.");return}if(R===!0)return;if(T.matrixWorldAutoUpdate===!0&&T.updateMatrixWorld(),N.parent===null&&N.matrixWorldAutoUpdate===!0&&N.updateMatrixWorld(),K.enabled===!0&&K.isPresenting===!0&&(K.cameraAutoUpdate===!0&&K.updateCamera(N),N=K.getCamera()),T.isScene===!0&&T.onBeforeRender(x,T,N,C),p=Xt.get(T,v.length),p.init(N),v.push(p),Mt.multiplyMatrices(N.projectionMatrix,N.matrixWorldInverse),k.setFromProjectionMatrix(Mt),at=this.localClippingEnabled,j=rt.init(this.clippingPlanes,at),m=_t.get(T,E.length),m.init(),E.push(m),K.enabled===!0&&K.isPresenting===!0){const st=x.xr.getDepthSensingMesh();st!==null&&Vt(st,N,-1/0,x.sortObjects)}Vt(T,N,0,x.sortObjects),m.finish(),x.sortObjects===!0&&m.sort(nt,D),Nt=K.enabled===!1||K.isPresenting===!1||K.hasDepthSensing()===!1,Nt&&Ut.addToRenderList(m,T),this.info.render.frame++,j===!0&&rt.beginShadows();const V=p.state.shadowsArray;lt.render(V,T,N),j===!0&&rt.endShadows(),this.info.autoReset===!0&&this.info.reset();const W=m.opaque,F=m.transmissive;if(p.setupLights(),N.isArrayCamera){const st=N.cameras;if(F.length>0)for(let ot=0,mt=st.length;ot<mt;ot++){const yt=st[ot];Qt(W,F,T,yt)}Nt&&Ut.render(T);for(let ot=0,mt=st.length;ot<mt;ot++){const yt=st[ot];Ie(m,T,yt,yt.viewport)}}else F.length>0&&Qt(W,F,T,N),Nt&&Ut.render(T),Ie(m,T,N);C!==null&&(A.updateMultisampleRenderTarget(C),A.updateRenderTargetMipmap(C)),T.isScene===!0&&T.onAfterRender(x,T,N),se.resetDefaultState(),S=-1,M=null,v.pop(),v.length>0?(p=v[v.length-1],j===!0&&rt.setGlobalState(x.clippingPlanes,p.state.camera)):p=null,E.pop(),E.length>0?m=E[E.length-1]:m=null};function Vt(T,N,V,W){if(T.visible===!1)return;if(T.layers.test(N.layers)){if(T.isGroup)V=T.renderOrder;else if(T.isLOD)T.autoUpdate===!0&&T.update(N);else if(T.isLight)p.pushLight(T),T.castShadow&&p.pushShadow(T);else if(T.isSprite){if(!T.frustumCulled||k.intersectsSprite(T)){W&&Ot.setFromMatrixPosition(T.matrixWorld).applyMatrix4(Mt);const ot=Z.update(T),mt=T.material;mt.visible&&m.push(T,ot,mt,V,Ot.z,null)}}else if((T.isMesh||T.isLine||T.isPoints)&&(!T.frustumCulled||k.intersectsObject(T))){const ot=Z.update(T),mt=T.material;if(W&&(T.boundingSphere!==void 0?(T.boundingSphere===null&&T.computeBoundingSphere(),Ot.copy(T.boundingSphere.center)):(ot.boundingSphere===null&&ot.computeBoundingSphere(),Ot.copy(ot.boundingSphere.center)),Ot.applyMatrix4(T.matrixWorld).applyMatrix4(Mt)),Array.isArray(mt)){const yt=ot.groups;for(let Ht=0,Wt=yt.length;Ht<Wt;Ht++){const wt=yt[Ht],Yt=mt[wt.materialIndex];Yt&&Yt.visible&&m.push(T,ot,Yt,V,Ot.z,wt)}}else mt.visible&&m.push(T,ot,mt,V,Ot.z,null)}}const st=T.children;for(let ot=0,mt=st.length;ot<mt;ot++)Vt(st[ot],N,V,W)}function Ie(T,N,V,W){const F=T.opaque,st=T.transmissive,ot=T.transparent;p.setupLightsView(V),j===!0&&rt.setGlobalState(x.clippingPlanes,V),W&&At.viewport(P.copy(W)),F.length>0&&ye(F,N,V),st.length>0&&ye(st,N,V),ot.length>0&&ye(ot,N,V),At.buffers.depth.setTest(!0),At.buffers.depth.setMask(!0),At.buffers.color.setMask(!0),At.setPolygonOffset(!1)}function Qt(T,N,V,W){if((V.isScene===!0?V.overrideMaterial:null)!==null)return;p.state.transmissionRenderTarget[W.id]===void 0&&(p.state.transmissionRenderTarget[W.id]=new Gr(1,1,{generateMipmaps:!0,type:zt.has("EXT_color_buffer_half_float")||zt.has("EXT_color_buffer_float")?Io:zi,minFilter:Pr,samples:4,stencilBuffer:s,resolveDepthBuffer:!1,resolveStencilBuffer:!1,colorSpace:oe.workingColorSpace}));const st=p.state.transmissionRenderTarget[W.id],ot=W.viewport||P;st.setSize(ot.z,ot.w);const mt=x.getRenderTarget();x.setRenderTarget(st),x.getClearColor(H),$=x.getClearAlpha(),$<1&&x.setClearColor(16777215,.5),x.clear(),Nt&&Ut.render(V);const yt=x.toneMapping;x.toneMapping=sr;const Ht=W.viewport;if(W.viewport!==void 0&&(W.viewport=void 0),p.setupLightsView(W),j===!0&&rt.setGlobalState(x.clippingPlanes,W),ye(T,V,W),A.updateMultisampleRenderTarget(st),A.updateRenderTargetMipmap(st),zt.has("WEBGL_multisampled_render_to_texture")===!1){let Wt=!1;for(let wt=0,Yt=N.length;wt<Yt;wt++){const ce=N[wt],fe=ce.object,Fe=ce.geometry,de=ce.material,Lt=ce.group;if(de.side===fi&&fe.layers.test(W.layers)){const Si=de.side;de.side=_n,de.needsUpdate=!0,He(fe,V,W,Fe,de,Lt),de.side=Si,de.needsUpdate=!0,Wt=!0}}Wt===!0&&(A.updateMultisampleRenderTarget(st),A.updateRenderTargetMipmap(st))}x.setRenderTarget(mt),x.setClearColor(H,$),Ht!==void 0&&(W.viewport=Ht),x.toneMapping=yt}function ye(T,N,V){const W=N.isScene===!0?N.overrideMaterial:null;for(let F=0,st=T.length;F<st;F++){const ot=T[F],mt=ot.object,yt=ot.geometry,Ht=W===null?ot.material:W,Wt=ot.group;mt.layers.test(V.layers)&&He(mt,N,V,yt,Ht,Wt)}}function He(T,N,V,W,F,st){T.onBeforeRender(x,N,V,W,F,st),T.modelViewMatrix.multiplyMatrices(V.matrixWorldInverse,T.matrixWorld),T.normalMatrix.getNormalMatrix(T.modelViewMatrix),F.onBeforeRender(x,N,V,W,T,st),F.transparent===!0&&F.side===fi&&F.forceSinglePass===!1?(F.side=_n,F.needsUpdate=!0,x.renderBufferDirect(V,N,W,F,T,st),F.side=cr,F.needsUpdate=!0,x.renderBufferDirect(V,N,W,F,T,st),F.side=fi):x.renderBufferDirect(V,N,W,F,T,st),T.onAfterRender(x,N,V,W,F,st)}function ve(T,N,V){N.isScene!==!0&&(N=qt);const W=Dt.get(T),F=p.state.lights,st=p.state.shadowsArray,ot=F.state.version,mt=dt.getParameters(T,F.state,st,N,V),yt=dt.getProgramCacheKey(mt);let Ht=W.programs;W.environment=T.isMeshStandardMaterial?N.environment:null,W.fog=N.fog,W.envMap=(T.isMeshStandardMaterial?G:y).get(T.envMap||W.environment),W.envMapRotation=W.environment!==null&&T.envMap===null?N.environmentRotation:T.envMapRotation,Ht===void 0&&(T.addEventListener("dispose",kt),Ht=new Map,W.programs=Ht);let Wt=Ht.get(yt);if(Wt!==void 0){if(W.currentProgram===Wt&&W.lightsStateVersion===ot)return he(T,mt),Wt}else mt.uniforms=dt.getUniforms(T),T.onBeforeCompile(mt,x),Wt=dt.acquireProgram(mt,yt),Ht.set(yt,Wt),W.uniforms=mt.uniforms;const wt=W.uniforms;return(!T.isShaderMaterial&&!T.isRawShaderMaterial||T.clipping===!0)&&(wt.clippingPlanes=rt.uniform),he(T,mt),W.needsLights=an(T),W.lightsStateVersion=ot,W.needsLights&&(wt.ambientLightColor.value=F.state.ambient,wt.lightProbe.value=F.state.probe,wt.directionalLights.value=F.state.directional,wt.directionalLightShadows.value=F.state.directionalShadow,wt.spotLights.value=F.state.spot,wt.spotLightShadows.value=F.state.spotShadow,wt.rectAreaLights.value=F.state.rectArea,wt.ltc_1.value=F.state.rectAreaLTC1,wt.ltc_2.value=F.state.rectAreaLTC2,wt.pointLights.value=F.state.point,wt.pointLightShadows.value=F.state.pointShadow,wt.hemisphereLights.value=F.state.hemi,wt.directionalShadowMap.value=F.state.directionalShadowMap,wt.directionalShadowMatrix.value=F.state.directionalShadowMatrix,wt.spotShadowMap.value=F.state.spotShadowMap,wt.spotLightMatrix.value=F.state.spotLightMatrix,wt.spotLightMap.value=F.state.spotLightMap,wt.pointShadowMap.value=F.state.pointShadowMap,wt.pointShadowMatrix.value=F.state.pointShadowMatrix),W.currentProgram=Wt,W.uniformsList=null,Wt}function xe(T){if(T.uniformsList===null){const N=T.currentProgram.getUniforms();T.uniformsList=Fa.seqWithValue(N.seq,T.uniforms)}return T.uniformsList}function he(T,N){const V=Dt.get(T);V.outputColorSpace=N.outputColorSpace,V.batching=N.batching,V.batchingColor=N.batchingColor,V.instancing=N.instancing,V.instancingColor=N.instancingColor,V.instancingMorph=N.instancingMorph,V.skinning=N.skinning,V.morphTargets=N.morphTargets,V.morphNormals=N.morphNormals,V.morphColors=N.morphColors,V.morphTargetsCount=N.morphTargetsCount,V.numClippingPlanes=N.numClippingPlanes,V.numIntersection=N.numClipIntersection,V.vertexAlphas=N.vertexAlphas,V.vertexTangents=N.vertexTangents,V.toneMapping=N.toneMapping}function An(T,N,V,W,F){N.isScene!==!0&&(N=qt),A.resetTextureUnits();const st=N.fog,ot=W.isMeshStandardMaterial?N.environment:null,mt=C===null?x.outputColorSpace:C.isXRRenderTarget===!0?C.texture.colorSpace:Os,yt=(W.isMeshStandardMaterial?G:y).get(W.envMap||ot),Ht=W.vertexColors===!0&&!!V.attributes.color&&V.attributes.color.itemSize===4,Wt=!!V.attributes.tangent&&(!!W.normalMap||W.anisotropy>0),wt=!!V.morphAttributes.position,Yt=!!V.morphAttributes.normal,ce=!!V.morphAttributes.color;let fe=sr;W.toneMapped&&(C===null||C.isXRRenderTarget===!0)&&(fe=x.toneMapping);const Fe=V.morphAttributes.position||V.morphAttributes.normal||V.morphAttributes.color,de=Fe!==void 0?Fe.length:0,Lt=Dt.get(W),Si=p.state.lights;if(j===!0&&(at===!0||T!==M)){const Vn=T===M&&W.id===S;rt.setState(W,T,Vn)}let pe=!1;W.version===Lt.__version?(Lt.needsLights&&Lt.lightsStateVersion!==Si.state.version||Lt.outputColorSpace!==mt||F.isBatchedMesh&&Lt.batching===!1||!F.isBatchedMesh&&Lt.batching===!0||F.isBatchedMesh&&Lt.batchingColor===!0&&F.colorTexture===null||F.isBatchedMesh&&Lt.batchingColor===!1&&F.colorTexture!==null||F.isInstancedMesh&&Lt.instancing===!1||!F.isInstancedMesh&&Lt.instancing===!0||F.isSkinnedMesh&&Lt.skinning===!1||!F.isSkinnedMesh&&Lt.skinning===!0||F.isInstancedMesh&&Lt.instancingColor===!0&&F.instanceColor===null||F.isInstancedMesh&&Lt.instancingColor===!1&&F.instanceColor!==null||F.isInstancedMesh&&Lt.instancingMorph===!0&&F.morphTexture===null||F.isInstancedMesh&&Lt.instancingMorph===!1&&F.morphTexture!==null||Lt.envMap!==yt||W.fog===!0&&Lt.fog!==st||Lt.numClippingPlanes!==void 0&&(Lt.numClippingPlanes!==rt.numPlanes||Lt.numIntersection!==rt.numIntersection)||Lt.vertexAlphas!==Ht||Lt.vertexTangents!==Wt||Lt.morphTargets!==wt||Lt.morphNormals!==Yt||Lt.morphColors!==ce||Lt.toneMapping!==fe||Lt.morphTargetsCount!==de)&&(pe=!0):(pe=!0,Lt.__version=W.version);let Qn=Lt.currentProgram;pe===!0&&(Qn=ve(W,N,F));let Xr=!1,Rn=!1,Hs=!1;const be=Qn.getUniforms(),ai=Lt.uniforms;if(At.useProgram(Qn.program)&&(Xr=!0,Rn=!0,Hs=!0),W.id!==S&&(S=W.id,Rn=!0),Xr||M!==T){At.buffers.depth.getReversed()?(et.copy(T.projectionMatrix),xg(et),Mg(et),be.setValue(I,"projectionMatrix",et)):be.setValue(I,"projectionMatrix",T.projectionMatrix),be.setValue(I,"viewMatrix",T.matrixWorldInverse);const ki=be.map.cameraPosition;ki!==void 0&&ki.setValue(I,Et.setFromMatrixPosition(T.matrixWorld)),B.logarithmicDepthBuffer&&be.setValue(I,"logDepthBufFC",2/(Math.log(T.far+1)/Math.LN2)),(W.isMeshPhongMaterial||W.isMeshToonMaterial||W.isMeshLambertMaterial||W.isMeshBasicMaterial||W.isMeshStandardMaterial||W.isShaderMaterial)&&be.setValue(I,"isOrthographic",T.isOrthographicCamera===!0),M!==T&&(M=T,Rn=!0,Hs=!0)}if(F.isSkinnedMesh){be.setOptional(I,F,"bindMatrix"),be.setOptional(I,F,"bindMatrixInverse");const Vn=F.skeleton;Vn&&(Vn.boneTexture===null&&Vn.computeBoneTexture(),be.setValue(I,"boneTexture",Vn.boneTexture,A))}F.isBatchedMesh&&(be.setOptional(I,F,"batchingTexture"),be.setValue(I,"batchingTexture",F._matricesTexture,A),be.setOptional(I,F,"batchingIdTexture"),be.setValue(I,"batchingIdTexture",F._indirectTexture,A),be.setOptional(I,F,"batchingColorTexture"),F._colorsTexture!==null&&be.setValue(I,"batchingColorTexture",F._colorsTexture,A));const Vs=V.morphAttributes;if((Vs.position!==void 0||Vs.normal!==void 0||Vs.color!==void 0)&&It.update(F,V,Qn),(Rn||Lt.receiveShadow!==F.receiveShadow)&&(Lt.receiveShadow=F.receiveShadow,be.setValue(I,"receiveShadow",F.receiveShadow)),W.isMeshGouraudMaterial&&W.envMap!==null&&(ai.envMap.value=yt,ai.flipEnvMap.value=yt.isCubeTexture&&yt.isRenderTargetTexture===!1?-1:1),W.isMeshStandardMaterial&&W.envMap===null&&N.environment!==null&&(ai.envMapIntensity.value=N.environmentIntensity),Rn&&(be.setValue(I,"toneMappingExposure",x.toneMappingExposure),Lt.needsLights&&Te(ai,Hs),st&&W.fog===!0&&ct.refreshFogUniforms(ai,st),ct.refreshMaterialUniforms(ai,W,z,Y,p.state.transmissionRenderTarget[T.id]),Fa.upload(I,xe(Lt),ai,A)),W.isShaderMaterial&&W.uniformsNeedUpdate===!0&&(Fa.upload(I,xe(Lt),ai,A),W.uniformsNeedUpdate=!1),W.isSpriteMaterial&&be.setValue(I,"center",F.center),be.setValue(I,"modelViewMatrix",F.modelViewMatrix),be.setValue(I,"normalMatrix",F.normalMatrix),be.setValue(I,"modelMatrix",F.matrixWorld),W.isShaderMaterial||W.isRawShaderMaterial){const Vn=W.uniformsGroups;for(let ki=0,Hi=Vn.length;ki<Hi;ki++){const Ju=Vn[ki];L.update(Ju,Qn),L.bind(Ju,Qn)}}return Qn}function Te(T,N){T.ambientLightColor.needsUpdate=N,T.lightProbe.needsUpdate=N,T.directionalLights.needsUpdate=N,T.directionalLightShadows.needsUpdate=N,T.pointLights.needsUpdate=N,T.pointLightShadows.needsUpdate=N,T.spotLights.needsUpdate=N,T.spotLightShadows.needsUpdate=N,T.rectAreaLights.needsUpdate=N,T.hemisphereLights.needsUpdate=N}function an(T){return T.isMeshLambertMaterial||T.isMeshToonMaterial||T.isMeshPhongMaterial||T.isMeshStandardMaterial||T.isShadowMaterial||T.isShaderMaterial&&T.lights===!0}this.getActiveCubeFace=function(){return w},this.getActiveMipmapLevel=function(){return b},this.getRenderTarget=function(){return C},this.setRenderTargetTextures=function(T,N,V){Dt.get(T.texture).__webglTexture=N,Dt.get(T.depthTexture).__webglTexture=V;const W=Dt.get(T);W.__hasExternalTextures=!0,W.__autoAllocateDepthBuffer=V===void 0,W.__autoAllocateDepthBuffer||zt.has("WEBGL_multisampled_render_to_texture")===!0&&(console.warn("THREE.WebGLRenderer: Render-to-texture extension was disabled because an external texture was provided"),W.__useRenderToTexture=!1)},this.setRenderTargetFramebuffer=function(T,N){const V=Dt.get(T);V.__webglFramebuffer=N,V.__useDefaultFramebuffer=N===void 0},this.setRenderTarget=function(T,N=0,V=0){C=T,w=N,b=V;let W=!0,F=null,st=!1,ot=!1;if(T){const yt=Dt.get(T);if(yt.__useDefaultFramebuffer!==void 0)At.bindFramebuffer(I.FRAMEBUFFER,null),W=!1;else if(yt.__webglFramebuffer===void 0)A.setupRenderTarget(T);else if(yt.__hasExternalTextures)A.rebindTextures(T,Dt.get(T.texture).__webglTexture,Dt.get(T.depthTexture).__webglTexture);else if(T.depthBuffer){const wt=T.depthTexture;if(yt.__boundDepthTexture!==wt){if(wt!==null&&Dt.has(wt)&&(T.width!==wt.image.width||T.height!==wt.image.height))throw new Error("WebGLRenderTarget: Attached DepthTexture is initialized to the incorrect size.");A.setupDepthRenderbuffer(T)}}const Ht=T.texture;(Ht.isData3DTexture||Ht.isDataArrayTexture||Ht.isCompressedArrayTexture)&&(ot=!0);const Wt=Dt.get(T).__webglFramebuffer;T.isWebGLCubeRenderTarget?(Array.isArray(Wt[N])?F=Wt[N][V]:F=Wt[N],st=!0):T.samples>0&&A.useMultisampledRTT(T)===!1?F=Dt.get(T).__webglMultisampledFramebuffer:Array.isArray(Wt)?F=Wt[V]:F=Wt,P.copy(T.viewport),U.copy(T.scissor),O=T.scissorTest}else P.copy(ut).multiplyScalar(z).floor(),U.copy(it).multiplyScalar(z).floor(),O=Tt;if(At.bindFramebuffer(I.FRAMEBUFFER,F)&&W&&At.drawBuffers(T,F),At.viewport(P),At.scissor(U),At.setScissorTest(O),st){const yt=Dt.get(T.texture);I.framebufferTexture2D(I.FRAMEBUFFER,I.COLOR_ATTACHMENT0,I.TEXTURE_CUBE_MAP_POSITIVE_X+N,yt.__webglTexture,V)}else if(ot){const yt=Dt.get(T.texture),Ht=N||0;I.framebufferTextureLayer(I.FRAMEBUFFER,I.COLOR_ATTACHMENT0,yt.__webglTexture,V||0,Ht)}S=-1},this.readRenderTargetPixels=function(T,N,V,W,F,st,ot){if(!(T&&T.isWebGLRenderTarget)){console.error("THREE.WebGLRenderer.readRenderTargetPixels: renderTarget is not THREE.WebGLRenderTarget.");return}let mt=Dt.get(T).__webglFramebuffer;if(T.isWebGLCubeRenderTarget&&ot!==void 0&&(mt=mt[ot]),mt){At.bindFramebuffer(I.FRAMEBUFFER,mt);try{const yt=T.texture,Ht=yt.format,Wt=yt.type;if(!B.textureFormatReadable(Ht)){console.error("THREE.WebGLRenderer.readRenderTargetPixels: renderTarget is not in RGBA or implementation defined format.");return}if(!B.textureTypeReadable(Wt)){console.error("THREE.WebGLRenderer.readRenderTargetPixels: renderTarget is not in UnsignedByteType or implementation defined type.");return}N>=0&&N<=T.width-W&&V>=0&&V<=T.height-F&&I.readPixels(N,V,W,F,Bt.convert(Ht),Bt.convert(Wt),st)}finally{const yt=C!==null?Dt.get(C).__webglFramebuffer:null;At.bindFramebuffer(I.FRAMEBUFFER,yt)}}},this.readRenderTargetPixelsAsync=async function(T,N,V,W,F,st,ot){if(!(T&&T.isWebGLRenderTarget))throw new Error("THREE.WebGLRenderer.readRenderTargetPixels: renderTarget is not THREE.WebGLRenderTarget.");let mt=Dt.get(T).__webglFramebuffer;if(T.isWebGLCubeRenderTarget&&ot!==void 0&&(mt=mt[ot]),mt){const yt=T.texture,Ht=yt.format,Wt=yt.type;if(!B.textureFormatReadable(Ht))throw new Error("THREE.WebGLRenderer.readRenderTargetPixelsAsync: renderTarget is not in RGBA or implementation defined format.");if(!B.textureTypeReadable(Wt))throw new Error("THREE.WebGLRenderer.readRenderTargetPixelsAsync: renderTarget is not in UnsignedByteType or implementation defined type.");if(N>=0&&N<=T.width-W&&V>=0&&V<=T.height-F){At.bindFramebuffer(I.FRAMEBUFFER,mt);const wt=I.createBuffer();I.bindBuffer(I.PIXEL_PACK_BUFFER,wt),I.bufferData(I.PIXEL_PACK_BUFFER,st.byteLength,I.STREAM_READ),I.readPixels(N,V,W,F,Bt.convert(Ht),Bt.convert(Wt),0);const Yt=C!==null?Dt.get(C).__webglFramebuffer:null;At.bindFramebuffer(I.FRAMEBUFFER,Yt);const ce=I.fenceSync(I.SYNC_GPU_COMMANDS_COMPLETE,0);return I.flush(),await vg(I,ce,4),I.bindBuffer(I.PIXEL_PACK_BUFFER,wt),I.getBufferSubData(I.PIXEL_PACK_BUFFER,0,st),I.deleteBuffer(wt),I.deleteSync(ce),st}else throw new Error("THREE.WebGLRenderer.readRenderTargetPixelsAsync: requested read bounds are out of range.")}},this.copyFramebufferToTexture=function(T,N=null,V=0){T.isTexture!==!0&&(so("WebGLRenderer: copyFramebufferToTexture function signature has changed."),N=arguments[0]||null,T=arguments[1]);const W=Math.pow(2,-V),F=Math.floor(T.image.width*W),st=Math.floor(T.image.height*W),ot=N!==null?N.x:0,mt=N!==null?N.y:0;A.setTexture2D(T,0),I.copyTexSubImage2D(I.TEXTURE_2D,V,0,0,ot,mt,F,st),At.unbindTexture()},this.copyTextureToTexture=function(T,N,V=null,W=null,F=0){T.isTexture!==!0&&(so("WebGLRenderer: copyTextureToTexture function signature has changed."),W=arguments[0]||null,T=arguments[1],N=arguments[2],F=arguments[3]||0,V=null);let st,ot,mt,yt,Ht,Wt,wt,Yt,ce;const fe=T.isCompressedTexture?T.mipmaps[F]:T.image;V!==null?(st=V.max.x-V.min.x,ot=V.max.y-V.min.y,mt=V.isBox3?V.max.z-V.min.z:1,yt=V.min.x,Ht=V.min.y,Wt=V.isBox3?V.min.z:0):(st=fe.width,ot=fe.height,mt=fe.depth||1,yt=0,Ht=0,Wt=0),W!==null?(wt=W.x,Yt=W.y,ce=W.z):(wt=0,Yt=0,ce=0);const Fe=Bt.convert(N.format),de=Bt.convert(N.type);let Lt;N.isData3DTexture?(A.setTexture3D(N,0),Lt=I.TEXTURE_3D):N.isDataArrayTexture||N.isCompressedArrayTexture?(A.setTexture2DArray(N,0),Lt=I.TEXTURE_2D_ARRAY):(A.setTexture2D(N,0),Lt=I.TEXTURE_2D),I.pixelStorei(I.UNPACK_FLIP_Y_WEBGL,N.flipY),I.pixelStorei(I.UNPACK_PREMULTIPLY_ALPHA_WEBGL,N.premultiplyAlpha),I.pixelStorei(I.UNPACK_ALIGNMENT,N.unpackAlignment);const Si=I.getParameter(I.UNPACK_ROW_LENGTH),pe=I.getParameter(I.UNPACK_IMAGE_HEIGHT),Qn=I.getParameter(I.UNPACK_SKIP_PIXELS),Xr=I.getParameter(I.UNPACK_SKIP_ROWS),Rn=I.getParameter(I.UNPACK_SKIP_IMAGES);I.pixelStorei(I.UNPACK_ROW_LENGTH,fe.width),I.pixelStorei(I.UNPACK_IMAGE_HEIGHT,fe.height),I.pixelStorei(I.UNPACK_SKIP_PIXELS,yt),I.pixelStorei(I.UNPACK_SKIP_ROWS,Ht),I.pixelStorei(I.UNPACK_SKIP_IMAGES,Wt);const Hs=T.isDataArrayTexture||T.isData3DTexture,be=N.isDataArrayTexture||N.isData3DTexture;if(T.isRenderTargetTexture||T.isDepthTexture){const ai=Dt.get(T),Vs=Dt.get(N),Vn=Dt.get(ai.__renderTarget),ki=Dt.get(Vs.__renderTarget);At.bindFramebuffer(I.READ_FRAMEBUFFER,Vn.__webglFramebuffer),At.bindFramebuffer(I.DRAW_FRAMEBUFFER,ki.__webglFramebuffer);for(let Hi=0;Hi<mt;Hi++)Hs&&I.framebufferTextureLayer(I.READ_FRAMEBUFFER,I.COLOR_ATTACHMENT0,Dt.get(T).__webglTexture,F,Wt+Hi),T.isDepthTexture?(be&&I.framebufferTextureLayer(I.DRAW_FRAMEBUFFER,I.COLOR_ATTACHMENT0,Dt.get(N).__webglTexture,F,ce+Hi),I.blitFramebuffer(yt,Ht,st,ot,wt,Yt,st,ot,I.DEPTH_BUFFER_BIT,I.NEAREST)):be?I.copyTexSubImage3D(Lt,F,wt,Yt,ce+Hi,yt,Ht,st,ot):I.copyTexSubImage2D(Lt,F,wt,Yt,ce+Hi,yt,Ht,st,ot);At.bindFramebuffer(I.READ_FRAMEBUFFER,null),At.bindFramebuffer(I.DRAW_FRAMEBUFFER,null)}else be?T.isDataTexture||T.isData3DTexture?I.texSubImage3D(Lt,F,wt,Yt,ce,st,ot,mt,Fe,de,fe.data):N.isCompressedArrayTexture?I.compressedTexSubImage3D(Lt,F,wt,Yt,ce,st,ot,mt,Fe,fe.data):I.texSubImage3D(Lt,F,wt,Yt,ce,st,ot,mt,Fe,de,fe):T.isDataTexture?I.texSubImage2D(I.TEXTURE_2D,F,wt,Yt,st,ot,Fe,de,fe.data):T.isCompressedTexture?I.compressedTexSubImage2D(I.TEXTURE_2D,F,wt,Yt,fe.width,fe.height,Fe,fe.data):I.texSubImage2D(I.TEXTURE_2D,F,wt,Yt,st,ot,Fe,de,fe);I.pixelStorei(I.UNPACK_ROW_LENGTH,Si),I.pixelStorei(I.UNPACK_IMAGE_HEIGHT,pe),I.pixelStorei(I.UNPACK_SKIP_PIXELS,Qn),I.pixelStorei(I.UNPACK_SKIP_ROWS,Xr),I.pixelStorei(I.UNPACK_SKIP_IMAGES,Rn),F===0&&N.generateMipmaps&&I.generateMipmap(Lt),At.unbindTexture()},this.copyTextureToTexture3D=function(T,N,V=null,W=null,F=0){return T.isTexture!==!0&&(so("WebGLRenderer: copyTextureToTexture3D function signature has changed."),V=arguments[0]||null,W=arguments[1]||null,T=arguments[2],N=arguments[3],F=arguments[4]||0),so('WebGLRenderer: copyTextureToTexture3D function has been deprecated. Use "copyTextureToTexture" instead.'),this.copyTextureToTexture(T,N,V,W,F)},this.initRenderTarget=function(T){Dt.get(T).__webglFramebuffer===void 0&&A.setupRenderTarget(T)},this.initTexture=function(T){T.isCubeTexture?A.setTextureCube(T,0):T.isData3DTexture?A.setTexture3D(T,0):T.isDataArrayTexture||T.isCompressedArrayTexture?A.setTexture2DArray(T,0):A.setTexture2D(T,0),At.unbindTexture()},this.resetState=function(){w=0,b=0,C=null,At.reset(),se.reset()},typeof __THREE_DEVTOOLS__<"u"&&__THREE_DEVTOOLS__.dispatchEvent(new CustomEvent("observe",{detail:this}))}get coordinateSystem(){return Ui}get outputColorSpace(){return this._outputColorSpace}set outputColorSpace(t){this._outputColorSpace=t;const e=this.getContext();e.drawingBufferColorspace=oe._getDrawingBufferColorSpace(t),e.unpackColorSpace=oe._getUnpackColorSpace()}}class PS extends Je{constructor(){super(),this.isScene=!0,this.type="Scene",this.background=null,this.environment=null,this.fog=null,this.backgroundBlurriness=0,this.backgroundIntensity=1,this.backgroundRotation=new Mi,this.environmentIntensity=1,this.environmentRotation=new Mi,this.overrideMaterial=null,typeof __THREE_DEVTOOLS__<"u"&&__THREE_DEVTOOLS__.dispatchEvent(new CustomEvent("observe",{detail:this}))}copy(t,e){return super.copy(t,e),t.background!==null&&(this.background=t.background.clone()),t.environment!==null&&(this.environment=t.environment.clone()),t.fog!==null&&(this.fog=t.fog.clone()),this.backgroundBlurriness=t.backgroundBlurriness,this.backgroundIntensity=t.backgroundIntensity,this.backgroundRotation.copy(t.backgroundRotation),this.environmentIntensity=t.environmentIntensity,this.environmentRotation.copy(t.environmentRotation),t.overrideMaterial!==null&&(this.overrideMaterial=t.overrideMaterial.clone()),this.matrixAutoUpdate=t.matrixAutoUpdate,this}toJSON(t){const e=super.toJSON(t);return this.fog!==null&&(e.object.fog=this.fog.toJSON()),this.backgroundBlurriness>0&&(e.object.backgroundBlurriness=this.backgroundBlurriness),this.backgroundIntensity!==1&&(e.object.backgroundIntensity=this.backgroundIntensity),e.object.backgroundRotation=this.backgroundRotation.toArray(),this.environmentIntensity!==1&&(e.object.environmentIntensity=this.environmentIntensity),e.object.environmentRotation=this.environmentRotation.toArray(),e}}class mu extends zs{static get type(){return"LineBasicMaterial"}constructor(t){super(),this.isLineBasicMaterial=!0,this.color=new ae(16777215),this.map=null,this.linewidth=1,this.linecap="round",this.linejoin="round",this.fog=!0,this.setValues(t)}copy(t){return super.copy(t),this.color.copy(t.color),this.map=t.map,this.linewidth=t.linewidth,this.linecap=t.linecap,this.linejoin=t.linejoin,this.fog=t.fog,this}}const ja=new q,Ja=new q,Uf=new Ce,js=new Cp,xa=new sl,Ql=new q,Nf=new q;class Ff extends Je{constructor(t=new Jn,e=new mu){super(),this.isLine=!0,this.type="Line",this.geometry=t,this.material=e,this.updateMorphTargets()}copy(t,e){return super.copy(t,e),this.material=Array.isArray(t.material)?t.material.slice():t.material,this.geometry=t.geometry,this}computeLineDistances(){const t=this.geometry;if(t.index===null){const e=t.attributes.position,n=[0];for(let i=1,s=e.count;i<s;i++)ja.fromBufferAttribute(e,i-1),Ja.fromBufferAttribute(e,i),n[i]=n[i-1],n[i]+=ja.distanceTo(Ja);t.setAttribute("lineDistance",new bn(n,1))}else console.warn("THREE.Line.computeLineDistances(): Computation only possible with non-indexed BufferGeometry.");return this}raycast(t,e){const n=this.geometry,i=this.matrixWorld,s=t.params.Line.threshold,o=n.drawRange;if(n.boundingSphere===null&&n.computeBoundingSphere(),xa.copy(n.boundingSphere),xa.applyMatrix4(i),xa.radius+=s,t.ray.intersectsSphere(xa)===!1)return;Uf.copy(i).invert(),js.copy(t.ray).applyMatrix4(Uf);const a=s/((this.scale.x+this.scale.y+this.scale.z)/3),l=a*a,c=this.isLineSegments?2:1,u=n.index,f=n.attributes.position;if(u!==null){const d=Math.max(0,o.start),g=Math.min(u.count,o.start+o.count);for(let _=d,m=g-1;_<m;_+=c){const p=u.getX(_),E=u.getX(_+1),v=Ma(this,t,js,l,p,E);v&&e.push(v)}if(this.isLineLoop){const _=u.getX(g-1),m=u.getX(d),p=Ma(this,t,js,l,_,m);p&&e.push(p)}}else{const d=Math.max(0,o.start),g=Math.min(f.count,o.start+o.count);for(let _=d,m=g-1;_<m;_+=c){const p=Ma(this,t,js,l,_,_+1);p&&e.push(p)}if(this.isLineLoop){const _=Ma(this,t,js,l,g-1,d);_&&e.push(_)}}}updateMorphTargets(){const e=this.geometry.morphAttributes,n=Object.keys(e);if(n.length>0){const i=e[n[0]];if(i!==void 0){this.morphTargetInfluences=[],this.morphTargetDictionary={};for(let s=0,o=i.length;s<o;s++){const a=i[s].name||String(s);this.morphTargetInfluences.push(0),this.morphTargetDictionary[a]=s}}}}}function Ma(r,t,e,n,i,s){const o=r.geometry.attributes.position;if(ja.fromBufferAttribute(o,i),Ja.fromBufferAttribute(o,s),e.distanceSqToSegment(ja,Ja,Ql,Nf)>n)return;Ql.applyMatrix4(r.matrixWorld);const l=t.ray.origin.distanceTo(Ql);if(!(l<t.near||l>t.far))return{distance:l,point:Nf.clone().applyMatrix4(r.matrixWorld),index:i,face:null,faceIndex:null,barycoord:null,object:r}}class ju extends Jn{constructor(t=.5,e=1,n=32,i=1,s=0,o=Math.PI*2){super(),this.type="RingGeometry",this.parameters={innerRadius:t,outerRadius:e,thetaSegments:n,phiSegments:i,thetaStart:s,thetaLength:o},n=Math.max(3,n),i=Math.max(1,i);const a=[],l=[],c=[],u=[];let h=t;const f=(e-t)/i,d=new q,g=new ue;for(let _=0;_<=i;_++){for(let m=0;m<=n;m++){const p=s+m/n*o;d.x=h*Math.cos(p),d.y=h*Math.sin(p),l.push(d.x,d.y,d.z),c.push(0,0,1),g.x=(d.x/e+1)/2,g.y=(d.y/e+1)/2,u.push(g.x,g.y)}h+=f}for(let _=0;_<i;_++){const m=_*(n+1);for(let p=0;p<n;p++){const E=p+m,v=E,x=E+n+1,R=E+n+2,w=E+1;a.push(v,x,w),a.push(x,R,w)}}this.setIndex(a),this.setAttribute("position",new bn(l,3)),this.setAttribute("normal",new bn(c,3)),this.setAttribute("uv",new bn(u,2))}copy(t){return super.copy(t),this.parameters=Object.assign({},t.parameters),this}static fromJSON(t){return new ju(t.innerRadius,t.outerRadius,t.thetaSegments,t.phiSegments,t.thetaStart,t.thetaLength)}}class So extends Jn{constructor(t=1,e=32,n=16,i=0,s=Math.PI*2,o=0,a=Math.PI){super(),this.type="SphereGeometry",this.parameters={radius:t,widthSegments:e,heightSegments:n,phiStart:i,phiLength:s,thetaStart:o,thetaLength:a},e=Math.max(3,Math.floor(e)),n=Math.max(2,Math.floor(n));const l=Math.min(o+a,Math.PI);let c=0;const u=[],h=new q,f=new q,d=[],g=[],_=[],m=[];for(let p=0;p<=n;p++){const E=[],v=p/n;let x=0;p===0&&o===0?x=.5/e:p===n&&l===Math.PI&&(x=-.5/e);for(let R=0;R<=e;R++){const w=R/e;h.x=-t*Math.cos(i+w*s)*Math.sin(o+v*a),h.y=t*Math.cos(o+v*a),h.z=t*Math.sin(i+w*s)*Math.sin(o+v*a),g.push(h.x,h.y,h.z),f.copy(h).normalize(),_.push(f.x,f.y,f.z),m.push(w+x,1-v),E.push(c++)}u.push(E)}for(let p=0;p<n;p++)for(let E=0;E<e;E++){const v=u[p][E+1],x=u[p][E],R=u[p+1][E],w=u[p+1][E+1];(p!==0||o>0)&&d.push(v,x,w),(p!==n-1||l<Math.PI)&&d.push(x,R,w)}this.setIndex(d),this.setAttribute("position",new bn(g,3)),this.setAttribute("normal",new bn(_,3)),this.setAttribute("uv",new bn(m,2))}copy(t){return super.copy(t),this.parameters=Object.assign({},t.parameters),this}static fromJSON(t){return new So(t.radius,t.widthSegments,t.heightSegments,t.phiStart,t.phiLength,t.thetaStart,t.thetaLength)}}class DS extends zs{static get type(){return"MeshPhongMaterial"}constructor(t){super(),this.isMeshPhongMaterial=!0,this.color=new ae(16777215),this.specular=new ae(1118481),this.shininess=30,this.map=null,this.lightMap=null,this.lightMapIntensity=1,this.aoMap=null,this.aoMapIntensity=1,this.emissive=new ae(0),this.emissiveIntensity=1,this.emissiveMap=null,this.bumpMap=null,this.bumpScale=1,this.normalMap=null,this.normalMapType=Tp,this.normalScale=new ue(1,1),this.displacementMap=null,this.displacementScale=1,this.displacementBias=0,this.specularMap=null,this.alphaMap=null,this.envMap=null,this.envMapRotation=new Mi,this.combine=Vu,this.reflectivity=1,this.refractionRatio=.98,this.wireframe=!1,this.wireframeLinewidth=1,this.wireframeLinecap="round",this.wireframeLinejoin="round",this.flatShading=!1,this.fog=!0,this.setValues(t)}copy(t){return super.copy(t),this.color.copy(t.color),this.specular.copy(t.specular),this.shininess=t.shininess,this.map=t.map,this.lightMap=t.lightMap,this.lightMapIntensity=t.lightMapIntensity,this.aoMap=t.aoMap,this.aoMapIntensity=t.aoMapIntensity,this.emissive.copy(t.emissive),this.emissiveMap=t.emissiveMap,this.emissiveIntensity=t.emissiveIntensity,this.bumpMap=t.bumpMap,this.bumpScale=t.bumpScale,this.normalMap=t.normalMap,this.normalMapType=t.normalMapType,this.normalScale.copy(t.normalScale),this.displacementMap=t.displacementMap,this.displacementScale=t.displacementScale,this.displacementBias=t.displacementBias,this.specularMap=t.specularMap,this.alphaMap=t.alphaMap,this.envMap=t.envMap,this.envMapRotation.copy(t.envMapRotation),this.combine=t.combine,this.reflectivity=t.reflectivity,this.refractionRatio=t.refractionRatio,this.wireframe=t.wireframe,this.wireframeLinewidth=t.wireframeLinewidth,this.wireframeLinecap=t.wireframeLinecap,this.wireframeLinejoin=t.wireframeLinejoin,this.flatShading=t.flatShading,this.fog=t.fog,this}}class Wp extends Je{constructor(t,e=1){super(),this.isLight=!0,this.type="Light",this.color=new ae(t),this.intensity=e}dispose(){}copy(t,e){return super.copy(t,e),this.color.copy(t.color),this.intensity=t.intensity,this}toJSON(t){const e=super.toJSON(t);return e.object.color=this.color.getHex(),e.object.intensity=this.intensity,this.groundColor!==void 0&&(e.object.groundColor=this.groundColor.getHex()),this.distance!==void 0&&(e.object.distance=this.distance),this.angle!==void 0&&(e.object.angle=this.angle),this.decay!==void 0&&(e.object.decay=this.decay),this.penumbra!==void 0&&(e.object.penumbra=this.penumbra),this.shadow!==void 0&&(e.object.shadow=this.shadow.toJSON()),this.target!==void 0&&(e.object.target=this.target.uuid),e}}const tc=new Ce,Of=new q,Bf=new q;class LS{constructor(t){this.camera=t,this.intensity=1,this.bias=0,this.normalBias=0,this.radius=1,this.blurSamples=8,this.mapSize=new ue(512,512),this.map=null,this.mapPass=null,this.matrix=new Ce,this.autoUpdate=!0,this.needsUpdate=!1,this._frustum=new Ku,this._frameExtents=new ue(1,1),this._viewportCount=1,this._viewports=[new De(0,0,1,1)]}getViewportCount(){return this._viewportCount}getFrustum(){return this._frustum}updateMatrices(t){const e=this.camera,n=this.matrix;Of.setFromMatrixPosition(t.matrixWorld),e.position.copy(Of),Bf.setFromMatrixPosition(t.target.matrixWorld),e.lookAt(Bf),e.updateMatrixWorld(),tc.multiplyMatrices(e.projectionMatrix,e.matrixWorldInverse),this._frustum.setFromProjectionMatrix(tc),n.set(.5,0,0,.5,0,.5,0,.5,0,0,.5,.5,0,0,0,1),n.multiply(tc)}getViewport(t){return this._viewports[t]}getFrameExtents(){return this._frameExtents}dispose(){this.map&&this.map.dispose(),this.mapPass&&this.mapPass.dispose()}copy(t){return this.camera=t.camera.clone(),this.intensity=t.intensity,this.bias=t.bias,this.radius=t.radius,this.mapSize.copy(t.mapSize),this}clone(){return new this.constructor().copy(this)}toJSON(){const t={};return this.intensity!==1&&(t.intensity=this.intensity),this.bias!==0&&(t.bias=this.bias),this.normalBias!==0&&(t.normalBias=this.normalBias),this.radius!==1&&(t.radius=this.radius),(this.mapSize.x!==512||this.mapSize.y!==512)&&(t.mapSize=this.mapSize.toArray()),t.camera=this.camera.toJSON(!1).object,delete t.camera.matrix,t}}class IS extends LS{constructor(){super(new Bp(-5,5,5,-5,.5,500)),this.isDirectionalLightShadow=!0}}class zf extends Wp{constructor(t,e){super(t,e),this.isDirectionalLight=!0,this.type="DirectionalLight",this.position.copy(Je.DEFAULT_UP),this.updateMatrix(),this.target=new Je,this.shadow=new IS}dispose(){this.shadow.dispose()}copy(t){return super.copy(t),this.target=t.target.clone(),this.shadow=t.shadow.clone(),this}}class US extends Wp{constructor(t,e){super(t,e),this.isAmbientLight=!0,this.type="AmbientLight"}}class NS{constructor(t=!0){this.autoStart=t,this.startTime=0,this.oldTime=0,this.elapsedTime=0,this.running=!1}start(){this.startTime=kf(),this.oldTime=this.startTime,this.elapsedTime=0,this.running=!0}stop(){this.getElapsedTime(),this.running=!1,this.autoStart=!1}getElapsedTime(){return this.getDelta(),this.elapsedTime}getDelta(){let t=0;if(this.autoStart&&!this.running)return this.start(),0;if(this.running){const e=kf();t=(e-this.oldTime)/1e3,this.oldTime=e,this.elapsedTime+=t}return t}}function kf(){return performance.now()}typeof __THREE_DEVTOOLS__<"u"&&__THREE_DEVTOOLS__.dispatchEvent(new CustomEvent("register",{detail:{revision:Hu}}));typeof window<"u"&&(window.__THREE__?console.warn("WARNING: Multiple instances of Three.js being imported."):window.__THREE__=Hu);te.registerPlugin(Ft);function FS(r){return new Promise(t=>{const e={val:0},n=document.querySelector(".loader-counter"),i=document.querySelector(".loader-status"),s="ABCDEFGHIJKLMNOPQRSTUVWXYZ0123456789$#@%&";function o(l,c){let u=0;const h=setInterval(()=>{l.innerText=c.split("").map((f,d)=>d<u?c[d]:s[Math.floor(Math.random()*26)]).join(""),u>=c.length&&clearInterval(h),u+=1/2},30)}const a=te.timeline();te.to(".loader-grid",{y:"20%",rotateX:50,scale:1.5,duration:3,ease:"none",repeat:-1,yoyo:!0}),a.to(e,{val:100,duration:3.5,ease:"power4.inOut",onUpdate:()=>{const l=Math.floor(e.val);n&&(n.innerText=l.toString().padStart(2,"0")),i&&(l===15&&o(i,"LOADING CORE..."),l===40&&o(i,"OPTIMIZING ASSETS..."),l===75&&o(i,"ESTABLISHING UPLINK..."),l===98&&o(i,"ACCESS GRANTED"))}}),a.to(".loader-line",{width:"100vw",duration:3,ease:"expo.out"},"<"),a.to(".loader-content",{filter:"blur(20px)",opacity:0,scale:.9,duration:.5,ease:"power2.in"}),a.to(".acid-loader",{yPercent:-100,duration:1.2,ease:"power4.inOut",onStart:()=>{r&&setTimeout(r,100)},onComplete:t})})}function OS(){const r=document.getElementById("cursor"),t=document.getElementById("cursor-dot");let e=0,n=0,i=0,s=0;document.addEventListener("mousemove",o=>{e=o.clientX,n=o.clientY}),te.ticker.add(()=>{i+=(e-i)*.12,s+=(n-s)*.12,te.set(r,{x:i,y:s,xPercent:-50,yPercent:-50}),te.set(t,{x:e,y:n,xPercent:-50,yPercent:-50})}),document.querySelectorAll("a, button, .hotspot").forEach(o=>{o.addEventListener("mouseenter",()=>document.body.classList.add("cursor-hover")),o.addEventListener("mouseleave",()=>document.body.classList.remove("cursor-hover"))})}function BS(){const r=new R_({lerp:.1,smoothWheel:!0,smoothTouch:!0,touchMultiplier:1.5,syncTouch:!0});return r.on("scroll",Ft.update),te.ticker.add(t=>r.raf(t*1e3)),te.ticker.lagSmoothing(0),r}function zS(){const r=document.getElementById("star-field"),t=document.createElement("canvas");t.style.position="absolute",t.style.inset="0",t.style.pointerEvents="none",r.appendChild(t);const e=t.getContext("2d");let n,i;const s=()=>{n=t.width=r.clientWidth,i=t.height=Math.max(r.clientHeight,window.innerHeight)};s(),window.addEventListener("resize",s);const o=Array.from({length:150},()=>({x:Math.random()*n,y:Math.random()*i,s:Math.random()*1.5+.5,a:Math.random()*Math.PI*2,v:.02+Math.random()*.03}));te.ticker.add(()=>{e.clearRect(0,0,n,i),e.fillStyle="#ffffff",o.forEach(a=>{a.a+=a.v,e.globalAlpha=.2+Math.abs(Math.sin(a.a))*.8,e.beginPath(),e.arc(a.x,a.y,a.s,0,Math.PI*2),e.fill()})})}function Sa(r,t){const e=document.getElementById(r);if(!e)return;const n=e.getContext("2d"),i=e.width,s=e.height;n.strokeStyle=t,n.lineWidth=1,n.globalAlpha=.7;const o=i*.42,a=s*.5,l=i*.3,c=s*.25;n.beginPath(),n.arc(o-l*.55,a-c*.1,4,0,Math.PI*2),n.stroke()}function ec(r,t){const e=document.getElementById(r);if(!e)return;const n=e.getContext("2d"),i=e.width,s=e.height;n.strokeStyle=t,n.lineWidth=1,n.globalAlpha=.65;const o=i/2,a=s*.28,l=i*.38,c=s*.26;n.beginPath();for(let u=0;u<=20;u++){const h=u/20*Math.PI;n.lineTo(o+Math.cos(h)*l,a-Math.sin(h)*c)}n.stroke();for(let u=1;u<6;u++)n.beginPath(),n.moveTo(o-l+u*l*2/6,a),n.bezierCurveTo(o,a-c*.5,o,a-c*.8,o,a-c),n.stroke();for(let u=0;u<8;u++){const h=o-l*.78+u*l*1.56/7,f=s*(.3+Math.random()*.35);n.beginPath(),n.moveTo(h,a),n.bezierCurveTo(h+(Math.random()-.5)*18,a+f*.35,h+(Math.random()-.5)*24,a+f*.7,h+(Math.random()-.5)*14,a+f),n.stroke()}}function nc(r,t){const e=document.getElementById(r);if(!e)return;const n=e.getContext("2d"),i=e.width,s=e.height;n.strokeStyle=t,n.lineWidth=1,n.globalAlpha=.6;const o=i*.45,a=s*.52,l=i*.33,c=s*.3,u=[];for(let h=0;h<18;h++){const f=h/18*Math.PI*2,d=1+.15*Math.sin(f*3+1.5);u.push({x:o+Math.cos(f)*l*d,y:a+Math.sin(f)*c*d})}n.beginPath(),u.forEach((h,f)=>f===0?n.moveTo(h.x,h.y):n.lineTo(h.x,h.y)),n.closePath(),n.stroke();for(let h=0;h<18;h+=3)n.beginPath(),n.moveTo(o,a),n.lineTo(u[h].x,u[h].y),n.stroke();n.beginPath(),n.moveTo(o-l*.2,a-c),n.bezierCurveTo(o,a-c*1.8,o+l*.6,a-c*1.4,o+l*.5,a-c*.7),n.stroke(),n.globalAlpha=.9,n.fillStyle=t,n.beginPath(),n.arc(o+l*.5,a-c*.7,6,0,Math.PI*2),n.fill(),n.globalAlpha=.6,n.beginPath(),n.moveTo(o-l,a+c*.1),n.lineTo(o-l*1.15,a-c*.2);for(let h=0;h<=7;h++){const f=a-c*.2+h*c*.45/7;n.lineTo(o-l*1.15+(h%2===0?6:18),f)}n.stroke()}function kS(){Sa("fish-1","#99eb1e"),ec("jellyfish-1","#333333"),Sa("fish-2","#7e7f9a"),nc("anglerfish-1","#99eb1e"),ec("jellyfish-2","#99eb1e"),Sa("fish-3","#333333"),nc("anglerfish-2","#7e7f9a"),Sa("fish-4","#99eb1e"),ec("jellyfish-3","#7e7f9a"),nc("anglerfish-3","#333333")}function HS(r,t,e=2){const n={val:0};te.to(n,{val:t,duration:e,ease:"power2.out",onUpdate:()=>{r.textContent=Math.floor(n.val).toLocaleString()}})}function VS(r){const t=document.getElementById("globe-container");if(!t)return;const e=t.clientWidth||600,n=t.clientHeight||600,i=new PS,s=new $n(45,e/n,.1,1e3);s.position.z=window.innerWidth<=768?3.5:2.8;const o=new CS({antialias:!0,alpha:!0});o.setSize(e,n),o.setPixelRatio(Math.min(window.devicePixelRatio,2)),o.setClearColor(0,0),t.appendChild(o.domElement);const a=new So(1,64,64),l=new DS({color:134170,emissive:2580,emissiveIntensity:.5,shininess:30,transparent:!0,opacity:.95}),c=new Bn(a,l);i.add(c);const u=new So(1.12,64,64),h=new Mo({color:10087198,transparent:!0,opacity:.06,side:_n});i.add(new Bn(u,h));const f=new US(132626,1.8);i.add(f);const d=new zf(10087198,.8);d.position.set(5,3,5),i.add(d);const g=new zf(3355443,.4);g.position.set(-5,-2,-3),i.add(g);function _(it,Tt,k=1.002){const j=(90-it)*Math.PI/180,at=(Tt+180)*Math.PI/180;return new q(-k*Math.sin(j)*Math.cos(at),k*Math.cos(j),k*Math.sin(j)*Math.sin(at))}fetch("https://raw.githubusercontent.com/johan/world.geo.json/master/countries.geo.json").then(it=>it.json()).then(it=>{const Tt=new mu({color:8290202,transparent:!0,opacity:.5});it.features.forEach(k=>{k.geometry.type==="Polygon"?m(k.geometry.coordinates[0],Tt):k.geometry.type==="MultiPolygon"&&k.geometry.coordinates.forEach(j=>m(j[0],Tt))})}).catch(it=>{});function m(it,Tt){const k=[];it.forEach(et=>{k.push(_(et[1],et[0],1.001))});const j=new Jn().setFromPoints(k),at=new Ff(j,Tt);c.add(at)}function p(it,Tt,k,j,at,et=60){const Mt=_(it,Tt),Et=_(k,j),Ot=[];for(let Pt=0;Pt<=et;Pt++){const I=Mt.clone().lerp(Et,Pt/et);I.normalize().multiplyScalar(1.002),Ot.push(I)}const qt=new Jn().setFromPoints(Ot),Nt=new mu({color:at,transparent:!0,opacity:.8});return new Ff(qt,Nt)}function E(it,Tt,k){const j=_(it,Tt,1.025),at=new So(.012,8,8),et=new Mo({color:k}),Mt=new Bn(at,et);return Mt.position.copy(j),Mt}const v=10087198,x=54527,R=8290202,w=[[40.7,-74,51.5,-.1,x],[40.7,-74,38.7,-9.1,x],[40.7,-74,43.6,-70.2,v],[25.8,-80.2,38.7,-9.1,v],[25.8,-80.2,18.5,-72.3,v],[25.8,-80.2,40.7,-74,v],[25.8,-80.2,9,-79.5,v],[51.5,-.1,48.8,2.3,x],[48.8,2.3,43.3,5.3,v],[43.3,5.3,36.7,3.1,v],[36.7,3.1,33.9,10.2,v],[33.9,10.2,31.2,29.9,v],[31.2,29.9,30.1,31.3,v],[30.1,31.3,25.2,55.3,x],[25.2,55.3,24.5,51.5,v],[24.5,51.5,21.5,39.2,v],[21.5,39.2,15.6,32.5,v],[15.6,32.5,11.6,43.1,v],[11.6,43.1,1.3,45.3,v],[25.2,55.3,19.1,72.9,x],[19.1,72.9,13.1,80.3,v],[13.1,80.3,1.3,103.8,x],[1.3,103.8,22.3,114.2,x],[22.3,114.2,35.7,139.7,x],[35.7,139.7,37.8,-122.4,x],[37.8,-122.4,47.6,-122.3,v],[47.6,-122.3,51.5,-.1,R],[1.3,103.8,-33.9,151.2,v],[-33.9,151.2,-36.8,174.7,v],[-36.8,174.7,1.3,103.8,R],[37.8,-122.4,21.3,-157.8,v],[21.3,-157.8,-33.9,151.2,v],[21.3,-157.8,1.3,103.8,v],[21.3,-157.8,35.7,139.7,v],[40.7,-74,-23.5,-46.6,v],[-23.5,-46.6,-34.6,-58.3,v],[-23.5,-46.6,-33.5,-70.6,v],[9,-79.5,-23.5,-46.6,v],[9,-79.5,37.8,-122.4,v],[38.7,-9.1,14.7,-17.4,v],[14.7,-17.4,-33.9,18.4,v],[-33.9,18.4,-23.5,-46.6,v],[-33.9,18.4,-20.3,57.5,v],[-20.3,57.5,1.3,103.8,v],[-20.3,57.5,19.1,72.9,v],[51.5,-.1,60.4,5.3,v],[60.4,5.3,59.9,30.3,v],[59.9,30.3,60.2,24.9,v],[51.5,-.1,53.3,-6.3,v],[55.7,37.6,48.5,34.2,v],[25.2,55.3,41,28.9,v],[14.7,-17.4,4.4,9.7,v],[4.4,9.7,-4.3,15.3,v],[-4.3,15.3,-33.9,18.4,v],[1.3,103.8,15.9,108.2,v],[15.9,108.2,22.3,114.2,v],[35.7,139.7,-33.9,151.2,v],[22.3,114.2,10.8,106.7,v],[10.8,106.7,3.1,101.7,v],[3.1,101.7,1.3,103.8,v],[13.1,80.3,6.9,79.9,v],[6.9,79.9,-20.3,57.5,v],[41,28.9,37,22,v],[37,22,33.9,10.2,v],[48.8,2.3,51.5,-.1,v],[-23.5,-46.6,10.5,-66.9,v],[10.5,-66.9,18.5,-72.3,v],[18.5,-72.3,25.8,-80.2,v],[38.7,-9.1,27.7,-15.4,v],[27.7,-15.4,14.7,-17.4,v],[27.7,-15.4,25.8,-80.2,R],[47.6,-122.3,21.3,-157.8,v],[51.5,-.1,40.7,-74,x],[13.1,80.3,22.3,114.2,R],[-33.5,-70.6,-33.9,18.4,R],[59.9,30.3,35.7,139.7,R],[60.4,5.3,21.3,-157.8,R]],b=[[40.7,-74,x],[51.5,-.1,x],[38.7,-9.1,v],[25.8,-80.2,v],[37.8,-122.4,x],[47.6,-122.3,v],[35.7,139.7,x],[22.3,114.2,x],[1.3,103.8,x],[10.8,106.7,v],[3.1,101.7,v],[15.9,108.2,v],[-33.9,151.2,v],[-36.8,174.7,v],[-33.9,18.4,v],[-23.5,-46.6,v],[-34.6,-58.3,v],[-33.5,-70.6,v],[25.2,55.3,x],[24.5,51.5,v],[21.5,39.2,v],[13.1,80.3,v],[19.1,72.9,x],[6.9,79.9,v],[48.8,2.3,v],[43.3,5.3,v],[36.7,3.1,v],[33.9,10.2,v],[31.2,29.9,v],[30.1,31.3,v],[41,28.9,v],[21.3,-157.8,v],[14.7,-17.4,v],[27.7,-15.4,v],[-20.3,57.5,v],[4.4,9.7,v],[-4.3,15.3,v],[11.6,43.1,v],[1.3,45.3,v],[15.6,32.5,v],[60.4,5.3,v],[59.9,30.3,v],[60.2,24.9,v],[53.3,-6.3,v],[9,-79.5,v],[18.5,-72.3,v],[10.5,-66.9,v],[43.6,-70.2,v],[37,22,v]];w.forEach(([it,Tt,k,j,at])=>{const et=p(it,Tt,k,j,at);c.add(et)});const C=[];b.forEach(([it,Tt,k])=>{const j=E(it,Tt,k);c.add(j);const at=_(it,Tt,1.03),et=new ju(.012,.025,16),Mt=new Mo({color:k,transparent:!0,opacity:.8,side:fi}),Et=new Bn(et,Mt);Et.position.copy(at),Et.lookAt(new q(0,0,0)),Et.userData={phase:Math.random()*Math.PI*2},c.add(Et),C.push(Et)});let S=!1,M={x:0,y:0},P=0,U=0,O=0;const H=o.domElement;H.addEventListener("mousedown",it=>{S=!0,M={x:it.clientX,y:it.clientY}}),H.addEventListener("mousemove",it=>{if(!S)return;const Tt=it.clientX-M.x;U=(it.clientY-M.y)*.003,O=Tt*.003,P+=U,M={x:it.clientX,y:it.clientY}}),H.addEventListener("mouseup",()=>{S=!1}),H.addEventListener("mouseleave",()=>{S=!1});let $=null;H.addEventListener("touchstart",it=>{$=it.touches[0],r&&r.stop()}),H.addEventListener("touchmove",it=>{if(it.cancelable&&it.preventDefault(),!$)return;const Tt=it.touches[0].clientX-$.clientX,k=it.touches[0].clientY-$.clientY;O=Tt*.003,U=k*.003,P+=U,$=it.touches[0]},{passive:!1}),H.addEventListener("touchend",()=>{r&&r.start()}),H.addEventListener("touchcancel",()=>{r&&r.start()});let X;function Y(){clearTimeout(X),X=setTimeout(()=>{const it=t.clientWidth,Tt=t.clientHeight;s.aspect=it/Tt,s.updateProjectionMatrix(),s.position.z=window.innerWidth<=768?3.5:2.8,o.setSize(it,Tt)},100)}window.addEventListener("resize",Y),Ft.create({trigger:"#globe-section",start:"top 80%",once:!0,onEnter:()=>{H.style.opacity="0",H.style.transition="opacity 1s ease",setTimeout(()=>H.style.opacity="1",100)}});let z=!1;new IntersectionObserver(it=>{z=it[0].isIntersecting},{threshold:0}).observe(document.getElementById("globe-section"));const D=new NS;function ut(){if(requestAnimationFrame(ut),!z)return;const it=D.getElapsedTime();S||(U*=.95,O*=.95),P+=(U-P)*0,c.rotation.x=P,c.rotation.y+=O+(S?0:.0015),C.forEach(Tt=>{const k=Tt.userData.phase,j=1+.4*Math.abs(Math.sin(it*1.5+k));Tt.scale.setScalar(j),Tt.material.opacity=.8-.5*Math.abs(Math.sin(it*1.5+k))}),o.render(i,s)}ut()}function GS(){te.set(".hero-subtitle",{y:"100%"}),te.set(".hero-stats",{opacity:0,scale:.95}),te.set([".outro-title",".outro-body",".outro-cta-row"],{y:40}),te.set(".truth-eyebrow",{y:20});const r=te.timeline({paused:!0});r.to(".hero-eyebrow",{opacity:1,duration:.8,ease:"power2.out"}).fromTo(".hero-title .line",{y:"110%",skewY:5},{y:"0%",skewY:0,duration:1,stagger:.08,ease:"expo.out"},"-=0.5").to(".hero-subtitle",{y:"0%",duration:.8,ease:"expo.out"},"-=0.6").to(".hero-stats",{opacity:1,scale:1,duration:.8,ease:"expo.out"},"-=0.4").to(".stat-item",{opacity:1,duration:.5,stagger:.12,ease:"power2.out"},"-=0.6").to(".scroll-cue",{opacity:1,duration:.5},"-=0.2"),document.querySelectorAll(".stat-num").forEach(l=>{Ft.create({trigger:l,start:"top 80%",once:!0,onEnter:()=>HS(l,parseInt(l.dataset.val,10))})});const t=document.querySelector(".depth-gauge"),e=document.getElementById("depth-value"),n=document.getElementById("depth-bar");Ft.create({trigger:"#descent",start:"top+=15% center",end:"bottom-=15% center",onToggle:l=>t.classList.toggle("visible",l.isActive),onUpdate:l=>{const c=window.innerWidth<=768;e.innerHTML=`${Math.floor(l.progress*11e3).toLocaleString()}<span>M</span>`,c?n.style.transform=`scaleX(${l.progress})`:n.style.transform=`scaleY(${l.progress})`}});const i=document.getElementById("particles-container");if(i)for(let l=0;l<200;l++){const c=document.createElement("div");c.className="particle";const u=Math.random()*4+1;c.style.width=u+"px",c.style.height=u+"px",c.style.left=Math.random()*100+"%",c.style.top=Math.random()*100+"%",i.appendChild(c),te.to(c,{y:-window.innerHeight*(1.5+Math.random()*2),ease:"none",scrollTrigger:{trigger:"#descent",start:"top bottom",end:"bottom top",scrub:!0}})}document.querySelectorAll("#cable-casing, .fiber-line, .fiber-glow").forEach(l=>{const c=l.getTotalLength()||6500;te.set(l,{strokeDasharray:c,strokeDashoffset:c}),Ft.create({trigger:"#descent",start:"top center",end:"bottom center",scrub:!0,onUpdate:u=>l.style.strokeDashoffset=c*(1-u.progress)})});const o=document.querySelector(".pulse-fiber");return o&&te.to(o,{strokeDashoffset:-2e3,duration:40,ease:"none",repeat:-1}),document.querySelectorAll(".creature").forEach((l,c)=>{const u=l.querySelector(".creature-canvas"),h=parseFloat(l.dataset.speed)||.3;Ft.create({trigger:l,start:"top bottom",once:!0,onEnter:()=>{te.to(l,{opacity:.9,duration:1.5,delay:c*.1,ease:"power2.out"}),u&&te.to(u,{y:20+c*4,duration:3+Math.random(),ease:"sine.inOut",yoyo:!0,repeat:-1})}}),Ft.create({trigger:"#descent",start:"top bottom",end:"bottom top",scrub:!0,onUpdate:f=>te.set(l,{y:(f.progress-.5)*600*h})})}),document.querySelectorAll(".hotspot").forEach((l,c)=>{const u=l.querySelector(".hotspot-line"),h=l.querySelector(".inline-card"),f=h.querySelectorAll(":scope > *"),d=l.querySelector(".hotspot-pulse");l.classList.contains("left-aligned");const g=window.innerWidth<=768,_="polygon(0% 10%, 0% 10%, 0% 10%, 0% 10%, 0% 10%, 0% 10%)",m="polygon(0% 2%, 2% 0%, 100% 0%, 100% 98%, 98% 100%, 0% 100%)",p=g?25:80;te.set(l,{opacity:1}),te.set(d,{scale:0,opacity:0}),te.set(u,{width:0}),te.set(h,{autoAlpha:0,clipPath:_}),te.set(f,{autoAlpha:0,y:15});const E=te.timeline({paused:!0});E.to(d,{scale:1,opacity:1,duration:.3,ease:"back.out(2)"}).to(u,{width:p,duration:.4,ease:"expo.inOut"},"-=0.1").to(h,{autoAlpha:1,duration:.05},"-=0.1").to(h,{clipPath:m,duration:.5,ease:"power4.out"},"<").to(f,{autoAlpha:1,y:0,duration:.4,stagger:.05,ease:"power2.out"},"-=0.3"),Ft.create({trigger:d,start:"center center",end:"bottom 10%",fastScrollEnd:!0,preventOverlaps:!0,onEnter:()=>E.play(),onLeaveBack:()=>E.reverse(),onLeave:()=>{g||te.to(l,{autoAlpha:0,y:-20,duration:.4})},onEnterBack:()=>{g||te.to(l,{autoAlpha:1,y:0,duration:.4,onComplete:()=>E.play()})}})}),Ft.create({trigger:"#truth",start:"top 65%",once:!0,onEnter:()=>{te.to(".truth-eyebrow",{opacity:1,y:0,duration:.6}),te.to(".reveal-word",{opacity:1,y:0,duration:.8,stagger:.08,ease:"expo.out",delay:.2}),te.to(".truth-row",{opacity:1,y:0,duration:.9,stagger:.2,ease:"power3.out",delay:.7})}}),Ft.create({trigger:"#globe-section",start:"top 70%",once:!0,onEnter:()=>{te.to(".globe-eyebrow",{opacity:1,duration:.5}),te.to(".globe-title",{opacity:1,duration:.6,delay:.2}),te.to(".globe-sub",{opacity:1,duration:.6,delay:.4}),te.to(".globe-legend",{opacity:1,duration:.6,delay:.8})}}),Ft.create({trigger:"#outro",start:"top 70%",once:!0,onEnter:()=>{te.timeline().to(".outro-title",{opacity:1,y:0,duration:.8,ease:"power3.out"}).to(".outro-body",{opacity:1,y:0,duration:.8,ease:"power3.out"},"-=0.5").to(".outro-cta-row",{opacity:1,y:0,duration:.8,ease:"power3.out"},"-=0.5").to(".outro-credit",{opacity:1,duration:.6},"-=0.3")}}),r}async function WS(){OS(),zS(),kS();const r=BS();VS(r),Ft.refresh();const t=GS();await FS(()=>{t&&t.play(),Ft.refresh()})}WS();
